// Description: Java 25 JPA implementation of a StringDef entity definition object.
...
@Entity
@Table(
	name = "strdef", schema = "CFBam31",
	indexes = {
		@Index(name = "StringDefIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaStringDef extends CFBamJpaAtom
	implements ICFBamStringDef
{
	...
	public String toString() {
		String ret = "<CFBamJpaStringDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
