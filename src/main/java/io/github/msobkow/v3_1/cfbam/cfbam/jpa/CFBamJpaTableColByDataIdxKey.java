// Description: Java 25 JPA implementation of a TableCol by DataIdx index key object.
	...
	implements ICFBamTableColByDataIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTableColByDataIdxKey, ICFBamTableCol, ICFBamTableColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTableColByDataIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
