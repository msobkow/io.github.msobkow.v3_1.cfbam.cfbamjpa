// Description: Java 25 JPA implementation of a Table by SchemaDefIdx index key object.
...
public class CFBamJpaTableBySchemaDefIdxKey
	implements ICFBamTableBySchemaDefIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaTableBySchemaDefIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTableBySchemaDefIdxKey, ICFBamTable, ICFBamTableH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTableBySchemaDefIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
