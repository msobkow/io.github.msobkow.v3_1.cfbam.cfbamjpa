// Description: Java 25 JPA implementation of a DoubleCol entity definition object.
...
@Entity
@Table(
	name = "dblcol", schema = "CFBam31",
	indexes = {
		@Index(name = "DoubleColIdIdx", columnList = "Id", unique = true),
		@Index(name = "DoubleColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaDoubleCol extends CFBamJpaDoubleDef
	implements ICFBamDoubleCol
{
	...
	public String toString() {
		String ret = "<CFBamJpaDoubleCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
