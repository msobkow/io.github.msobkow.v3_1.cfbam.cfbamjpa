// Description: Java 25 JPA implementation of a DbKeyHash160Col entity definition object.
...
@Entity
@Table(
	name = "dbk160col", schema = "CFBam31",
	indexes = {
		@Index(name = "DbKeyHash160ColIdIdx", columnList = "Id", unique = true),
		@Index(name = "DbKeyHash160ColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaDbKeyHash160Col extends CFBamJpaDbKeyHash160Def
	implements ICFBamDbKeyHash160Col
{
	...
	public String toString() {
		String ret = "<CFBamJpaDbKeyHash160Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
