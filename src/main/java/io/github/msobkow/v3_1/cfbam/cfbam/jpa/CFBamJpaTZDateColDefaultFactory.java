...
// Description: Java 25 JPA Default Factory implementation for TZDateCol.
...
/*
 *	CFBamTZDateColFactory JPA implementation for TZDateCol
 */
public class CFBamJpaTZDateColDefaultFactory
    implements ICFBamTZDateColFactory
{
    public CFBamJpaTZDateColDefaultFactory() {
    }

    @Override
    public ICFBamTZDateColByTableIdxKey newByTableIdxKey() {
	ICFBamTZDateColByTableIdxKey key =
            new CFBamJpaTZDateColByTableIdxKey();
	return( key );
    }
	...
	public CFBamJpaTZDateColByTableIdxKey ensureByTableIdxKey(ICFBamTZDateColByTableIdxKey key) {
		...
		else if (key instanceof CFBamJpaTZDateColByTableIdxKey) {
			return( (CFBamJpaTZDateColByTableIdxKey)key );
		}
		else {
			CFBamJpaTZDateColByTableIdxKey mapped = new CFBamJpaTZDateColByTableIdxKey();
