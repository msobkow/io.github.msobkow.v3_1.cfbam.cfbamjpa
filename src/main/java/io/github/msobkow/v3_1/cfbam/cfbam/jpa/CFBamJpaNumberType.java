// Description: Java 25 JPA implementation of a NumberType entity definition object.
...
@Entity
@Table(
	name = "numtyp", schema = "CFBam31",
	indexes = {
		@Index(name = "NumberTypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "NumberTypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaNumberType extends CFBamJpaNumberDef
	implements ICFBamNumberType
{
	...
	public String toString() {
		String ret = "<CFBamJpaNumberType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
