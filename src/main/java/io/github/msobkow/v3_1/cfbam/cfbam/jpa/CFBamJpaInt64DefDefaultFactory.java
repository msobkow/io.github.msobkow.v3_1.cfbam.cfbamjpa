...
// Description: Java 25 JPA Default Factory implementation for Int64Def.
...
/*
 *	CFBamInt64DefFactory JPA implementation for Int64Def
 */
public class CFBamJpaInt64DefDefaultFactory
    implements ICFBamInt64DefFactory
{
    public CFBamJpaInt64DefDefaultFactory() {
    }

    @Override
    public ICFBamInt64Def newRec() {
        ICFBamInt64Def rec =
            new CFBamJpaInt64Def();
        return( rec );
    }
