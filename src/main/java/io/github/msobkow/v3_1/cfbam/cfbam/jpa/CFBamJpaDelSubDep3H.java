// Description: Java 25 JPA implementation of DelSubDep3 history objects
...
/**
 *  CFBamJpaDelSubDep3H provides history objects matching the CFBamDelSubDep3 change history.
 */
@Entity
@Table(
    name = "delsubdep3_h", schema = "CFBam31",
    indexes = {
        @Index(name = "DelSubDep3IdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "DelSubDep3DelSubDep2Idx_h", columnList = "contdeldep2id", unique = false),
        @Index(name = "DelSubDep3UNameIdx_h", columnList = "contdeldep2id, safe_name", unique = true)
    }
)
...
public class CFBamJpaDelSubDep3H extends CFBamJpaDelDepH
    implements ICFBamDelSubDep3H
{
	@AttributeOverrides({
		@AttributeOverride(name="bytes", column = @Column( name="contdeldep2id", nullable=false, length=CFLibDbKeyHash256.HASH_LENGTH ) )
	})
	protected CFLibDbKeyHash256 requiredDelSubDep2Id;
	@Column( name="safe_name", nullable=false, length=192 )
	protected String requiredName;

    public CFBamJpaDelSubDep3H() {
            super();
    ...
    public String toString() {
        String ret = "<CFBamJpaDelSubDep3H" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
