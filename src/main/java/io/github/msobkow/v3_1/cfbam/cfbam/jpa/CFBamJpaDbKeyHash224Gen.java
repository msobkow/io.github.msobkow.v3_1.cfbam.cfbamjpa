// Description: Java 25 JPA implementation of a DbKeyHash224Gen entity definition object.
...
@Entity
@Table(
	name = "idgdbk224", schema = "CFBam31",
	indexes = {
		@Index(name = "DbKeyHash224GenIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaDbKeyHash224Gen extends CFBamJpaDbKeyHash224Type
	implements ICFBamDbKeyHash224Gen
{
	...
	public CFBamJpaDbKeyHash224Gen() {
		super();
	...
	public String toString() {
		String ret = "<CFBamJpaDbKeyHash224Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
