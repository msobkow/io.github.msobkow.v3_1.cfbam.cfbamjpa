// Description: Java 25 JPA implementation of a NmTokensType by SchemaIdx index key object.
...
public class CFBamJpaNmTokensTypeBySchemaIdxKey
	implements ICFBamNmTokensTypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaNmTokensTypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamNmTokensTypeBySchemaIdxKey, ICFBamNmTokensType, ICFBamNmTokensTypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamNmTokensTypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
