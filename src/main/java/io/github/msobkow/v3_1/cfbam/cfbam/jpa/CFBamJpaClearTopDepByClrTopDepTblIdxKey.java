// Description: Java 25 JPA implementation of a ClearTopDep by ClrTopDepTblIdx index key object.
...
public class CFBamJpaClearTopDepByClrTopDepTblIdxKey
	implements ICFBamClearTopDepByClrTopDepTblIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamClearTopDepByClrTopDepTblIdxKey, ICFBamClearTopDep, ICFBamClearTopDepH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamClearTopDepByClrTopDepTblIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
