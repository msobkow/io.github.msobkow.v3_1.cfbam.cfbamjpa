// Description: Java 25 JPA implementation of a DbKeyHash160Col by TableIdx index key object.
...
public class CFBamJpaDbKeyHash160ColByTableIdxKey
	implements ICFBamDbKeyHash160ColByTableIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	public CFBamJpaDbKeyHash160ColByTableIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDbKeyHash160ColByTableIdxKey, ICFBamDbKeyHash160Col, ICFBamDbKeyHash160ColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDbKeyHash160ColByTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
