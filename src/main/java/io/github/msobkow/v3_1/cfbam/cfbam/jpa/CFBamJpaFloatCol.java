// Description: Java 25 JPA implementation of a FloatCol entity definition object.
...
@Entity
@Table(
	name = "fltcol", schema = "CFBam31",
	indexes = {
		@Index(name = "FloatColIdIdx", columnList = "Id", unique = true),
		@Index(name = "FloatColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaFloatCol extends CFBamJpaFloatDef
	implements ICFBamFloatCol
{
	...
	public String toString() {
		String ret = "<CFBamJpaFloatCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
