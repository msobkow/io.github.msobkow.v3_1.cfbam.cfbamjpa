// Description: Java 25 JPA implementation of a TimestampCol entity definition object.
...
@Entity
@Table(
	name = "tscol", schema = "CFBam31",
	indexes = {
		@Index(name = "TimestampColIdIdx", columnList = "Id", unique = true),
		@Index(name = "TimestampColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaTimestampCol extends CFBamJpaTimestampDef
	implements ICFBamTimestampCol
{
	...
	public String toString() {
		String ret = "<CFBamJpaTimestampCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
