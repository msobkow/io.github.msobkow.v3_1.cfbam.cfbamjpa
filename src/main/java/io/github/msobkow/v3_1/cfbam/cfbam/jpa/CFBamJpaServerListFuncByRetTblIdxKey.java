// Description: Java 25 JPA implementation of a ServerListFunc by RetTblIdx index key object.
	...
	implements ICFBamServerListFuncByRetTblIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamServerListFuncByRetTblIdxKey, ICFBamServerListFunc, ICFBamServerListFuncH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamServerListFuncByRetTblIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
