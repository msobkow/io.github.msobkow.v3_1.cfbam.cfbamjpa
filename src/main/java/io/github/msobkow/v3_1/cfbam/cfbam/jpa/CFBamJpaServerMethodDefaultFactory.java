...
// Description: Java 25 JPA Default Factory implementation for ServerMethod.
...
/*
 *	CFBamServerMethodFactory JPA implementation for ServerMethod
 */
public class CFBamJpaServerMethodDefaultFactory
    implements ICFBamServerMethodFactory
{
    public CFBamJpaServerMethodDefaultFactory() {
    }

    @Override
    public ICFBamServerMethodByUNameIdxKey newByUNameIdxKey() {
	ICFBamServerMethodByUNameIdxKey key =
            new CFBamJpaServerMethodByUNameIdxKey();
	return( key );
    }
	...
	ICFBamServerMethodByDefSchemaIdxKey key =
            new CFBamJpaServerMethodByDefSchemaIdxKey();
	return( key );
    }
