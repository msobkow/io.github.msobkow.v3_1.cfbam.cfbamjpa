...
// Description: Java 25 JPA Default Factory implementation for TokenType.
...
/*
 *	CFBamTokenTypeFactory JPA implementation for TokenType
 */
public class CFBamJpaTokenTypeDefaultFactory
    implements ICFBamTokenTypeFactory
{
    public CFBamJpaTokenTypeDefaultFactory() {
    }

    @Override
    public ICFBamTokenTypeBySchemaIdxKey newBySchemaIdxKey() {
	ICFBamTokenTypeBySchemaIdxKey key =
            new CFBamJpaTokenTypeBySchemaIdxKey();
	return( key );
    }
	...
	public CFBamJpaTokenTypeBySchemaIdxKey ensureBySchemaIdxKey(ICFBamTokenTypeBySchemaIdxKey key) {
		...
		else if (key instanceof CFBamJpaTokenTypeBySchemaIdxKey) {
			return( (CFBamJpaTokenTypeBySchemaIdxKey)key );
		}
		else {
			CFBamJpaTokenTypeBySchemaIdxKey mapped = new CFBamJpaTokenTypeBySchemaIdxKey();
