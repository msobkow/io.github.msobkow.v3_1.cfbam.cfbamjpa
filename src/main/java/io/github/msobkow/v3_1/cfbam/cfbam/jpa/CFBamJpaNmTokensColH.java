// Description: Java 25 JPA implementation of NmTokensCol history objects
...
/**
 *  CFBamJpaNmTokensColH provides history objects matching the CFBamNmTokensCol change history.
 */
@Entity
@Table(
    name = "nmtknscol_h", schema = "CFBam31",
    indexes = {
        @Index(name = "NmTokensColIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "NmTokensColTableIdx_h", columnList = "TableId", unique = false)
    }
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43129")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaNmTokensColH extends CFBamJpaNmTokensDefH
    implements ICFBamNmTokensColH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof ICFBamNmTokensCol ) {
			setNmTokensCol( (ICFBamNmTokensCol)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamJpaNmTokensColH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
