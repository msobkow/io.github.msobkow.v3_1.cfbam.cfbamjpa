...
public class CFBamJpaInt16TypeTable implements ICFBamInt16TypeTable
{
		...
		ICFBamInt16Type rec )
	{
		if (rec == null) {
			...
			CFBamJpaInt16Type created = int16typeService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamInt16Type rec )
	{
		if (rec == null) {
			...
			CFBamJpaInt16Type jparec = (CFBamJpaInt16Type)rec;
			CFBamJpaInt16Type updated = int16typeService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamInt16Type rec )
	{
		...
		if (rec instanceof CFBamJpaInt16Type) {
			CFBamJpaInt16Type jparec = (CFBamJpaInt16Type)rec;
			int16typeService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		int16typeService.deleteBySchemaIdx(argSchemaDefId);
	}
	...
	{
		int16typeService.deleteBySchemaIdx(argKey.getRequiredSchemaDefId());
	}
	...
	{
		int16typeService.deleteByIdIdx(argKey);
	}
	...
	public void deleteInt16TypeByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		int16typeService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		int16typeService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteInt16TypeByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		int16typeService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		int16typeService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		int16typeService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		int16typeService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		int16typeService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		int16typeService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		int16typeService.deleteByNextIdx(argNextId);
	}
	...
	{
		int16typeService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteInt16TypeByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		int16typeService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		int16typeService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteInt16TypeByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		int16typeService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		int16typeService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( int16typeService.find(PKey) );
	}
	...
	public ICFBamInt16Type lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( int16typeService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamInt16Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaInt16Type> results = int16typeService.findAll();
	...
	{
		return( int16typeService.find(argId) );
	}
	...
	public ICFBamInt16Type readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( int16typeService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamInt16Type[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaInt16Type> results = int16typeService.findByScopeIdx(argScopeId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Type[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaInt16Type> results = int16typeService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Type[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaInt16Type> results = int16typeService.findByPrevIdx(argPrevId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Type[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaInt16Type> results = int16typeService.findByNextIdx(argNextId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Type[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaInt16Type> results = int16typeService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
	...
	public ICFBamInt16Type[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaInt16Type> results = int16typeService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
	...
	public ICFBamInt16Type[] readDerivedBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argSchemaDefId )
	{
		List<CFBamJpaInt16Type> results = int16typeService.findBySchemaIdx(argSchemaDefId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
			retset[idx++] = cur;
