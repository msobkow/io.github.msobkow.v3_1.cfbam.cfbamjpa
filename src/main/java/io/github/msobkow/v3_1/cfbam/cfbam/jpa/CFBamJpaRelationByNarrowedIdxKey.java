// Description: Java 25 JPA implementation of a Relation by NarrowedIdx index key object.
	...
	implements ICFBamRelationByNarrowedIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamRelationByNarrowedIdxKey, ICFBamRelation, ICFBamRelationH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamRelationByNarrowedIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
