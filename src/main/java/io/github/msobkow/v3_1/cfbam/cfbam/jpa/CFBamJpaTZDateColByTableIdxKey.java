// Description: Java 25 JPA implementation of a TZDateCol by TableIdx index key object.
...
public class CFBamJpaTZDateColByTableIdxKey
	implements ICFBamTZDateColByTableIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	public CFBamJpaTZDateColByTableIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTZDateColByTableIdxKey, ICFBamTZDateCol, ICFBamTZDateColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTZDateColByTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
