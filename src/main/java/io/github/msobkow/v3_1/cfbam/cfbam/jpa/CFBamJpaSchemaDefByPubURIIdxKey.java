// Description: Java 25 JPA implementation of a SchemaDef by PubURIIdx index key object.
...
public class CFBamJpaSchemaDefByPubURIIdxKey
	implements ICFBamSchemaDefByPubURIIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamSchemaDefByPubURIIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
