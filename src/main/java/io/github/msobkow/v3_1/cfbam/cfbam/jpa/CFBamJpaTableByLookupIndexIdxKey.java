// Description: Java 25 JPA implementation of a Table by LookupIndexIdx index key object.
	...
	implements ICFBamTableByLookupIndexIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTableByLookupIndexIdxKey, ICFBamTable, ICFBamTableH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTableByLookupIndexIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
