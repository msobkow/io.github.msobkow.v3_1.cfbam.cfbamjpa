// Description: Java 25 Spring JPA Service for Int32Type
...
/**
 *	Service for the CFBamInt32Type entities defined in io.github.msobkow.v3_1.cfbam.cfbam.jpa
 *	using the CFBamInt32TypeRepository to access them.
 */
@Service("cfbam31JpaInt32TypeService")
public class CFBamJpaInt32TypeService {
	...
	@Autowired
	private CFBamJpaInt32TypeRepository cfbam31Int32TypeRepository;

	/**
	 *	Create an entity, generating any database keys required along the way.
	 *
	 *		@param	data	The entity to be instantiated; must be a specific instance of CFBamJpaInt32Type, not a subclass.
	 *
	...
	public CFBamJpaInt32Type create(CFBamJpaInt32Type data) {
		...
		try {
			...
			if(data.getPKey() != null && cfbam31Int32TypeRepository.existsById((CFLibDbKeyHash256)data.getPKey())) {
				return( (CFBamJpaInt32Type)(cfbam31Int32TypeRepository.findById((CFLibDbKeyHash256)(data.getPKey())).get()));
			}
			return cfbam31Int32TypeRepository.save(data);
		}
		catch(Exception ex) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED,rollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt32Type update(CFBamJpaInt32Type data) {
		...
		CFBamJpaInt32Type existing = cfbam31Int32TypeRepository.findById((CFLibDbKeyHash256)(data.getPKey()))
		...
		return cfbam31Int32TypeRepository.save(existing);
	}
	...
	public CFBamJpaInt32Type find(@Param("id") CFLibDbKeyHash256 requiredId) {
		return( cfbam31Int32TypeRepository.get(requiredId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findAll() {
		return( cfbam31Int32TypeRepository.findAll() );
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt32Type findByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName) {
		return( cfbam31Int32TypeRepository.findByUNameIdx(requiredScopeId,
			requiredName));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt32Type findByUNameIdx(ICFBamValueByUNameIdxKey key) {
		return( cfbam31Int32TypeRepository.findByUNameIdx(key.getRequiredScopeId(), key.getRequiredName()));
	}
	 ...
	 *		@param requiredScopeId
	 *
	 *		@return List&lt;CFBamJpaInt32Type&gt; of the found entities, or an empty list if no such entities exist.
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId) {
		return( cfbam31Int32TypeRepository.findByScopeIdx(requiredScopeId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findByScopeIdx(ICFBamValueByScopeIdxKey key) {
		return( cfbam31Int32TypeRepository.findByScopeIdx(key.getRequiredScopeId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId) {
		return( cfbam31Int32TypeRepository.findByDefSchemaIdx(optionalDefSchemaId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
		return( cfbam31Int32TypeRepository.findByDefSchemaIdx(key.getOptionalDefSchemaId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Int32TypeRepository.findByPrevIdx(optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findByPrevIdx(ICFBamValueByPrevIdxKey key) {
		return( cfbam31Int32TypeRepository.findByPrevIdx(key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Int32TypeRepository.findByNextIdx(optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findByNextIdx(ICFBamValueByNextIdxKey key) {
		return( cfbam31Int32TypeRepository.findByNextIdx(key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Int32TypeRepository.findByContPrevIdx(requiredScopeId,
			optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
		return( cfbam31Int32TypeRepository.findByContPrevIdx(key.getRequiredScopeId(), key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Int32TypeRepository.findByContNextIdx(requiredScopeId,
			optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findByContNextIdx(ICFBamValueByContNextIdxKey key) {
		return( cfbam31Int32TypeRepository.findByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findBySchemaIdx(@Param("schemaDefId") CFLibDbKeyHash256 requiredSchemaDefId) {
		return( cfbam31Int32TypeRepository.findBySchemaIdx(requiredSchemaDefId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> findBySchemaIdx(ICFBamInt32TypeBySchemaIdxKey key) {
		return( cfbam31Int32TypeRepository.findBySchemaIdx(key.getRequiredSchemaDefId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt32Type lockByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId) {
		return( cfbam31Int32TypeRepository.lockByIdIdx(requiredId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt32Type lockByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName) {
		return( cfbam31Int32TypeRepository.lockByUNameIdx(requiredScopeId,
			requiredName));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt32Type lockByUNameIdx(ICFBamValueByUNameIdxKey key) {
		return( cfbam31Int32TypeRepository.lockByUNameIdx(key.getRequiredScopeId(), key.getRequiredName()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId) {
		return( cfbam31Int32TypeRepository.lockByScopeIdx(requiredScopeId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockByScopeIdx(ICFBamValueByScopeIdxKey key) {
		return( cfbam31Int32TypeRepository.lockByScopeIdx(key.getRequiredScopeId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId) {
		return( cfbam31Int32TypeRepository.lockByDefSchemaIdx(optionalDefSchemaId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
		return( cfbam31Int32TypeRepository.lockByDefSchemaIdx(key.getOptionalDefSchemaId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Int32TypeRepository.lockByPrevIdx(optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockByPrevIdx(ICFBamValueByPrevIdxKey key) {
		return( cfbam31Int32TypeRepository.lockByPrevIdx(key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Int32TypeRepository.lockByNextIdx(optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockByNextIdx(ICFBamValueByNextIdxKey key) {
		return( cfbam31Int32TypeRepository.lockByNextIdx(key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Int32TypeRepository.lockByContPrevIdx(requiredScopeId,
			optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
		return( cfbam31Int32TypeRepository.lockByContPrevIdx(key.getRequiredScopeId(), key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Int32TypeRepository.lockByContNextIdx(requiredScopeId,
			optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockByContNextIdx(ICFBamValueByContNextIdxKey key) {
		return( cfbam31Int32TypeRepository.lockByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockBySchemaIdx(@Param("schemaDefId") CFLibDbKeyHash256 requiredSchemaDefId) {
		return( cfbam31Int32TypeRepository.lockBySchemaIdx(requiredSchemaDefId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt32Type> lockBySchemaIdx(ICFBamInt32TypeBySchemaIdxKey key) {
		return( cfbam31Int32TypeRepository.lockBySchemaIdx(key.getRequiredSchemaDefId()));
	}
	...
	public void deleteByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId) {
		cfbam31Int32TypeRepository.deleteByIdIdx(requiredId);
	}
	...
	public void deleteByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName) {
		cfbam31Int32TypeRepository.deleteByUNameIdx(requiredScopeId,
			requiredName);
	}
	...
	public void deleteByUNameIdx(ICFBamValueByUNameIdxKey key) {
		cfbam31Int32TypeRepository.deleteByUNameIdx(key.getRequiredScopeId(), key.getRequiredName());
	}
	...
	public void deleteByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId) {
		cfbam31Int32TypeRepository.deleteByScopeIdx(requiredScopeId);
	}
	...
	public void deleteByScopeIdx(ICFBamValueByScopeIdxKey key) {
		cfbam31Int32TypeRepository.deleteByScopeIdx(key.getRequiredScopeId());
	}
	...
	public void deleteByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId) {
		cfbam31Int32TypeRepository.deleteByDefSchemaIdx(optionalDefSchemaId);
	}
	...
	public void deleteByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
		cfbam31Int32TypeRepository.deleteByDefSchemaIdx(key.getOptionalDefSchemaId());
	}
	...
	public void deleteByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		cfbam31Int32TypeRepository.deleteByPrevIdx(optionalPrevId);
	}
	...
	public void deleteByPrevIdx(ICFBamValueByPrevIdxKey key) {
		cfbam31Int32TypeRepository.deleteByPrevIdx(key.getOptionalPrevId());
	}
	...
	public void deleteByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		cfbam31Int32TypeRepository.deleteByNextIdx(optionalNextId);
	}
	...
	public void deleteByNextIdx(ICFBamValueByNextIdxKey key) {
		cfbam31Int32TypeRepository.deleteByNextIdx(key.getOptionalNextId());
	}
	...
	public void deleteByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		cfbam31Int32TypeRepository.deleteByContPrevIdx(requiredScopeId,
			optionalPrevId);
	}
	...
	public void deleteByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
		cfbam31Int32TypeRepository.deleteByContPrevIdx(key.getRequiredScopeId(), key.getOptionalPrevId());
	}
	...
	public void deleteByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		cfbam31Int32TypeRepository.deleteByContNextIdx(requiredScopeId,
			optionalNextId);
	}
	...
	public void deleteByContNextIdx(ICFBamValueByContNextIdxKey key) {
		cfbam31Int32TypeRepository.deleteByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId());
	}
	...
	public void deleteBySchemaIdx(@Param("schemaDefId") CFLibDbKeyHash256 requiredSchemaDefId) {
		cfbam31Int32TypeRepository.deleteBySchemaIdx(requiredSchemaDefId);
	}
	...
	public void deleteBySchemaIdx(ICFBamInt32TypeBySchemaIdxKey key) {
		cfbam31Int32TypeRepository.deleteBySchemaIdx(key.getRequiredSchemaDefId());
	}
}
