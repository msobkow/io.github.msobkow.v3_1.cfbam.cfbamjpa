// Description: Java 25 JPA implementation of a SchemaRef by PrevIdx index key object.
	...
	implements ICFBamSchemaRefByPrevIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamSchemaRefByPrevIdxKey, ICFBamSchemaRef, ICFBamSchemaRefH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamSchemaRefByPrevIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
