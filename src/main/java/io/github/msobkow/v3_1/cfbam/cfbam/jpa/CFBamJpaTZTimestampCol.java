// Description: Java 25 JPA implementation of a TZTimestampCol entity definition object.
...
@Entity
@Table(
	name = "zscol", schema = "CFBam31",
	indexes = {
		@Index(name = "TZTimestampColIdIdx", columnList = "Id", unique = true),
		@Index(name = "TZTimestampColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaTZTimestampCol extends CFBamJpaTZTimestampDef
	implements ICFBamTZTimestampCol
{
	...
	public String toString() {
		String ret = "<CFBamJpaTZTimestampCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
