// Description: Java 25 JPA implementation of a TZDateDef entity definition object.
...
@Entity
@Table(
	name = "dzdef", schema = "CFBam31",
	indexes = {
		@Index(name = "TZDateDefIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaTZDateDef extends CFBamJpaAtom
	implements ICFBamTZDateDef
{
	...
	public String toString() {
		String ret = "<CFBamJpaTZDateDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
