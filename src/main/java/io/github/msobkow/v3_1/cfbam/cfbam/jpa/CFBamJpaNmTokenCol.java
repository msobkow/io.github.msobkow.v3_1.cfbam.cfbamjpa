// Description: Java 25 JPA implementation of a NmTokenCol entity definition object.
...
@Entity
@Table(
	name = "nmtkncol", schema = "CFBam31",
	indexes = {
		@Index(name = "NmTokenColIdIdx", columnList = "Id", unique = true),
		@Index(name = "NmTokenColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaNmTokenCol extends CFBamJpaNmTokenDef
	implements ICFBamNmTokenCol
{
	...
	public String toString() {
		String ret = "<CFBamJpaNmTokenCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
