// Description: Java 25 Spring JPA Repository for StringType
...
/**
 *	JpaRepository for the CFBamJpaStringType entities defined in io.github.msobkow.v3_1.cfbam.cfbam.jpa.
 *	The manufactured repositories try to provide a rich, do-it-all interface to the JPA data store, with both object and argument-based implementations of the interface defined.
 */
@Transactional(readOnly = true)
public interface CFBamJpaStringTypeRepository extends JpaRepository<CFBamJpaStringType, CFLibDbKeyHash256> {
	...
	CFBamJpaStringType get(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	CFBamJpaStringType findByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity, typically from the JPA cache, or null if no such entity exists.
	 */
	default CFBamJpaStringType findByUNameIdx(ICFBamValueByUNameIdxKey key) {
	 ...
	 *		@param requiredScopeId
	 *
	 *		@return List&lt;CFBamJpaStringType&gt; of the found entities, typically from the JPA cache, or an empty list if no such entities exist.
	 */
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId")
	List<CFBamJpaStringType> findByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId);
	 ...
	 */
	default List<CFBamJpaStringType> findByScopeIdx(ICFBamValueByScopeIdxKey key) {
	...
	List<CFBamJpaStringType> findByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaStringType> findByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
	...
	List<CFBamJpaStringType> findByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaStringType> findByPrevIdx(ICFBamValueByPrevIdxKey key) {
	...
	List<CFBamJpaStringType> findByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaStringType> findByNextIdx(ICFBamValueByNextIdxKey key) {
	...
	List<CFBamJpaStringType> findByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaStringType> findByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
	...
	List<CFBamJpaStringType> findByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaStringType> findByContNextIdx(ICFBamValueByContNextIdxKey key) {
		return( findByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId()));
	}

	// CFBamJpaAtom specified index readers

	// CFBamJpaStringDef specified index readers

	// CFBamJpaStringType specified index readers

	/**
	 *	Read zero or more entities into a List using the columns of the CFBamStringTypeBySchemaIdxKey as arguments.
	 *
	 *		@param requiredSchemaDefId
	 *
	 *		@return List&lt;CFBamJpaStringType&gt; of the found entities, typically from the JPA cache, or an empty list if no such entities exist.
	 */
	@Query("select r from CFBamJpaStringType r where r.requiredSchemaDefId = :schemaDefId")
	List<CFBamJpaStringType> findBySchemaIdx(@Param("schemaDefId") CFLibDbKeyHash256 requiredSchemaDefId);

	/**
	 *	CFBamStringTypeBySchemaIdxKey entity list reader convenience method for object-based access.
	 *
	 *		@param key The CFBamStringTypeBySchemaIdxKey instance to use for the query arguments.
	 *
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaStringType> findBySchemaIdx(ICFBamStringTypeBySchemaIdxKey key) {
	...
	@Query("select r from CFBamJpaValue r where r.requiredId = :id")
	CFBamJpaStringType lockByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.requiredName = :name")
	CFBamJpaStringType lockByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName);
	 ...
	 *		@return The locked entity, refreshed from the data store, or null if no such entity exists.
	 */
	default CFBamJpaStringType lockByUNameIdx(ICFBamValueByUNameIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId")
	List<CFBamJpaStringType> lockByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaStringType> lockByScopeIdx(ICFBamValueByScopeIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaStringType> lockByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaStringType> lockByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaStringType> lockByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaStringType> lockByPrevIdx(ICFBamValueByPrevIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaStringType> lockByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaStringType> lockByNextIdx(ICFBamValueByNextIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaStringType> lockByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaStringType> lockByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaStringType> lockByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaStringType> lockByContNextIdx(ICFBamValueByContNextIdxKey key) {
		return( lockByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId()));
	}

	// CFBamJpaAtom specified delete-by-index methods

	// CFBamJpaStringDef specified delete-by-index methods

	// CFBamJpaStringType specified delete-by-index methods
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaStringType r where r.requiredSchemaDefId = :schemaDefId")
	List<CFBamJpaStringType> lockBySchemaIdx(@Param("schemaDefId") CFLibDbKeyHash256 requiredSchemaDefId);

	/**
	 *	CFBamStringTypeBySchemaIdxKey based lock method for object-based access.
	 *
	 *		@param key The key of the entity to be locked.
	 *
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaStringType> lockBySchemaIdx(ICFBamStringTypeBySchemaIdxKey key) {
	...
	@Transactional
	@Modifying
	@Query("delete from CFBamJpaStringType r where r.requiredSchemaDefId = :schemaDefId")
	void deleteBySchemaIdx(@Param("schemaDefId") CFLibDbKeyHash256 requiredSchemaDefId);

	/**
	 *	CFBamStringTypeBySchemaIdxKey based lock method for object-based access.
	 *
	 *		@param key The CFBamStringTypeBySchemaIdxKey of the entity to be locked.
	 */
	default void deleteBySchemaIdx(ICFBamStringTypeBySchemaIdxKey key) {
