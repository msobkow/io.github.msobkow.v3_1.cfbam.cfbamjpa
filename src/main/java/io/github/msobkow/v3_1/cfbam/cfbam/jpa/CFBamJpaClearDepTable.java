...
public class CFBamJpaClearDepTable implements ICFBamClearDepTable
{
		...
		ICFBamClearDep rec )
	{
		if (rec == null) {
			...
			CFBamJpaClearDep created = cleardepService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamClearDep rec )
	{
		if (rec == null) {
			...
			CFBamJpaClearDep jparec = (CFBamJpaClearDep)rec;
			CFBamJpaClearDep updated = cleardepService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamClearDep rec )
	{
		...
		if (rec instanceof CFBamJpaClearDep) {
			CFBamJpaClearDep jparec = (CFBamJpaClearDep)rec;
			cleardepService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		cleardepService.deleteByClearDepIdx(argRelationId);
	}
	...
	{
		cleardepService.deleteByClearDepIdx(argKey.getRequiredRelationId());
	}
	...
	{
		cleardepService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		cleardepService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		cleardepService.deleteByIdIdx(argKey);
	}
	...
	{
		cleardepService.deleteByTenantIdx(argTenantId);
	}
	...
	{
		cleardepService.deleteByTenantIdx(argKey.getRequiredTenantId());
	}
	...
	{
		return( cleardepService.find(PKey) );
	}
	...
	public ICFBamClearDep lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( cleardepService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamClearDep[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaClearDep> results = cleardepService.findAll();
	...
	{
		return( cleardepService.find(argId) );
	}
	...
	public ICFBamClearDep[] readDerivedByTenantIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTenantId )
	{
		List<CFBamJpaClearDep> results = cleardepService.findByTenantIdx(argTenantId);
		ICFBamClearDep[] retset = new ICFBamClearDep[results.size()];
		int idx = 0;
		for (CFBamJpaClearDep cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamClearDep[] readDerivedByClearDepIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argRelationId )
	{
		List<CFBamJpaClearDep> results = cleardepService.findByClearDepIdx(argRelationId);
		ICFBamClearDep[] retset = new ICFBamClearDep[results.size()];
		int idx = 0;
		for (CFBamJpaClearDep cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamClearDep[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaClearDep> results = cleardepService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamClearDep[] retset = new ICFBamClearDep[results.size()];
		int idx = 0;
		for (CFBamJpaClearDep cur: results) {
			retset[idx++] = cur;
