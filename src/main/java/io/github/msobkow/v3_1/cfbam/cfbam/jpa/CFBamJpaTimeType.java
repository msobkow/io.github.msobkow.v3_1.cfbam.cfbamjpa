// Description: Java 25 JPA implementation of a TimeType entity definition object.
...
@Entity
@Table(
	name = "tmtyp", schema = "CFBam31",
	indexes = {
		@Index(name = "TimeTypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "TimeTypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaTimeType extends CFBamJpaTimeDef
	implements ICFBamTimeType
{
	...
	public String toString() {
		String ret = "<CFBamJpaTimeType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
