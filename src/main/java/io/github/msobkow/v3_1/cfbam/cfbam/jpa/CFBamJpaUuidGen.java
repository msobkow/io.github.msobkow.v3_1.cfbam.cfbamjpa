// Description: Java 25 JPA implementation of a UuidGen entity definition object.
...
@Entity
@Table(
	name = "idguuid", schema = "CFBam31",
	indexes = {
		@Index(name = "UuidGenIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaUuidGen extends CFBamJpaUuidType
	implements ICFBamUuidGen
{
	...
	public String toString() {
		String ret = "<CFBamJpaUuidGen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
