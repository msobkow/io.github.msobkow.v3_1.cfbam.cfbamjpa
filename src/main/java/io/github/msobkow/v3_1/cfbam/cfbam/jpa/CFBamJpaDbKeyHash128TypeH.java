// Description: Java 25 JPA implementation of DbKeyHash128Type history objects
...
/**
 *  CFBamJpaDbKeyHash128TypeH provides history objects matching the CFBamDbKeyHash128Type change history.
 */
@Entity
@Table(
    name = "dbk128typ_h", schema = "CFBam31",
    indexes = {
        @Index(name = "DbKeyHash128TypeIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "DbKeyHash128TypeSchemaDefIdx_h", columnList = "SchemaDefId", unique = false)
    }
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43066")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaDbKeyHash128TypeH extends CFBamJpaDbKeyHash128DefH
    implements ICFBamDbKeyHash128TypeH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof ICFBamDbKeyHash128Type ) {
			setDbKeyHash128Type( (ICFBamDbKeyHash128Type)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamJpaDbKeyHash128TypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
