// Description: Java 25 JPA implementation of UuidDef history objects
...
/**
 *  CFBamJpaUuidDefH provides history objects matching the CFBamUuidDef change history.
 */
@Entity
@Table(
    name = "uuiddef_h", schema = "CFBam31",
    indexes = {
        @Index(name = "UuidDefIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true)
    }
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43111")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaUuidDefH extends CFBamJpaAtomH
    implements ICFBamUuidDefH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaUuidDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
