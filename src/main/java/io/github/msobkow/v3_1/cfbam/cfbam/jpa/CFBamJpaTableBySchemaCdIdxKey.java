// Description: Java 25 JPA implementation of a Table by SchemaCdIdx index key object.
...
public class CFBamJpaTableBySchemaCdIdxKey
	implements ICFBamTableBySchemaCdIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamTableBySchemaCdIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
