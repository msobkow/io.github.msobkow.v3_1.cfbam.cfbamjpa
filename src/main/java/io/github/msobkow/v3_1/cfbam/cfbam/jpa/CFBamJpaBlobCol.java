// Description: Java 25 JPA implementation of a BlobCol entity definition object.
...
@Entity
@Table(
	name = "blbcol", schema = "CFBam31",
	indexes = {
		@Index(name = "BlobColIdIdx", columnList = "Id", unique = true),
		@Index(name = "BlobColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaBlobCol extends CFBamJpaBlobDef
	implements ICFBamBlobCol
{
	...
	public String toString() {
		String ret = "<CFBamJpaBlobCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
