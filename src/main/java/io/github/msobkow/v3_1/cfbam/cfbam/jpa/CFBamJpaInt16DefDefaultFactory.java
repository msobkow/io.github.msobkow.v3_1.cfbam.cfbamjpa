...
// Description: Java 25 JPA Default Factory implementation for Int16Def.
...
/*
 *	CFBamInt16DefFactory JPA implementation for Int16Def
 */
public class CFBamJpaInt16DefDefaultFactory
    implements ICFBamInt16DefFactory
{
    public CFBamJpaInt16DefDefaultFactory() {
    }

    @Override
    public ICFBamInt16Def newRec() {
        ICFBamInt16Def rec =
            new CFBamJpaInt16Def();
        return( rec );
    }
	...
	public CFBamJpaInt16DefH ensureHRec(ICFBamInt16DefH hrec) {
		...
		else if( hrec instanceof CFBamJpaInt16DefH) {
			return( (CFBamJpaInt16DefH)hrec );
		}
		else {
