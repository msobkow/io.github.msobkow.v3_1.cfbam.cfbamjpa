// Description: Java 25 JPA implementation of Uuid6Type history objects
...
/**
 *  CFBamJpaUuid6TypeH provides history objects matching the CFBamUuid6Type change history.
 */
@Entity
@Table(
    name = "uuid6typ_h", schema = "CFBam31",
    indexes = {
        @Index(name = "Uuid6TypeIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "Uuid6TypeSchemaDefIdx_h", columnList = "SchemaDefId", unique = false)
    }
)
...
public class CFBamJpaUuid6TypeH extends CFBamJpaUuid6DefH
    implements ICFBamUuid6TypeH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaUuid6TypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
