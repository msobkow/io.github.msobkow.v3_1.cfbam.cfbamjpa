// Description: Java 25 JPA implementation of a EnumType entity definition object.
...
@Entity
@Table(
	name = "enumtyp", schema = "CFBam31",
	indexes = {
		@Index(name = "EnumTypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "EnumTypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaEnumType extends CFBamJpaEnumDef
	implements ICFBamEnumType
{
	...
	public String toString() {
		String ret = "<CFBamJpaEnumType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
