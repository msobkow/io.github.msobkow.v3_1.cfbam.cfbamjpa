// Description: Java 25 JPA implementation of a TimestampType entity definition object.
...
@Entity
@Table(
	name = "tstyp", schema = "CFBam31",
	indexes = {
		@Index(name = "TimestampTypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "TimestampTypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43102")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaTimestampType extends CFBamJpaTimestampDef
	implements ICFBamTimestampType
{
	...
	public String toString() {
		String ret = "<CFBamJpaTimestampType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
