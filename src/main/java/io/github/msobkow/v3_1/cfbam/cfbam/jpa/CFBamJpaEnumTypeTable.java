...
public class CFBamJpaEnumTypeTable implements ICFBamEnumTypeTable
{
		...
		ICFBamEnumType rec )
	{
		if (rec == null) {
			...
			CFBamJpaEnumType created = enumtypeService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamEnumType rec )
	{
		if (rec == null) {
			...
			CFBamJpaEnumType jparec = (CFBamJpaEnumType)rec;
			CFBamJpaEnumType updated = enumtypeService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamEnumType rec )
	{
		...
		if (rec instanceof CFBamJpaEnumType) {
			CFBamJpaEnumType jparec = (CFBamJpaEnumType)rec;
			enumtypeService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		enumtypeService.deleteBySchemaIdx(argSchemaDefId);
	}
	...
	{
		enumtypeService.deleteBySchemaIdx(argKey.getRequiredSchemaDefId());
	}
	...
	{
		enumtypeService.deleteByIdIdx(argKey);
	}
	...
	public void deleteEnumTypeByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		enumtypeService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		enumtypeService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteEnumTypeByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		enumtypeService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		enumtypeService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		enumtypeService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		enumtypeService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		enumtypeService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		enumtypeService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		enumtypeService.deleteByNextIdx(argNextId);
	}
	...
	{
		enumtypeService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteEnumTypeByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		enumtypeService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		enumtypeService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteEnumTypeByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		enumtypeService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		enumtypeService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( enumtypeService.find(PKey) );
	}
	...
	public ICFBamEnumType lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( enumtypeService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamEnumType[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaEnumType> results = enumtypeService.findAll();
	...
	{
		return( enumtypeService.find(argId) );
	}
	...
	public ICFBamEnumType readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( enumtypeService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamEnumType[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaEnumType> results = enumtypeService.findByScopeIdx(argScopeId);
		ICFBamEnumType[] retset = new ICFBamEnumType[results.size()];
		int idx = 0;
		for (CFBamJpaEnumType cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamEnumType[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaEnumType> results = enumtypeService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamEnumType[] retset = new ICFBamEnumType[results.size()];
		int idx = 0;
		for (CFBamJpaEnumType cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamEnumType[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaEnumType> results = enumtypeService.findByPrevIdx(argPrevId);
		ICFBamEnumType[] retset = new ICFBamEnumType[results.size()];
		int idx = 0;
		for (CFBamJpaEnumType cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamEnumType[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaEnumType> results = enumtypeService.findByNextIdx(argNextId);
		ICFBamEnumType[] retset = new ICFBamEnumType[results.size()];
		int idx = 0;
		for (CFBamJpaEnumType cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamEnumType[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaEnumType> results = enumtypeService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamEnumType[] retset = new ICFBamEnumType[results.size()];
		int idx = 0;
		for (CFBamJpaEnumType cur: results) {
	...
	public ICFBamEnumType[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaEnumType> results = enumtypeService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamEnumType[] retset = new ICFBamEnumType[results.size()];
		int idx = 0;
		for (CFBamJpaEnumType cur: results) {
	...
	public ICFBamEnumType[] readDerivedBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argSchemaDefId )
	{
		List<CFBamJpaEnumType> results = enumtypeService.findBySchemaIdx(argSchemaDefId);
		ICFBamEnumType[] retset = new ICFBamEnumType[results.size()];
		int idx = 0;
		for (CFBamJpaEnumType cur: results) {
			retset[idx++] = cur;
