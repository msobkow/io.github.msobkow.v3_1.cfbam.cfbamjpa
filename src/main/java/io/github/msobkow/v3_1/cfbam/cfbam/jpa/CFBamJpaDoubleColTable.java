...
public class CFBamJpaDoubleColTable implements ICFBamDoubleColTable
{
		...
		ICFBamDoubleCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaDoubleCol created = doublecolService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamDoubleCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaDoubleCol jparec = (CFBamJpaDoubleCol)rec;
			CFBamJpaDoubleCol updated = doublecolService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamDoubleCol rec )
	{
		...
		if (rec instanceof CFBamJpaDoubleCol) {
			CFBamJpaDoubleCol jparec = (CFBamJpaDoubleCol)rec;
			doublecolService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		doublecolService.deleteByTableIdx(argTableId);
	}
	...
	{
		doublecolService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		doublecolService.deleteByIdIdx(argKey);
	}
	...
	public void deleteDoubleColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		doublecolService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		doublecolService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDoubleColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		doublecolService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		doublecolService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		doublecolService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		doublecolService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		doublecolService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		doublecolService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		doublecolService.deleteByNextIdx(argNextId);
	}
	...
	{
		doublecolService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteDoubleColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		doublecolService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		doublecolService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDoubleColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		doublecolService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		doublecolService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( doublecolService.find(PKey) );
	}
	...
	public ICFBamDoubleCol lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( doublecolService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamDoubleCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaDoubleCol> results = doublecolService.findAll();
	...
	{
		return( doublecolService.find(argId) );
	}
	...
	public ICFBamDoubleCol readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( doublecolService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamDoubleCol[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaDoubleCol> results = doublecolService.findByScopeIdx(argScopeId);
		ICFBamDoubleCol[] retset = new ICFBamDoubleCol[results.size()];
		int idx = 0;
		for (CFBamJpaDoubleCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDoubleCol[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaDoubleCol> results = doublecolService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamDoubleCol[] retset = new ICFBamDoubleCol[results.size()];
		int idx = 0;
		for (CFBamJpaDoubleCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDoubleCol[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDoubleCol> results = doublecolService.findByPrevIdx(argPrevId);
		ICFBamDoubleCol[] retset = new ICFBamDoubleCol[results.size()];
		int idx = 0;
		for (CFBamJpaDoubleCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDoubleCol[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDoubleCol> results = doublecolService.findByNextIdx(argNextId);
		ICFBamDoubleCol[] retset = new ICFBamDoubleCol[results.size()];
		int idx = 0;
		for (CFBamJpaDoubleCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDoubleCol[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDoubleCol> results = doublecolService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamDoubleCol[] retset = new ICFBamDoubleCol[results.size()];
		int idx = 0;
		for (CFBamJpaDoubleCol cur: results) {
	...
	public ICFBamDoubleCol[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDoubleCol> results = doublecolService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamDoubleCol[] retset = new ICFBamDoubleCol[results.size()];
		int idx = 0;
		for (CFBamJpaDoubleCol cur: results) {
	...
	public ICFBamDoubleCol[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaDoubleCol> results = doublecolService.findByTableIdx(argTableId);
		ICFBamDoubleCol[] retset = new ICFBamDoubleCol[results.size()];
		int idx = 0;
		for (CFBamJpaDoubleCol cur: results) {
			retset[idx++] = cur;
