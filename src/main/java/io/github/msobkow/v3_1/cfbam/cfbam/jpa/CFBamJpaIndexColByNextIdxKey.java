// Description: Java 25 JPA implementation of a IndexCol by NextIdx index key object.
	...
	implements ICFBamIndexColByNextIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamIndexColByNextIdxKey, ICFBamIndexCol, ICFBamIndexColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamIndexColByNextIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
