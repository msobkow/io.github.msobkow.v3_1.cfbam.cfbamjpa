...
public class CFBamJpaPopSubDep2Table implements ICFBamPopSubDep2Table
{
		...
		ICFBamPopSubDep2 rec )
	{
		if (rec == null) {
			...
			CFBamJpaPopSubDep2 created = popsubdep2Service.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamPopSubDep2 rec )
	{
		if (rec == null) {
			...
			CFBamJpaPopSubDep2 jparec = (CFBamJpaPopSubDep2)rec;
			CFBamJpaPopSubDep2 updated = popsubdep2Service.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamPopSubDep2 rec )
	{
		...
		if (rec instanceof CFBamJpaPopSubDep2) {
			CFBamJpaPopSubDep2 jparec = (CFBamJpaPopSubDep2)rec;
			popsubdep2Service.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		popsubdep2Service.deleteByPopSubDep1Idx(argPopSubDep1Id);
	}
	...
	{
		popsubdep2Service.deleteByPopSubDep1Idx(argKey.getRequiredPopSubDep1Id());
	}
	...
	public void deletePopSubDep2ByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		popsubdep2Service.deleteByUNameIdx(argPopSubDep1Id,
		argName);
	}
	...
	{
		popsubdep2Service.deleteByUNameIdx(argKey.getRequiredPopSubDep1Id(),
	...
	{
		popsubdep2Service.deleteByRelationIdx(argRelationId);
	}
	...
	{
		popsubdep2Service.deleteByRelationIdx(argKey.getRequiredRelationId());
	}
	...
	{
		popsubdep2Service.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		popsubdep2Service.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		popsubdep2Service.deleteByIdIdx(argKey);
	}
	...
	{
		popsubdep2Service.deleteByTenantIdx(argTenantId);
	}
	...
	{
		popsubdep2Service.deleteByTenantIdx(argKey.getRequiredTenantId());
	}
	...
	{
		return( popsubdep2Service.find(PKey) );
	}
	...
	public ICFBamPopSubDep2 lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( popsubdep2Service.lockByIdIdx(PKey) );
	}
	...
	public ICFBamPopSubDep2[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaPopSubDep2> results = popsubdep2Service.findAll();
	...
	{
		return( popsubdep2Service.find(argId) );
	}
	...
	public ICFBamPopSubDep2[] readDerivedByTenantIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTenantId )
	{
		List<CFBamJpaPopSubDep2> results = popsubdep2Service.findByTenantIdx(argTenantId);
		ICFBamPopSubDep2[] retset = new ICFBamPopSubDep2[results.size()];
		int idx = 0;
		for (CFBamJpaPopSubDep2 cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamPopSubDep2[] readDerivedByRelationIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argRelationId )
	{
		List<CFBamJpaPopSubDep2> results = popsubdep2Service.findByRelationIdx(argRelationId);
		ICFBamPopSubDep2[] retset = new ICFBamPopSubDep2[results.size()];
		int idx = 0;
		for (CFBamJpaPopSubDep2 cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamPopSubDep2[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaPopSubDep2> results = popsubdep2Service.findByDefSchemaIdx(argDefSchemaId);
		ICFBamPopSubDep2[] retset = new ICFBamPopSubDep2[results.size()];
		int idx = 0;
		for (CFBamJpaPopSubDep2 cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamPopSubDep2[] readDerivedByPopSubDep1Idx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPopSubDep1Id )
	{
		List<CFBamJpaPopSubDep2> results = popsubdep2Service.findByPopSubDep1Idx(argPopSubDep1Id);
		ICFBamPopSubDep2[] retset = new ICFBamPopSubDep2[results.size()];
		int idx = 0;
		for (CFBamJpaPopSubDep2 cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamPopSubDep2 readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( popsubdep2Service.findByUNameIdx(argPopSubDep1Id,
		argName) );
	}
