// Description: Java 25 JPA implementation of a DbKeyHash128Col entity definition object.
...
@Entity
@Table(
	name = "dbk128col", schema = "CFBam31",
	indexes = {
		@Index(name = "DbKeyHash128ColIdIdx", columnList = "Id", unique = true),
		@Index(name = "DbKeyHash128ColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaDbKeyHash128Col extends CFBamJpaDbKeyHash128Def
	implements ICFBamDbKeyHash128Col
{
	...
	public CFBamJpaDbKeyHash128Col() {
		super();
	...
	public String toString() {
		String ret = "<CFBamJpaDbKeyHash128Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
