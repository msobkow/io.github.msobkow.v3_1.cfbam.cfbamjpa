// Description: Java 25 JPA implementation of a IndexCol by PrevIdx index key object.
	...
	implements ICFBamIndexColByPrevIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamIndexColByPrevIdxKey, ICFBamIndexCol, ICFBamIndexColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamIndexColByPrevIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
