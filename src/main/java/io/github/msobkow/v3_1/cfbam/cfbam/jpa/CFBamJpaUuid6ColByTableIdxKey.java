// Description: Java 25 JPA implementation of a Uuid6Col by TableIdx index key object.
...
public class CFBamJpaUuid6ColByTableIdxKey
	implements ICFBamUuid6ColByTableIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamUuid6ColByTableIdxKey, ICFBamUuid6Col, ICFBamUuid6ColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamUuid6ColByTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
