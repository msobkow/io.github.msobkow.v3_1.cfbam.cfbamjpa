// Description: Java 25 JPA implementation of a ClearDep by ClearDepIdx index key object.
...
public class CFBamJpaClearDepByClearDepIdxKey
	implements ICFBamClearDepByClearDepIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamClearDepByClearDepIdxKey, ICFBamClearDep, ICFBamClearDepH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamClearDepByClearDepIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
