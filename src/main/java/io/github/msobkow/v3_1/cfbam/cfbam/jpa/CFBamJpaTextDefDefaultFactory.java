...
// Description: Java 25 JPA Default Factory implementation for TextDef.
...
/*
 *	CFBamTextDefFactory JPA implementation for TextDef
 */
public class CFBamJpaTextDefDefaultFactory
    implements ICFBamTextDefFactory
{
    public CFBamJpaTextDefDefaultFactory() {
    }
	...
	public CFBamJpaTextDefH ensureHRec(ICFBamTextDefH hrec) {
		...
		else if( hrec instanceof CFBamJpaTextDefH) {
			return( (CFBamJpaTextDefH)hrec );
		}
		else {
