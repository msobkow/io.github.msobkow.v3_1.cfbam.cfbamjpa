...
public class CFBamJpaParamTable implements ICFBamParamTable
{
		...
		ICFBamParam rec )
	{
		if (rec == null) {
			...
			CFBamJpaParam created = paramService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamParam rec )
	{
		if (rec == null) {
			...
			CFBamJpaParam jparec = (CFBamJpaParam)rec;
			CFBamJpaParam updated = paramService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamParam rec )
	{
		...
		if (rec instanceof CFBamJpaParam) {
			CFBamJpaParam jparec = (CFBamJpaParam)rec;
			paramService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		paramService.deleteByIdIdx(argKey);
	}
	...
	public void deleteParamByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		paramService.deleteByUNameIdx(argServerMethodId,
		argName);
	}
	...
	{
		paramService.deleteByUNameIdx(argKey.getRequiredServerMethodId(),
	...
	public void deleteParamByServerMethodIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argServerMethodId )
	{
		paramService.deleteByServerMethodIdx(argServerMethodId);
	}
	...
	{
		paramService.deleteByServerMethodIdx(argKey.getRequiredServerMethodId());
	}
	...
	{
		paramService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		paramService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		paramService.deleteByServerTypeIdx(argTypeId);
	}
	...
	{
		paramService.deleteByServerTypeIdx(argKey.getOptionalTypeId());
	}
	...
	{
		paramService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		paramService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		paramService.deleteByNextIdx(argNextId);
	}
	...
	{
		paramService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteParamByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		paramService.deleteByContPrevIdx(argServerMethodId,
		argPrevId);
	}
	...
	{
		paramService.deleteByContPrevIdx(argKey.getRequiredServerMethodId(),
	...
	public void deleteParamByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		paramService.deleteByContNextIdx(argServerMethodId,
		argNextId);
	}
	...
	{
		paramService.deleteByContNextIdx(argKey.getRequiredServerMethodId(),
	...
	public ICFBamParam lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( paramService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamParam[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaParam> results = paramService.findAll();
	...
	{
		return( paramService.find(argId) );
	}
	...
	public ICFBamParam readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( paramService.findByUNameIdx(argServerMethodId,
		argName) );
	}
	...
	public ICFBamParam[] readDerivedByServerMethodIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argServerMethodId )
	{
		List<CFBamJpaParam> results = paramService.findByServerMethodIdx(argServerMethodId);
		ICFBamParam[] retset = new ICFBamParam[results.size()];
		int idx = 0;
		for (CFBamJpaParam cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamParam[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaParam> results = paramService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamParam[] retset = new ICFBamParam[results.size()];
		int idx = 0;
		for (CFBamJpaParam cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamParam[] readDerivedByServerTypeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTypeId )
	{
		List<CFBamJpaParam> results = paramService.findByServerTypeIdx(argTypeId);
		ICFBamParam[] retset = new ICFBamParam[results.size()];
		int idx = 0;
		for (CFBamJpaParam cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamParam[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaParam> results = paramService.findByPrevIdx(argPrevId);
		ICFBamParam[] retset = new ICFBamParam[results.size()];
		int idx = 0;
		for (CFBamJpaParam cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamParam[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaParam> results = paramService.findByNextIdx(argNextId);
		ICFBamParam[] retset = new ICFBamParam[results.size()];
		int idx = 0;
		for (CFBamJpaParam cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamParam[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaParam> results = paramService.findByContPrevIdx(argServerMethodId,
		argPrevId);
		ICFBamParam[] retset = new ICFBamParam[results.size()];
		int idx = 0;
		for (CFBamJpaParam cur: results) {
	...
	public ICFBamParam[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaParam> results = paramService.findByContNextIdx(argServerMethodId,
		argNextId);
		ICFBamParam[] retset = new ICFBamParam[results.size()];
		int idx = 0;
		for (CFBamJpaParam cur: results) {
