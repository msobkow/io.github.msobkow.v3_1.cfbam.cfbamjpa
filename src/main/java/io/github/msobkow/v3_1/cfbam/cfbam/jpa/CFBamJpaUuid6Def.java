// Description: Java 25 JPA implementation of a Uuid6Def entity definition object.
...
@Entity
@Table(
	name = "uuid6def", schema = "CFBam31",
	indexes = {
		@Index(name = "Uuid6DefIdIdx", columnList = "Id", unique = true)
	}
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43112")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaUuid6Def extends CFBamJpaAtom
	implements ICFBamUuid6Def
{
	...
	public String toString() {
		String ret = "<CFBamJpaUuid6Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
