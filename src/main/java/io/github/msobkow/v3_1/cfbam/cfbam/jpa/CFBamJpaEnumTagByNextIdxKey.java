// Description: Java 25 JPA implementation of a EnumTag by NextIdx index key object.
	...
	implements ICFBamEnumTagByNextIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamEnumTagByNextIdxKey, ICFBamEnumTag, ICFBamEnumTagH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamEnumTagByNextIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
