// Description: Java 25 JPA implementation of a TZTimeType by SchemaIdx index key object.
...
public class CFBamJpaTZTimeTypeBySchemaIdxKey
	implements ICFBamTZTimeTypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaTZTimeTypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTZTimeTypeBySchemaIdxKey, ICFBamTZTimeType, ICFBamTZTimeTypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTZTimeTypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
