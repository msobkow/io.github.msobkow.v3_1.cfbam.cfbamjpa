// Description: Java 25 JPA implementation of a RelationCol by UNameIdx index key object.
	...
	implements ICFBamRelationColByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamRelationColByUNameIdxKey, ICFBamRelationCol, ICFBamRelationColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamRelationColByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
