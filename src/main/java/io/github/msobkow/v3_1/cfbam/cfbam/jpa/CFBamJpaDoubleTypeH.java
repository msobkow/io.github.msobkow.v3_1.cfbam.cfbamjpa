// Description: Java 25 JPA implementation of DoubleType history objects
...
/**
 *  CFBamJpaDoubleTypeH provides history objects matching the CFBamDoubleType change history.
 */
@Entity
@Table(
    name = "dbltyp_h", schema = "CFBam31",
    indexes = {
        @Index(name = "DoubleTypeIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "DoubleTypeSchemaDefIdx_h", columnList = "SchemaDefId", unique = false)
    }
)
...
public class CFBamJpaDoubleTypeH extends CFBamJpaDoubleDefH
    implements ICFBamDoubleTypeH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaDoubleTypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
