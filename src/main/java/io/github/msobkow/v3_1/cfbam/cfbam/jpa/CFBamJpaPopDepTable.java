...
public class CFBamJpaPopDepTable implements ICFBamPopDepTable
{
		...
		ICFBamPopDep rec )
	{
		if (rec == null) {
			...
			CFBamJpaPopDep created = popdepService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamPopDep rec )
	{
		if (rec == null) {
			...
			CFBamJpaPopDep jparec = (CFBamJpaPopDep)rec;
			CFBamJpaPopDep updated = popdepService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamPopDep rec )
	{
		...
		if (rec instanceof CFBamJpaPopDep) {
			CFBamJpaPopDep jparec = (CFBamJpaPopDep)rec;
			popdepService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		popdepService.deleteByRelationIdx(argRelationId);
	}
	...
	{
		popdepService.deleteByRelationIdx(argKey.getRequiredRelationId());
	}
	...
	{
		popdepService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		popdepService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		popdepService.deleteByIdIdx(argKey);
	}
	...
	{
		popdepService.deleteByTenantIdx(argTenantId);
	}
	...
	{
		popdepService.deleteByTenantIdx(argKey.getRequiredTenantId());
	}
	...
	{
		return( popdepService.find(PKey) );
	}
	...
	public ICFBamPopDep lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( popdepService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamPopDep[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaPopDep> results = popdepService.findAll();
	...
	{
		return( popdepService.find(argId) );
	}
	...
	public ICFBamPopDep[] readDerivedByTenantIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTenantId )
	{
		List<CFBamJpaPopDep> results = popdepService.findByTenantIdx(argTenantId);
		ICFBamPopDep[] retset = new ICFBamPopDep[results.size()];
		int idx = 0;
		for (CFBamJpaPopDep cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamPopDep[] readDerivedByRelationIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argRelationId )
	{
		List<CFBamJpaPopDep> results = popdepService.findByRelationIdx(argRelationId);
		ICFBamPopDep[] retset = new ICFBamPopDep[results.size()];
		int idx = 0;
		for (CFBamJpaPopDep cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamPopDep[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaPopDep> results = popdepService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamPopDep[] retset = new ICFBamPopDep[results.size()];
		int idx = 0;
		for (CFBamJpaPopDep cur: results) {
			retset[idx++] = cur;
