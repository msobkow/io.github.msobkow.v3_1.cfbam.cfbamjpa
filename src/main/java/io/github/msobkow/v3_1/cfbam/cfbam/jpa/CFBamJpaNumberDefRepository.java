// Description: Java 25 Spring JPA Repository for NumberDef
...
/**
 *	JpaRepository for the CFBamJpaNumberDef entities defined in io.github.msobkow.v3_1.cfbam.cfbam.jpa.
 *	The manufactured repositories try to provide a rich, do-it-all interface to the JPA data store, with both object and argument-based implementations of the interface defined.
 */
@Transactional(readOnly = true)
public interface CFBamJpaNumberDefRepository extends JpaRepository<CFBamJpaNumberDef, CFLibDbKeyHash256> {
	...
	CFBamJpaNumberDef get(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	CFBamJpaNumberDef findByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity, typically from the JPA cache, or null if no such entity exists.
	 */
	default CFBamJpaNumberDef findByUNameIdx(ICFBamValueByUNameIdxKey key) {
	 ...
	 *		@param requiredScopeId
	 *
	 *		@return List&lt;CFBamJpaNumberDef&gt; of the found entities, typically from the JPA cache, or an empty list if no such entities exist.
	 */
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId")
	List<CFBamJpaNumberDef> findByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId);
	 ...
	 */
	default List<CFBamJpaNumberDef> findByScopeIdx(ICFBamValueByScopeIdxKey key) {
	...
	List<CFBamJpaNumberDef> findByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaNumberDef> findByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
	...
	List<CFBamJpaNumberDef> findByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaNumberDef> findByPrevIdx(ICFBamValueByPrevIdxKey key) {
	...
	List<CFBamJpaNumberDef> findByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaNumberDef> findByNextIdx(ICFBamValueByNextIdxKey key) {
	...
	List<CFBamJpaNumberDef> findByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaNumberDef> findByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
	...
	List<CFBamJpaNumberDef> findByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaNumberDef> findByContNextIdx(ICFBamValueByContNextIdxKey key) {
	...
	@Query("select r from CFBamJpaValue r where r.requiredId = :id")
	CFBamJpaNumberDef lockByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.requiredName = :name")
	CFBamJpaNumberDef lockByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName);
	 ...
	 *		@return The locked entity, refreshed from the data store, or null if no such entity exists.
	 */
	default CFBamJpaNumberDef lockByUNameIdx(ICFBamValueByUNameIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId")
	List<CFBamJpaNumberDef> lockByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaNumberDef> lockByScopeIdx(ICFBamValueByScopeIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaNumberDef> lockByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaNumberDef> lockByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaNumberDef> lockByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaNumberDef> lockByPrevIdx(ICFBamValueByPrevIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaNumberDef> lockByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaNumberDef> lockByNextIdx(ICFBamValueByNextIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaNumberDef> lockByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaNumberDef> lockByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaNumberDef> lockByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaNumberDef> lockByContNextIdx(ICFBamValueByContNextIdxKey key) {
