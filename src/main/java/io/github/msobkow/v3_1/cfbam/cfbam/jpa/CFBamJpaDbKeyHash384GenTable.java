...
public class CFBamJpaDbKeyHash384GenTable implements ICFBamDbKeyHash384GenTable
{
		...
		ICFBamDbKeyHash384Gen rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash384Gen created = dbkeyhash384genService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamDbKeyHash384Gen rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash384Gen jparec = (CFBamJpaDbKeyHash384Gen)rec;
			CFBamJpaDbKeyHash384Gen updated = dbkeyhash384genService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamDbKeyHash384Gen rec )
	{
		...
		if (rec instanceof CFBamJpaDbKeyHash384Gen) {
			CFBamJpaDbKeyHash384Gen jparec = (CFBamJpaDbKeyHash384Gen)rec;
			dbkeyhash384genService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		dbkeyhash384genService.deleteBySchemaIdx(argSchemaDefId);
	}
	...
	{
		dbkeyhash384genService.deleteBySchemaIdx(argKey.getRequiredSchemaDefId());
	}
	...
	{
		dbkeyhash384genService.deleteByIdIdx(argKey);
	}
	...
	public void deleteDbKeyHash384GenByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		dbkeyhash384genService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		dbkeyhash384genService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash384GenByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		dbkeyhash384genService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		dbkeyhash384genService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		dbkeyhash384genService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		dbkeyhash384genService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		dbkeyhash384genService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		dbkeyhash384genService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		dbkeyhash384genService.deleteByNextIdx(argNextId);
	}
	...
	{
		dbkeyhash384genService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteDbKeyHash384GenByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		dbkeyhash384genService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		dbkeyhash384genService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash384GenByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		dbkeyhash384genService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		dbkeyhash384genService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( dbkeyhash384genService.find(PKey) );
	}
	...
	public ICFBamDbKeyHash384Gen lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( dbkeyhash384genService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamDbKeyHash384Gen[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaDbKeyHash384Gen> results = dbkeyhash384genService.findAll();
	...
	{
		return( dbkeyhash384genService.find(argId) );
	}
	...
	public ICFBamDbKeyHash384Gen readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( dbkeyhash384genService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamDbKeyHash384Gen[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaDbKeyHash384Gen> results = dbkeyhash384genService.findByScopeIdx(argScopeId);
		ICFBamDbKeyHash384Gen[] retset = new ICFBamDbKeyHash384Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Gen cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash384Gen[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaDbKeyHash384Gen> results = dbkeyhash384genService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamDbKeyHash384Gen[] retset = new ICFBamDbKeyHash384Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Gen cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash384Gen[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash384Gen> results = dbkeyhash384genService.findByPrevIdx(argPrevId);
		ICFBamDbKeyHash384Gen[] retset = new ICFBamDbKeyHash384Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Gen cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash384Gen[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash384Gen> results = dbkeyhash384genService.findByNextIdx(argNextId);
		ICFBamDbKeyHash384Gen[] retset = new ICFBamDbKeyHash384Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Gen cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash384Gen[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash384Gen> results = dbkeyhash384genService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamDbKeyHash384Gen[] retset = new ICFBamDbKeyHash384Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Gen cur: results) {
	...
	public ICFBamDbKeyHash384Gen[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash384Gen> results = dbkeyhash384genService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamDbKeyHash384Gen[] retset = new ICFBamDbKeyHash384Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Gen cur: results) {
	...
	public ICFBamDbKeyHash384Gen[] readDerivedBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argSchemaDefId )
	{
		List<CFBamJpaDbKeyHash384Gen> results = dbkeyhash384genService.findBySchemaIdx(argSchemaDefId);
		ICFBamDbKeyHash384Gen[] retset = new ICFBamDbKeyHash384Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Gen cur: results) {
			retset[idx++] = cur;
