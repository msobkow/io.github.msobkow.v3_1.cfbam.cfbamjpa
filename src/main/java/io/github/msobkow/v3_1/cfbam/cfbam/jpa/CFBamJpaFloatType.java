// Description: Java 25 JPA implementation of a FloatType entity definition object.
...
@Entity
@Table(
	name = "flttyp", schema = "CFBam31",
	indexes = {
		@Index(name = "FloatTypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "FloatTypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaFloatType extends CFBamJpaFloatDef
	implements ICFBamFloatType
{
	...
	public String toString() {
		String ret = "<CFBamJpaFloatType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
