// Description: Java 25 JPA implementation of a TextCol entity definition object.
...
@Entity
@Table(
	name = "txtcol", schema = "CFBam31",
	indexes = {
		@Index(name = "TextColIdIdx", columnList = "Id", unique = true),
		@Index(name = "TextColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaTextCol extends CFBamJpaTextDef
	implements ICFBamTextCol
{
	...
	public String toString() {
		String ret = "<CFBamJpaTextCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
