// Description: Java 25 JPA implementation of a BoolDef entity definition object.
...
@Entity
@Table(
	name = "booldef", schema = "CFBam31",
	indexes = {
		@Index(name = "BoolDefIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaBoolDef extends CFBamJpaAtom
	implements ICFBamBoolDef
{
	...
	public String toString() {
		String ret = "<CFBamJpaBoolDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
