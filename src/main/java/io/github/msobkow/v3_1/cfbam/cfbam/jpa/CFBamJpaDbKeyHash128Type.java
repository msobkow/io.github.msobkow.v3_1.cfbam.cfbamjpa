// Description: Java 25 JPA implementation of a DbKeyHash128Type entity definition object.
...
@Entity
@Table(
	name = "dbk128typ", schema = "CFBam31",
	indexes = {
		@Index(name = "DbKeyHash128TypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "DbKeyHash128TypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaDbKeyHash128Type extends CFBamJpaDbKeyHash128Def
	implements ICFBamDbKeyHash128Type
{
	...
	public CFBamJpaDbKeyHash128Type() {
		super();
	...
	public String toString() {
		String ret = "<CFBamJpaDbKeyHash128Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
