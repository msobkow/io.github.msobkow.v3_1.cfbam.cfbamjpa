// Description: Java 25 JPA implementation of a DelTopDep by NextIdx index key object.
	...
	implements ICFBamDelTopDepByNextIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDelTopDepByNextIdxKey, ICFBamDelTopDep, ICFBamDelTopDepH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDelTopDepByNextIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
