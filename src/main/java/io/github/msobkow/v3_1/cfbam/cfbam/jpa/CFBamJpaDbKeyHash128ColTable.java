...
public class CFBamJpaDbKeyHash128ColTable implements ICFBamDbKeyHash128ColTable
{
		...
		ICFBamDbKeyHash128Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash128Col created = dbkeyhash128colService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamDbKeyHash128Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash128Col jparec = (CFBamJpaDbKeyHash128Col)rec;
			CFBamJpaDbKeyHash128Col updated = dbkeyhash128colService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamDbKeyHash128Col rec )
	{
		...
		if (rec instanceof CFBamJpaDbKeyHash128Col) {
			CFBamJpaDbKeyHash128Col jparec = (CFBamJpaDbKeyHash128Col)rec;
			dbkeyhash128colService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		dbkeyhash128colService.deleteByTableIdx(argTableId);
	}
	...
	{
		dbkeyhash128colService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		dbkeyhash128colService.deleteByIdIdx(argKey);
	}
	...
	public void deleteDbKeyHash128ColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		dbkeyhash128colService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		dbkeyhash128colService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash128ColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		dbkeyhash128colService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		dbkeyhash128colService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		dbkeyhash128colService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		dbkeyhash128colService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		dbkeyhash128colService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		dbkeyhash128colService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		dbkeyhash128colService.deleteByNextIdx(argNextId);
	}
	...
	{
		dbkeyhash128colService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteDbKeyHash128ColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		dbkeyhash128colService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		dbkeyhash128colService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash128ColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		dbkeyhash128colService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		dbkeyhash128colService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( dbkeyhash128colService.find(PKey) );
	}
	...
	public ICFBamDbKeyHash128Col lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( dbkeyhash128colService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamDbKeyHash128Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaDbKeyHash128Col> results = dbkeyhash128colService.findAll();
	...
	{
		return( dbkeyhash128colService.find(argId) );
	}
	...
	public ICFBamDbKeyHash128Col readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( dbkeyhash128colService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamDbKeyHash128Col[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaDbKeyHash128Col> results = dbkeyhash128colService.findByScopeIdx(argScopeId);
		ICFBamDbKeyHash128Col[] retset = new ICFBamDbKeyHash128Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash128Col[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaDbKeyHash128Col> results = dbkeyhash128colService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamDbKeyHash128Col[] retset = new ICFBamDbKeyHash128Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash128Col[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash128Col> results = dbkeyhash128colService.findByPrevIdx(argPrevId);
		ICFBamDbKeyHash128Col[] retset = new ICFBamDbKeyHash128Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash128Col[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash128Col> results = dbkeyhash128colService.findByNextIdx(argNextId);
		ICFBamDbKeyHash128Col[] retset = new ICFBamDbKeyHash128Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash128Col[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash128Col> results = dbkeyhash128colService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamDbKeyHash128Col[] retset = new ICFBamDbKeyHash128Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Col cur: results) {
	...
	public ICFBamDbKeyHash128Col[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash128Col> results = dbkeyhash128colService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamDbKeyHash128Col[] retset = new ICFBamDbKeyHash128Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Col cur: results) {
	...
	public ICFBamDbKeyHash128Col[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaDbKeyHash128Col> results = dbkeyhash128colService.findByTableIdx(argTableId);
		ICFBamDbKeyHash128Col[] retset = new ICFBamDbKeyHash128Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Col cur: results) {
			retset[idx++] = cur;
