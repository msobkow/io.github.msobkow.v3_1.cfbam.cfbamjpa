...
public class CFBamJpaPopTopDepTable implements ICFBamPopTopDepTable
{
		...
		ICFBamPopTopDep rec )
	{
		if (rec == null) {
			...
			CFBamJpaPopTopDep created = poptopdepService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamPopTopDep rec )
	{
		if (rec == null) {
			...
			CFBamJpaPopTopDep jparec = (CFBamJpaPopTopDep)rec;
			CFBamJpaPopTopDep updated = poptopdepService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamPopTopDep rec )
	{
		...
		if (rec instanceof CFBamJpaPopTopDep) {
			CFBamJpaPopTopDep jparec = (CFBamJpaPopTopDep)rec;
			poptopdepService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		poptopdepService.deleteByContRelIdx(argContRelationId);
	}
	...
	{
		poptopdepService.deleteByContRelIdx(argKey.getRequiredContRelationId());
	}
	...
	public void deletePopTopDepByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		poptopdepService.deleteByUNameIdx(argContRelationId,
		argName);
	}
	...
	{
		poptopdepService.deleteByUNameIdx(argKey.getRequiredContRelationId(),
	...
	{
		poptopdepService.deleteByRelationIdx(argRelationId);
	}
	...
	{
		poptopdepService.deleteByRelationIdx(argKey.getRequiredRelationId());
	}
	...
	{
		poptopdepService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		poptopdepService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		poptopdepService.deleteByIdIdx(argKey);
	}
	...
	{
		poptopdepService.deleteByTenantIdx(argTenantId);
	}
	...
	{
		poptopdepService.deleteByTenantIdx(argKey.getRequiredTenantId());
	}
	...
	{
		return( poptopdepService.find(PKey) );
	}
	...
	public ICFBamPopTopDep lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( poptopdepService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamPopTopDep[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaPopTopDep> results = poptopdepService.findAll();
	...
	{
		return( poptopdepService.find(argId) );
	}
	...
	public ICFBamPopTopDep[] readDerivedByTenantIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTenantId )
	{
		List<CFBamJpaPopTopDep> results = poptopdepService.findByTenantIdx(argTenantId);
		ICFBamPopTopDep[] retset = new ICFBamPopTopDep[results.size()];
		int idx = 0;
		for (CFBamJpaPopTopDep cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamPopTopDep[] readDerivedByRelationIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argRelationId )
	{
		List<CFBamJpaPopTopDep> results = poptopdepService.findByRelationIdx(argRelationId);
		ICFBamPopTopDep[] retset = new ICFBamPopTopDep[results.size()];
		int idx = 0;
		for (CFBamJpaPopTopDep cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamPopTopDep[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaPopTopDep> results = poptopdepService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamPopTopDep[] retset = new ICFBamPopTopDep[results.size()];
		int idx = 0;
		for (CFBamJpaPopTopDep cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamPopTopDep[] readDerivedByContRelIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argContRelationId )
	{
		List<CFBamJpaPopTopDep> results = poptopdepService.findByContRelIdx(argContRelationId);
		ICFBamPopTopDep[] retset = new ICFBamPopTopDep[results.size()];
		int idx = 0;
		for (CFBamJpaPopTopDep cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamPopTopDep readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( poptopdepService.findByUNameIdx(argContRelationId,
		argName) );
	}
