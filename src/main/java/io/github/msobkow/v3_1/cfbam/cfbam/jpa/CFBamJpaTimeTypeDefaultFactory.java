...
// Description: Java 25 JPA Default Factory implementation for TimeType.
...
/*
 *	CFBamTimeTypeFactory JPA implementation for TimeType
 */
public class CFBamJpaTimeTypeDefaultFactory
    implements ICFBamTimeTypeFactory
{
    public CFBamJpaTimeTypeDefaultFactory() {
    }

    @Override
    public ICFBamTimeTypeBySchemaIdxKey newBySchemaIdxKey() {
	ICFBamTimeTypeBySchemaIdxKey key =
            new CFBamJpaTimeTypeBySchemaIdxKey();
	return( key );
    }
