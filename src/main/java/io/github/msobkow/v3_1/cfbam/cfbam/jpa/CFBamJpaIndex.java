// Description: Java 25 JPA implementation of a Index entity definition object.
...
@Entity
@Table(
	name = "idxdef", schema = "CFBam31",
	indexes = {
		@Index(name = "IndexIdIdx", columnList = "Id", unique = true),
		@Index(name = "IndexUNameIdx", columnList = "TableId, safe_name", unique = true),
		@Index(name = "IndexTableIdx", columnList = "TableId", unique = false),
		@Index(name = "IndexDefSchemaDefIdx", columnList = "defschid", unique = false)
	}
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43041")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaIndex extends CFBamJpaScope
	implements ICFBamIndex
{
	...
	public void set( ICFBamScope src ) {
		if( src instanceof ICFBamIndex ) {
			setIndex( (ICFBamIndex)src );
		}
		else {
	...
	public String toString() {
		String ret = "<CFBamJpaIndex" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
