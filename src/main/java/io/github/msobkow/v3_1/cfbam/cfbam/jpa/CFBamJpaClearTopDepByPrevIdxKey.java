// Description: Java 25 JPA implementation of a ClearTopDep by PrevIdx index key object.
	...
	implements ICFBamClearTopDepByPrevIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamClearTopDepByPrevIdxKey, ICFBamClearTopDep, ICFBamClearTopDepH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamClearTopDepByPrevIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
