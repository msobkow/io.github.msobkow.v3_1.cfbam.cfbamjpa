// Description: Java 25 JPA implementation of a DbKeyHash160Gen entity definition object.
...
@Entity
@Table(
	name = "idgdbk160", schema = "CFBam31",
	indexes = {
		@Index(name = "DbKeyHash160GenIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaDbKeyHash160Gen extends CFBamJpaDbKeyHash160Type
	implements ICFBamDbKeyHash160Gen
{
	...
	public String toString() {
		String ret = "<CFBamJpaDbKeyHash160Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
