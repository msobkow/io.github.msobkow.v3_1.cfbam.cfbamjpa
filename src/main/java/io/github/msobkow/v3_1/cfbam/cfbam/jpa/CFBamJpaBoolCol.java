// Description: Java 25 JPA implementation of a BoolCol entity definition object.
...
@Entity
@Table(
	name = "boolcol", schema = "CFBam31",
	indexes = {
		@Index(name = "BoolColIdIdx", columnList = "Id", unique = true),
		@Index(name = "BoolColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaBoolCol extends CFBamJpaBoolDef
	implements ICFBamBoolCol
{
	...
	public String toString() {
		String ret = "<CFBamJpaBoolCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
