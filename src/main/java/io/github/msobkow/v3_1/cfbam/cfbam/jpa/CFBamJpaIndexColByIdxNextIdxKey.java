// Description: Java 25 JPA implementation of a IndexCol by IdxNextIdx index key object.
	...
	implements ICFBamIndexColByIdxNextIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamIndexColByIdxNextIdxKey, ICFBamIndexCol, ICFBamIndexColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamIndexColByIdxNextIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
