// Description: Java 25 JPA implementation of a NumberCol entity definition object.
...
@Entity
@Table(
	name = "numcol", schema = "CFBam31",
	indexes = {
		@Index(name = "NumberColIdIdx", columnList = "Id", unique = true),
		@Index(name = "NumberColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaNumberCol extends CFBamJpaNumberDef
	implements ICFBamNumberCol
{
	...
	public String toString() {
		String ret = "<CFBamJpaNumberCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
