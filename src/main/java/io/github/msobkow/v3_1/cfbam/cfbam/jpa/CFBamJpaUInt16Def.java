// Description: Java 25 JPA implementation of a UInt16Def entity definition object.
...
@Entity
@Table(
	name = "u16def", schema = "CFBam31",
	indexes = {
		@Index(name = "UInt16DefIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaUInt16Def extends CFBamJpaAtom
	implements ICFBamUInt16Def
{
	...
	public String toString() {
		String ret = "<CFBamJpaUInt16Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
