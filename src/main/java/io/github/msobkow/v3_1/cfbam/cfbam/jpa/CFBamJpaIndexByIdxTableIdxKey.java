// Description: Java 25 JPA implementation of a Index by IdxTableIdx index key object.
...
public class CFBamJpaIndexByIdxTableIdxKey
	implements ICFBamIndexByIdxTableIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	public CFBamJpaIndexByIdxTableIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamIndexByIdxTableIdxKey, ICFBamIndex, ICFBamIndexH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamIndexByIdxTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
