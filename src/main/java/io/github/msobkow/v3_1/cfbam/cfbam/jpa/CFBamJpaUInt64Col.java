// Description: Java 25 JPA implementation of a UInt64Col entity definition object.
...
@Entity
@Table(
	name = "uint64col", schema = "CFBam31",
	indexes = {
		@Index(name = "UInt64ColIdIdx", columnList = "Id", unique = true),
		@Index(name = "UInt64ColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaUInt64Col extends CFBamJpaUInt64Def
	implements ICFBamUInt64Col
{
	...
	public String toString() {
		String ret = "<CFBamJpaUInt64Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
