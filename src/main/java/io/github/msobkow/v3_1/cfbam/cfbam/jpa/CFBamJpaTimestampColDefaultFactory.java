...
// Description: Java 25 JPA Default Factory implementation for TimestampCol.
...
/*
 *	CFBamTimestampColFactory JPA implementation for TimestampCol
 */
public class CFBamJpaTimestampColDefaultFactory
    implements ICFBamTimestampColFactory
{
    public CFBamJpaTimestampColDefaultFactory() {
    }

    @Override
    public ICFBamTimestampColByTableIdxKey newByTableIdxKey() {
	ICFBamTimestampColByTableIdxKey key =
            new CFBamJpaTimestampColByTableIdxKey();
	return( key );
    }
