// Description: Java 25 JPA implementation of a SchemaDef by CTenantIdx index key object.
	...
	implements ICFBamSchemaDefByCTenantIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamSchemaDefByCTenantIdxKey, ICFBamSchemaDef, ICFBamSchemaDefH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamSchemaDefByCTenantIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
