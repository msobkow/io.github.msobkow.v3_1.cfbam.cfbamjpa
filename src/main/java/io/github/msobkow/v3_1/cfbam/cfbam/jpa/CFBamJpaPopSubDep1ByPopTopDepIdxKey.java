// Description: Java 25 JPA implementation of a PopSubDep1 by PopTopDepIdx index key object.
	...
	implements ICFBamPopSubDep1ByPopTopDepIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamPopSubDep1ByPopTopDepIdxKey, ICFBamPopSubDep1, ICFBamPopSubDep1H");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPopSubDep1ByPopTopDepIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
