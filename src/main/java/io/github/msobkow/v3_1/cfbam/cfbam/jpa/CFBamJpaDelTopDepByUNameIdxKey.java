// Description: Java 25 JPA implementation of a DelTopDep by UNameIdx index key object.
...
public class CFBamJpaDelTopDepByUNameIdxKey
	implements ICFBamDelTopDepByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDelTopDepByUNameIdxKey, ICFBamDelTopDep, ICFBamDelTopDepH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDelTopDepByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
