// Description: Java 25 JPA implementation of UInt64Def history objects
...
/**
 *  CFBamJpaUInt64DefH provides history objects matching the CFBamUInt64Def change history.
 */
@Entity
@Table(
    name = "u64def_h", schema = "CFBam31",
    indexes = {
        @Index(name = "UInt64DefIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true)
    }
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43109")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaUInt64DefH extends CFBamJpaAtomH
    implements ICFBamUInt64DefH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaUInt64DefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
