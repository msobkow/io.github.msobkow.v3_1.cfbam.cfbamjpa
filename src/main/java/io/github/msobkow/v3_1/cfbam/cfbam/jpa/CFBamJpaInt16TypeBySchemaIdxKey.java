// Description: Java 25 JPA implementation of a Int16Type by SchemaIdx index key object.
...
public class CFBamJpaInt16TypeBySchemaIdxKey
	implements ICFBamInt16TypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaInt16TypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamInt16TypeBySchemaIdxKey, ICFBamInt16Type, ICFBamInt16TypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamInt16TypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
