...
// Description: Java 25 JPA Default Factory implementation for Id64Gen.
...
/*
 *	CFBamId64GenFactory JPA implementation for Id64Gen
 */
public class CFBamJpaId64GenDefaultFactory
    implements ICFBamId64GenFactory
{
    public CFBamJpaId64GenDefaultFactory() {
    }
	...
	public CFBamJpaId64GenH ensureHRec(ICFBamId64GenH hrec) {
		...
		else if( hrec instanceof CFBamJpaId64GenH) {
			return( (CFBamJpaId64GenH)hrec );
		}
		else {
