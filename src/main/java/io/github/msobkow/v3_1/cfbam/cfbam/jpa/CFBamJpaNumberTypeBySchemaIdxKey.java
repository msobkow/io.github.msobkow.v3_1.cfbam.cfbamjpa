// Description: Java 25 JPA implementation of a NumberType by SchemaIdx index key object.
...
public class CFBamJpaNumberTypeBySchemaIdxKey
	implements ICFBamNumberTypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaNumberTypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamNumberTypeBySchemaIdxKey, ICFBamNumberType, ICFBamNumberTypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamNumberTypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
