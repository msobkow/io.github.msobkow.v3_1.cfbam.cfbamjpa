...
public class CFBamJpaNmTokenColTable implements ICFBamNmTokenColTable
{
		...
		ICFBamNmTokenCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaNmTokenCol created = nmtokencolService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamNmTokenCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaNmTokenCol jparec = (CFBamJpaNmTokenCol)rec;
			CFBamJpaNmTokenCol updated = nmtokencolService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamNmTokenCol rec )
	{
		...
		if (rec instanceof CFBamJpaNmTokenCol) {
			CFBamJpaNmTokenCol jparec = (CFBamJpaNmTokenCol)rec;
			nmtokencolService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		nmtokencolService.deleteByTableIdx(argTableId);
	}
	...
	{
		nmtokencolService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		nmtokencolService.deleteByIdIdx(argKey);
	}
	...
	public void deleteNmTokenColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		nmtokencolService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		nmtokencolService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteNmTokenColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		nmtokencolService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		nmtokencolService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		nmtokencolService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		nmtokencolService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		nmtokencolService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		nmtokencolService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		nmtokencolService.deleteByNextIdx(argNextId);
	}
	...
	{
		nmtokencolService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteNmTokenColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		nmtokencolService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		nmtokencolService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteNmTokenColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		nmtokencolService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		nmtokencolService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( nmtokencolService.find(PKey) );
	}
	...
	public ICFBamNmTokenCol lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( nmtokencolService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamNmTokenCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaNmTokenCol> results = nmtokencolService.findAll();
	...
	{
		return( nmtokencolService.find(argId) );
	}
	...
	public ICFBamNmTokenCol readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( nmtokencolService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamNmTokenCol[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaNmTokenCol> results = nmtokencolService.findByScopeIdx(argScopeId);
		ICFBamNmTokenCol[] retset = new ICFBamNmTokenCol[results.size()];
		int idx = 0;
		for (CFBamJpaNmTokenCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNmTokenCol[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaNmTokenCol> results = nmtokencolService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamNmTokenCol[] retset = new ICFBamNmTokenCol[results.size()];
		int idx = 0;
		for (CFBamJpaNmTokenCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNmTokenCol[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaNmTokenCol> results = nmtokencolService.findByPrevIdx(argPrevId);
		ICFBamNmTokenCol[] retset = new ICFBamNmTokenCol[results.size()];
		int idx = 0;
		for (CFBamJpaNmTokenCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNmTokenCol[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaNmTokenCol> results = nmtokencolService.findByNextIdx(argNextId);
		ICFBamNmTokenCol[] retset = new ICFBamNmTokenCol[results.size()];
		int idx = 0;
		for (CFBamJpaNmTokenCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNmTokenCol[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaNmTokenCol> results = nmtokencolService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamNmTokenCol[] retset = new ICFBamNmTokenCol[results.size()];
		int idx = 0;
		for (CFBamJpaNmTokenCol cur: results) {
	...
	public ICFBamNmTokenCol[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaNmTokenCol> results = nmtokencolService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamNmTokenCol[] retset = new ICFBamNmTokenCol[results.size()];
		int idx = 0;
		for (CFBamJpaNmTokenCol cur: results) {
	...
	public ICFBamNmTokenCol[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaNmTokenCol> results = nmtokencolService.findByTableIdx(argTableId);
		ICFBamNmTokenCol[] retset = new ICFBamNmTokenCol[results.size()];
		int idx = 0;
		for (CFBamJpaNmTokenCol cur: results) {
			retset[idx++] = cur;
