// Description: Java 25 JPA implementation of a Int64Col entity definition object.
...
@Entity
@Table(
	name = "int64col", schema = "CFBam31",
	indexes = {
		@Index(name = "Int64ColIdIdx", columnList = "Id", unique = true),
		@Index(name = "Int64ColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaInt64Col extends CFBamJpaInt64Def
	implements ICFBamInt64Col
{
	...
	public String toString() {
		String ret = "<CFBamJpaInt64Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
