// Description: Java 25 JPA implementation of a Table by QualTableIdx index key object.
	...
	implements ICFBamTableByQualTableIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTableByQualTableIdxKey, ICFBamTable, ICFBamTableH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTableByQualTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
