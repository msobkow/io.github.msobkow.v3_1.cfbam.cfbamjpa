// Description: Java 25 JPA implementation of a Relation by FromKeyIdx index key object.
	...
	implements ICFBamRelationByFromKeyIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamRelationByFromKeyIdxKey, ICFBamRelation, ICFBamRelationH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamRelationByFromKeyIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
