...
// Description: Java 25 JPA Default Factory implementation for TokenDef.
...
/*
 *	CFBamTokenDefFactory JPA implementation for TokenDef
 */
public class CFBamJpaTokenDefDefaultFactory
    implements ICFBamTokenDefFactory
{
    public CFBamJpaTokenDefDefaultFactory() {
    }

    @Override
    public ICFBamTokenDef newRec() {
        ICFBamTokenDef rec =
            new CFBamJpaTokenDef();
        return( rec );
    }
