// Description: Java 25 JPA implementation of a NumberDef entity definition object.
...
@Entity
@Table(
	name = "numdef", schema = "CFBam31",
	indexes = {
		@Index(name = "NumberDefIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaNumberDef extends CFBamJpaAtom
	implements ICFBamNumberDef
{
	...
	public String toString() {
		String ret = "<CFBamJpaNumberDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
