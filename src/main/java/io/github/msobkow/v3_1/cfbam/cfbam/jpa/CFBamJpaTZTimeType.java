// Description: Java 25 JPA implementation of a TZTimeType entity definition object.
...
@Entity
@Table(
	name = "tmztyp", schema = "CFBam31",
	indexes = {
		@Index(name = "TZTimeTypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "TZTimeTypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaTZTimeType extends CFBamJpaTZTimeDef
	implements ICFBamTZTimeType
{
	...
	public String toString() {
		String ret = "<CFBamJpaTZTimeType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
