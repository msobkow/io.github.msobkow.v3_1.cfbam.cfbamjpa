// Description: Java 25 JPA implementation of BlobType history objects
...
/**
 *  CFBamJpaBlobTypeH provides history objects matching the CFBamBlobType change history.
 */
@Entity
@Table(
    name = "blbtyp_h", schema = "CFBam31",
    indexes = {
        @Index(name = "BlobTypeIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "BlobTypeSchemaDefIdx_h", columnList = "SchemaDefId", unique = false)
    }
)
...
public class CFBamJpaBlobTypeH extends CFBamJpaBlobDefH
    implements ICFBamBlobTypeH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaBlobTypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
