// Description: Java 25 JPA implementation of a ServerMethod by UNameIdx index key object.
...
public class CFBamJpaServerMethodByUNameIdxKey
	implements ICFBamServerMethodByUNameIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	protected String requiredName;
	public CFBamJpaServerMethodByUNameIdxKey() {
	...
	public String toString() {
		String ret = "<CFBamServerMethodByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
