...
public class CFBamJpaUInt64ColTable implements ICFBamUInt64ColTable
{
		...
		ICFBamUInt64Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaUInt64Col created = uint64colService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamUInt64Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaUInt64Col jparec = (CFBamJpaUInt64Col)rec;
			CFBamJpaUInt64Col updated = uint64colService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamUInt64Col rec )
	{
		...
		if (rec instanceof CFBamJpaUInt64Col) {
			CFBamJpaUInt64Col jparec = (CFBamJpaUInt64Col)rec;
			uint64colService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		uint64colService.deleteByTableIdx(argTableId);
	}
	...
	{
		uint64colService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		uint64colService.deleteByIdIdx(argKey);
	}
	...
	public void deleteUInt64ColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		uint64colService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		uint64colService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteUInt64ColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		uint64colService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		uint64colService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		uint64colService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		uint64colService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		uint64colService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		uint64colService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		uint64colService.deleteByNextIdx(argNextId);
	}
	...
	{
		uint64colService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteUInt64ColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		uint64colService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		uint64colService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteUInt64ColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		uint64colService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		uint64colService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( uint64colService.find(PKey) );
	}
	...
	public ICFBamUInt64Col lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( uint64colService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamUInt64Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaUInt64Col> results = uint64colService.findAll();
	...
	{
		return( uint64colService.find(argId) );
	}
	...
	public ICFBamUInt64Col readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( uint64colService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamUInt64Col[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaUInt64Col> results = uint64colService.findByScopeIdx(argScopeId);
		ICFBamUInt64Col[] retset = new ICFBamUInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt64Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt64Col[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaUInt64Col> results = uint64colService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamUInt64Col[] retset = new ICFBamUInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt64Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt64Col[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaUInt64Col> results = uint64colService.findByPrevIdx(argPrevId);
		ICFBamUInt64Col[] retset = new ICFBamUInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt64Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt64Col[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaUInt64Col> results = uint64colService.findByNextIdx(argNextId);
		ICFBamUInt64Col[] retset = new ICFBamUInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt64Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt64Col[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaUInt64Col> results = uint64colService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamUInt64Col[] retset = new ICFBamUInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt64Col cur: results) {
	...
	public ICFBamUInt64Col[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaUInt64Col> results = uint64colService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamUInt64Col[] retset = new ICFBamUInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt64Col cur: results) {
	...
	public ICFBamUInt64Col[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaUInt64Col> results = uint64colService.findByTableIdx(argTableId);
		ICFBamUInt64Col[] retset = new ICFBamUInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt64Col cur: results) {
			retset[idx++] = cur;
