// Description: Java 25 JPA implementation of TimestampDef history objects
...
/**
 *  CFBamJpaTimestampDefH provides history objects matching the CFBamTimestampDef change history.
 */
@Entity
@Table(
    name = "tsdef_h", schema = "CFBam31",
    indexes = {
        @Index(name = "TimestampDefIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true)
    }
)
    ...
    implements ICFBamTimestampDefH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaTimestampDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
