...
public class CFBamJpaTZTimeColTable implements ICFBamTZTimeColTable
{
		...
		ICFBamTZTimeCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaTZTimeCol created = tztimecolService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamTZTimeCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaTZTimeCol jparec = (CFBamJpaTZTimeCol)rec;
			CFBamJpaTZTimeCol updated = tztimecolService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamTZTimeCol rec )
	{
		...
		if (rec instanceof CFBamJpaTZTimeCol) {
			CFBamJpaTZTimeCol jparec = (CFBamJpaTZTimeCol)rec;
			tztimecolService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		tztimecolService.deleteByTableIdx(argTableId);
	}
	...
	{
		tztimecolService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		tztimecolService.deleteByIdIdx(argKey);
	}
	...
	public void deleteTZTimeColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		tztimecolService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		tztimecolService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTZTimeColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		tztimecolService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		tztimecolService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		tztimecolService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		tztimecolService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		tztimecolService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		tztimecolService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		tztimecolService.deleteByNextIdx(argNextId);
	}
	...
	{
		tztimecolService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteTZTimeColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		tztimecolService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		tztimecolService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTZTimeColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		tztimecolService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		tztimecolService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( tztimecolService.find(PKey) );
	}
	...
	public ICFBamTZTimeCol lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( tztimecolService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamTZTimeCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaTZTimeCol> results = tztimecolService.findAll();
	...
	{
		return( tztimecolService.find(argId) );
	}
	...
	public ICFBamTZTimeCol readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( tztimecolService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamTZTimeCol[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaTZTimeCol> results = tztimecolService.findByScopeIdx(argScopeId);
		ICFBamTZTimeCol[] retset = new ICFBamTZTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimeCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTZTimeCol[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaTZTimeCol> results = tztimecolService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamTZTimeCol[] retset = new ICFBamTZTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimeCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTZTimeCol[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTZTimeCol> results = tztimecolService.findByPrevIdx(argPrevId);
		ICFBamTZTimeCol[] retset = new ICFBamTZTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimeCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTZTimeCol[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTZTimeCol> results = tztimecolService.findByNextIdx(argNextId);
		ICFBamTZTimeCol[] retset = new ICFBamTZTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimeCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTZTimeCol[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTZTimeCol> results = tztimecolService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamTZTimeCol[] retset = new ICFBamTZTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimeCol cur: results) {
	...
	public ICFBamTZTimeCol[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTZTimeCol> results = tztimecolService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamTZTimeCol[] retset = new ICFBamTZTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimeCol cur: results) {
	...
	public ICFBamTZTimeCol[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaTZTimeCol> results = tztimecolService.findByTableIdx(argTableId);
		ICFBamTZTimeCol[] retset = new ICFBamTZTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimeCol cur: results) {
			retset[idx++] = cur;
