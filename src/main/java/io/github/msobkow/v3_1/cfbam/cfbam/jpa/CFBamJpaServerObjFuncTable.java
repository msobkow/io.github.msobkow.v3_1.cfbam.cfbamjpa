...
public class CFBamJpaServerObjFuncTable implements ICFBamServerObjFuncTable
{
		...
		ICFBamServerObjFunc rec )
	{
		if (rec == null) {
			...
			CFBamJpaServerObjFunc created = serverobjfuncService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamServerObjFunc rec )
	{
		if (rec == null) {
			...
			CFBamJpaServerObjFunc jparec = (CFBamJpaServerObjFunc)rec;
			CFBamJpaServerObjFunc updated = serverobjfuncService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamServerObjFunc rec )
	{
		...
		if (rec instanceof CFBamJpaServerObjFunc) {
			CFBamJpaServerObjFunc jparec = (CFBamJpaServerObjFunc)rec;
			serverobjfuncService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		serverobjfuncService.deleteByRetTblIdx(argRetTableId);
	}
	...
	{
		serverobjfuncService.deleteByRetTblIdx(argKey.getOptionalRetTableId());
	}
	...
	public void deleteServerObjFuncByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		serverobjfuncService.deleteByUNameIdx(argTableId,
		argName);
	}
	...
	{
		serverobjfuncService.deleteByUNameIdx(argKey.getRequiredTableId(),
	...
	public void deleteServerObjFuncByMethTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		serverobjfuncService.deleteByMethTableIdx(argTableId);
	}
	...
	{
		serverobjfuncService.deleteByMethTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		serverobjfuncService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		serverobjfuncService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		serverobjfuncService.deleteByIdIdx(argKey);
	}
	...
	{
		serverobjfuncService.deleteByTenantIdx(argTenantId);
	}
	...
	{
		serverobjfuncService.deleteByTenantIdx(argKey.getRequiredTenantId());
	}
	...
	{
		return( serverobjfuncService.find(PKey) );
	}
	...
	public ICFBamServerObjFunc lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( serverobjfuncService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamServerObjFunc[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaServerObjFunc> results = serverobjfuncService.findAll();
	...
	{
		return( serverobjfuncService.find(argId) );
	}
	...
	public ICFBamServerObjFunc[] readDerivedByTenantIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTenantId )
	{
		List<CFBamJpaServerObjFunc> results = serverobjfuncService.findByTenantIdx(argTenantId);
		ICFBamServerObjFunc[] retset = new ICFBamServerObjFunc[results.size()];
		int idx = 0;
		for (CFBamJpaServerObjFunc cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamServerObjFunc readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( serverobjfuncService.findByUNameIdx(argTableId,
		argName) );
	}
	...
	public ICFBamServerObjFunc[] readDerivedByMethTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaServerObjFunc> results = serverobjfuncService.findByMethTableIdx(argTableId);
		ICFBamServerObjFunc[] retset = new ICFBamServerObjFunc[results.size()];
		int idx = 0;
		for (CFBamJpaServerObjFunc cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamServerObjFunc[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaServerObjFunc> results = serverobjfuncService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamServerObjFunc[] retset = new ICFBamServerObjFunc[results.size()];
		int idx = 0;
		for (CFBamJpaServerObjFunc cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamServerObjFunc[] readDerivedByRetTblIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argRetTableId )
	{
		List<CFBamJpaServerObjFunc> results = serverobjfuncService.findByRetTblIdx(argRetTableId);
		ICFBamServerObjFunc[] retset = new ICFBamServerObjFunc[results.size()];
		int idx = 0;
		for (CFBamJpaServerObjFunc cur: results) {
			retset[idx++] = cur;
