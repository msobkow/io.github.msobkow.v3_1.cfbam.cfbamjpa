// Description: Java 25 JPA implementation of a Index by DefSchemaIdx index key object.
...
public class CFBamJpaIndexByDefSchemaIdxKey
	implements ICFBamIndexByDefSchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalDefSchemaId;
	public CFBamJpaIndexByDefSchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamIndexByDefSchemaIdxKey, ICFBamIndex, ICFBamIndexH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamIndexByDefSchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
