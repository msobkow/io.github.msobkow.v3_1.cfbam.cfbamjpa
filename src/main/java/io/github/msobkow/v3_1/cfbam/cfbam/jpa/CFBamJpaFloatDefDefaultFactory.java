...
// Description: Java 25 JPA Default Factory implementation for FloatDef.
...
/*
 *	CFBamFloatDefFactory JPA implementation for FloatDef
 */
public class CFBamJpaFloatDefDefaultFactory
    implements ICFBamFloatDefFactory
{
    public CFBamJpaFloatDefDefaultFactory() {
    }

    @Override
    public ICFBamFloatDef newRec() {
        ICFBamFloatDef rec =
            new CFBamJpaFloatDef();
        return( rec );
    }
