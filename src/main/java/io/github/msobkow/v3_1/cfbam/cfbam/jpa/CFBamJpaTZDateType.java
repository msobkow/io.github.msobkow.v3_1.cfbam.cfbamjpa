// Description: Java 25 JPA implementation of a TZDateType entity definition object.
...
@Entity
@Table(
	name = "dztyp", schema = "CFBam31",
	indexes = {
		@Index(name = "TZDateTypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "TZDateTypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaTZDateType extends CFBamJpaTZDateDef
	implements ICFBamTZDateType
{
	...
	public String toString() {
		String ret = "<CFBamJpaTZDateType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
