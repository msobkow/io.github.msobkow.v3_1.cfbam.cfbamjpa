// Description: Java 25 JPA implementation of a RelationCol by DefSchemaIdx index key object.
...
public class CFBamJpaRelationColByDefSchemaIdxKey
	implements ICFBamRelationColByDefSchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalDefSchemaId;
	public CFBamJpaRelationColByDefSchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamRelationColByDefSchemaIdxKey, ICFBamRelationCol, ICFBamRelationColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamRelationColByDefSchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
