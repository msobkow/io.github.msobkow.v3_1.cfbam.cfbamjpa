...
public class CFBamJpaInt16TypeTable implements ICFBamInt16TypeTable
{
		...
		ICFBamInt16Type rec )
	{
		if (rec == null) {
			...
			CFBamJpaInt16Type created = jpaHooksSchema.getInt16TypeService().create(jparec);
			return( created );
		}
		else {
		...
		ICFBamInt16Type rec )
	{
		if (rec == null) {
			...
			CFBamJpaInt16Type jparec = (CFBamJpaInt16Type)rec;
			CFBamJpaInt16Type updated = jpaHooksSchema.getInt16TypeService().update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamInt16Type rec )
	{
		...
		if (rec instanceof CFBamJpaInt16Type) {
			CFBamJpaInt16Type jparec = (CFBamJpaInt16Type)rec;
			jpaHooksSchema.getInt16TypeService().deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		jpaHooksSchema.getInt16TypeService().deleteBySchemaIdx(argSchemaDefId);
	}
	...
	{
		jpaHooksSchema.getInt16TypeService().deleteBySchemaIdx(argKey.getRequiredSchemaDefId());
	}
	...
	{
		jpaHooksSchema.getInt16TypeService().deleteByIdIdx(argKey);
	}
	...
	public void deleteInt16TypeByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		jpaHooksSchema.getInt16TypeService().deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		jpaHooksSchema.getInt16TypeService().deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteInt16TypeByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		jpaHooksSchema.getInt16TypeService().deleteByScopeIdx(argScopeId);
	}
	...
	{
		jpaHooksSchema.getInt16TypeService().deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		jpaHooksSchema.getInt16TypeService().deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		jpaHooksSchema.getInt16TypeService().deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		jpaHooksSchema.getInt16TypeService().deleteByPrevIdx(argPrevId);
	}
	...
	{
		jpaHooksSchema.getInt16TypeService().deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		jpaHooksSchema.getInt16TypeService().deleteByNextIdx(argNextId);
	}
	...
	{
		jpaHooksSchema.getInt16TypeService().deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteInt16TypeByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		jpaHooksSchema.getInt16TypeService().deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		jpaHooksSchema.getInt16TypeService().deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteInt16TypeByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		jpaHooksSchema.getInt16TypeService().deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		jpaHooksSchema.getInt16TypeService().deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( jpaHooksSchema.getInt16TypeService().find(PKey) );
	}
	...
	public ICFBamInt16Type lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( jpaHooksSchema.getInt16TypeService().lockByIdIdx(PKey) );
	}
	...
	public ICFBamInt16Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaInt16Type> results = jpaHooksSchema.getInt16TypeService().findAll();
	...
	{
		return( jpaHooksSchema.getInt16TypeService().find(argId) );
	}
	...
	public ICFBamInt16Type readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( jpaHooksSchema.getInt16TypeService().findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamInt16Type[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaInt16Type> results = jpaHooksSchema.getInt16TypeService().findByScopeIdx(argScopeId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Type[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaInt16Type> results = jpaHooksSchema.getInt16TypeService().findByDefSchemaIdx(argDefSchemaId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Type[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaInt16Type> results = jpaHooksSchema.getInt16TypeService().findByPrevIdx(argPrevId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Type[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaInt16Type> results = jpaHooksSchema.getInt16TypeService().findByNextIdx(argNextId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Type[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaInt16Type> results = jpaHooksSchema.getInt16TypeService().findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
	...
	public ICFBamInt16Type[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaInt16Type> results = jpaHooksSchema.getInt16TypeService().findByContNextIdx(argScopeId,
		argNextId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
	...
	public ICFBamInt16Type[] readDerivedBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argSchemaDefId )
	{
		List<CFBamJpaInt16Type> results = jpaHooksSchema.getInt16TypeService().findBySchemaIdx(argSchemaDefId);
		ICFBamInt16Type[] retset = new ICFBamInt16Type[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Type cur: results) {
			retset[idx++] = cur;
