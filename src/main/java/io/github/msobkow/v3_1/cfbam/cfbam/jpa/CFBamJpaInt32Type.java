// Description: Java 25 JPA implementation of a Int32Type entity definition object.
...
@Entity
@Table(
	name = "int32typ", schema = "CFBam31",
	indexes = {
		@Index(name = "Int32TypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "Int32TypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaInt32Type extends CFBamJpaInt32Def
	implements ICFBamInt32Type
{
	...
	public String toString() {
		String ret = "<CFBamJpaInt32Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
