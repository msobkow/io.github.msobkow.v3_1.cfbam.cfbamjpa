// Description: Java 25 JPA implementation of a DelDep by DefSchemaIdx index key object.
...
public class CFBamJpaDelDepByDefSchemaIdxKey
	implements ICFBamDelDepByDefSchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalDefSchemaId;
	public CFBamJpaDelDepByDefSchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDelDepByDefSchemaIdxKey, ICFBamDelDep, ICFBamDelDepH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDelDepByDefSchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
