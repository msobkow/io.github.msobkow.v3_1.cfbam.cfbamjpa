...
public class CFBamJpaInt16ColTable implements ICFBamInt16ColTable
{
		...
		ICFBamInt16Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaInt16Col created = int16colService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamInt16Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaInt16Col jparec = (CFBamJpaInt16Col)rec;
			CFBamJpaInt16Col updated = int16colService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamInt16Col rec )
	{
		...
		if (rec instanceof CFBamJpaInt16Col) {
			CFBamJpaInt16Col jparec = (CFBamJpaInt16Col)rec;
			int16colService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		int16colService.deleteByTableIdx(argTableId);
	}
	...
	{
		int16colService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		int16colService.deleteByIdIdx(argKey);
	}
	...
	public void deleteInt16ColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		int16colService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		int16colService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteInt16ColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		int16colService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		int16colService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		int16colService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		int16colService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		int16colService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		int16colService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		int16colService.deleteByNextIdx(argNextId);
	}
	...
	{
		int16colService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteInt16ColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		int16colService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		int16colService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteInt16ColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		int16colService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		int16colService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( int16colService.find(PKey) );
	}
	...
	public ICFBamInt16Col lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( int16colService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamInt16Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaInt16Col> results = int16colService.findAll();
	...
	{
		return( int16colService.find(argId) );
	}
	...
	public ICFBamInt16Col readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( int16colService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamInt16Col[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaInt16Col> results = int16colService.findByScopeIdx(argScopeId);
		ICFBamInt16Col[] retset = new ICFBamInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Col[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaInt16Col> results = int16colService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamInt16Col[] retset = new ICFBamInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Col[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaInt16Col> results = int16colService.findByPrevIdx(argPrevId);
		ICFBamInt16Col[] retset = new ICFBamInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Col[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaInt16Col> results = int16colService.findByNextIdx(argNextId);
		ICFBamInt16Col[] retset = new ICFBamInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Col[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaInt16Col> results = int16colService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamInt16Col[] retset = new ICFBamInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Col cur: results) {
	...
	public ICFBamInt16Col[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaInt16Col> results = int16colService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamInt16Col[] retset = new ICFBamInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Col cur: results) {
	...
	public ICFBamInt16Col[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaInt16Col> results = int16colService.findByTableIdx(argTableId);
		ICFBamInt16Col[] retset = new ICFBamInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Col cur: results) {
			retset[idx++] = cur;
