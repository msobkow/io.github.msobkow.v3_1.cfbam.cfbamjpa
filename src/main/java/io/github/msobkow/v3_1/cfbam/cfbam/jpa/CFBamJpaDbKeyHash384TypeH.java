// Description: Java 25 JPA implementation of DbKeyHash384Type history objects
...
/**
 *  CFBamJpaDbKeyHash384TypeH provides history objects matching the CFBamDbKeyHash384Type change history.
 */
@Entity
@Table(
    name = "dbk384typ_h", schema = "CFBam31",
    indexes = {
        @Index(name = "DbKeyHash384TypeIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "DbKeyHash384TypeSchemaDefIdx_h", columnList = "SchemaDefId", unique = false)
    }
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43082")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaDbKeyHash384TypeH extends CFBamJpaDbKeyHash384DefH
    implements ICFBamDbKeyHash384TypeH
{
    ...
    public CFBamJpaDbKeyHash384TypeH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof ICFBamDbKeyHash384Type ) {
			setDbKeyHash384Type( (ICFBamDbKeyHash384Type)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamJpaDbKeyHash384TypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
