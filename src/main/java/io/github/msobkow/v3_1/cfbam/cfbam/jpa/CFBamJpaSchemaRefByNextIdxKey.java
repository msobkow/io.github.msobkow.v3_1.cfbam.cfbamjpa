// Description: Java 25 JPA implementation of a SchemaRef by NextIdx index key object.
	...
	implements ICFBamSchemaRefByNextIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamSchemaRefByNextIdxKey, ICFBamSchemaRef, ICFBamSchemaRefH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamSchemaRefByNextIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
