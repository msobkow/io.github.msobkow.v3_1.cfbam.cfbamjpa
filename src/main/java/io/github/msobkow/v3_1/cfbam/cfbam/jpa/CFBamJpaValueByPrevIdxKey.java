// Description: Java 25 JPA implementation of a Value by PrevIdx index key object.
	...
	implements ICFBamValueByPrevIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamValueByPrevIdxKey, ICFBamValue, ICFBamValueH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamValueByPrevIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
