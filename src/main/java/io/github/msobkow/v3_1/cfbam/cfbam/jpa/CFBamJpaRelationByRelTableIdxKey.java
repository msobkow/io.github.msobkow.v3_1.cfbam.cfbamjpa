// Description: Java 25 JPA implementation of a Relation by RelTableIdx index key object.
...
public class CFBamJpaRelationByRelTableIdxKey
	implements ICFBamRelationByRelTableIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamRelationByRelTableIdxKey, ICFBamRelation, ICFBamRelationH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamRelationByRelTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
