// Description: Java 25 JPA implementation of TokenDef history objects
...
/**
 *  CFBamJpaTokenDefH provides history objects matching the CFBamTokenDef change history.
 */
@Entity
@Table(
    name = "tkndef_h", schema = "CFBam31",
    indexes = {
        @Index(name = "TokenDefIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true)
    }
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43103")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaTokenDefH extends CFBamJpaAtomH
    implements ICFBamTokenDefH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof ICFBamTokenDef ) {
			setTokenDef( (ICFBamTokenDef)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamJpaTokenDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
