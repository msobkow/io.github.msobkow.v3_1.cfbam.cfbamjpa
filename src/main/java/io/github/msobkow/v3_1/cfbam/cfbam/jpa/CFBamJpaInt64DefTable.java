...
public class CFBamJpaInt64DefTable implements ICFBamInt64DefTable
{
		...
		ICFBamInt64Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaInt64Def created = int64defService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamInt64Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaInt64Def jparec = (CFBamJpaInt64Def)rec;
			CFBamJpaInt64Def updated = int64defService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamInt64Def rec )
	{
		...
		if (rec instanceof CFBamJpaInt64Def) {
			CFBamJpaInt64Def jparec = (CFBamJpaInt64Def)rec;
			int64defService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		int64defService.deleteByIdIdx(argKey);
	}
	...
	public void deleteInt64DefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		int64defService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		int64defService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteInt64DefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		int64defService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		int64defService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		int64defService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		int64defService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		int64defService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		int64defService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		int64defService.deleteByNextIdx(argNextId);
	}
	...
	{
		int64defService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteInt64DefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		int64defService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		int64defService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteInt64DefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		int64defService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		int64defService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( int64defService.find(PKey) );
	}
	...
	public ICFBamInt64Def lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( int64defService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamInt64Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaInt64Def> results = int64defService.findAll();
	...
	{
		return( int64defService.find(argId) );
	}
	...
	public ICFBamInt64Def readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( int64defService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamInt64Def[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaInt64Def> results = int64defService.findByScopeIdx(argScopeId);
		ICFBamInt64Def[] retset = new ICFBamInt64Def[results.size()];
		int idx = 0;
		for (CFBamJpaInt64Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt64Def[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaInt64Def> results = int64defService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamInt64Def[] retset = new ICFBamInt64Def[results.size()];
		int idx = 0;
		for (CFBamJpaInt64Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt64Def[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaInt64Def> results = int64defService.findByPrevIdx(argPrevId);
		ICFBamInt64Def[] retset = new ICFBamInt64Def[results.size()];
		int idx = 0;
		for (CFBamJpaInt64Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt64Def[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaInt64Def> results = int64defService.findByNextIdx(argNextId);
		ICFBamInt64Def[] retset = new ICFBamInt64Def[results.size()];
		int idx = 0;
		for (CFBamJpaInt64Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt64Def[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaInt64Def> results = int64defService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamInt64Def[] retset = new ICFBamInt64Def[results.size()];
		int idx = 0;
		for (CFBamJpaInt64Def cur: results) {
	...
	public ICFBamInt64Def[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaInt64Def> results = int64defService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamInt64Def[] retset = new ICFBamInt64Def[results.size()];
		int idx = 0;
		for (CFBamJpaInt64Def cur: results) {
