// Description: Java 25 JPA implementation of a DateType entity definition object.
...
@Entity
@Table(
	name = "dttyp", schema = "CFBam31",
	indexes = {
		@Index(name = "DateTypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "DateTypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaDateType extends CFBamJpaDateDef
	implements ICFBamDateType
{
	...
	public String toString() {
		String ret = "<CFBamJpaDateType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
