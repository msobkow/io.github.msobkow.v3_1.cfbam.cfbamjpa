// Description: Java 25 JPA implementation of a DbKeyHash384Type entity definition object.
...
@Entity
@Table(
	name = "dbk384typ", schema = "CFBam31",
	indexes = {
		@Index(name = "DbKeyHash384TypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "DbKeyHash384TypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaDbKeyHash384Type extends CFBamJpaDbKeyHash384Def
	implements ICFBamDbKeyHash384Type
{
	...
	public String toString() {
		String ret = "<CFBamJpaDbKeyHash384Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
