...
// Description: Java 25 JPA Default Factory implementation for DelDep.
...
/*
 *	CFBamDelDepFactory JPA implementation for DelDep
 */
public class CFBamJpaDelDepDefaultFactory
    implements ICFBamDelDepFactory
{
    public CFBamJpaDelDepDefaultFactory() {
    }

    @Override
    public ICFBamDelDepByDefSchemaIdxKey newByDefSchemaIdxKey() {
	ICFBamDelDepByDefSchemaIdxKey key =
            new CFBamJpaDelDepByDefSchemaIdxKey();
	return( key );
    }
