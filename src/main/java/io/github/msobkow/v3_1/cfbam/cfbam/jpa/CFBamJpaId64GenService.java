// Description: Java 25 Spring JPA Service for Id64Gen
...
/**
 *	Service for the CFBamId64Gen entities defined in io.github.msobkow.v3_1.cfbam.cfbam.jpa
 *	using the CFBamId64GenRepository to access them.
 */
@Service("cfbam31JpaId64GenService")
public class CFBamJpaId64GenService {
	...
	@Autowired
	private CFBamJpaId64GenRepository cfbam31Id64GenRepository;

	/**
	 *	Create an entity, generating any database keys required along the way.
	 *
	 *		@param	data	The entity to be instantiated; must be a specific instance of CFBamJpaId64Gen, not a subclass.
	 *
	...
	public CFBamJpaId64Gen create(CFBamJpaId64Gen data) {
		...
		if( data.getRequiredSlice() < ICFBamId64Gen.SLICE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				S_ProcName,
				0,
				"getRequiredSlice()",
		...
		if( data.getRequiredSlice() > ICFBamId64Gen.SLICE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				S_ProcName,
				0,
				"getRequiredSlice()",
		...
		if( data.getRequiredBlockSize() < ICFBamId64Gen.BLOCKSIZE_MIN_VALUE ) {
			throw new CFLibArgumentUnderflowException( getClass(),
				S_ProcName,
				0,
		...
		if( data.getRequiredBlockSize() > ICFBamId64Gen.BLOCKSIZE_MAX_VALUE ) {
			throw new CFLibArgumentOverflowException( getClass(),
				S_ProcName,
				0,
				"getRequiredBlockSize()",
		...
		try {
			...
			if(data.getPKey() != null && cfbam31Id64GenRepository.existsById((CFLibDbKeyHash256)data.getPKey())) {
				return( (CFBamJpaId64Gen)(cfbam31Id64GenRepository.findById((CFLibDbKeyHash256)(data.getPKey())).get()));
			}
			return cfbam31Id64GenRepository.save(data);
		}
		catch(Exception ex) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED,rollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaId64Gen update(CFBamJpaId64Gen data) {
		...
		CFBamJpaId64Gen existing = cfbam31Id64GenRepository.findById((CFLibDbKeyHash256)(data.getPKey()))
		...
		// Apply superior data relationships of CFBamId64Gen to existing object
		// Apply data columns of CFBamId64Gen to existing object
		existing.setRequiredSlice(data.getRequiredSlice());
		existing.setRequiredBlockSize(data.getRequiredBlockSize());
		// Update the audit columns
		data.setUpdatedAt(LocalDateTime.now());
		// Save the changes we've made
		return cfbam31Id64GenRepository.save(existing);
	}
	...
	public CFBamJpaId64Gen find(@Param("id") CFLibDbKeyHash256 requiredId) {
		return( cfbam31Id64GenRepository.get(requiredId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findAll() {
		return( cfbam31Id64GenRepository.findAll() );
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaId64Gen findByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName) {
		return( cfbam31Id64GenRepository.findByUNameIdx(requiredScopeId,
			requiredName));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaId64Gen findByUNameIdx(ICFBamValueByUNameIdxKey key) {
		return( cfbam31Id64GenRepository.findByUNameIdx(key.getRequiredScopeId(), key.getRequiredName()));
	}
	 ...
	 *		@param requiredScopeId
	 *
	 *		@return List&lt;CFBamJpaId64Gen&gt; of the found entities, or an empty list if no such entities exist.
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId) {
		return( cfbam31Id64GenRepository.findByScopeIdx(requiredScopeId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findByScopeIdx(ICFBamValueByScopeIdxKey key) {
		return( cfbam31Id64GenRepository.findByScopeIdx(key.getRequiredScopeId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId) {
		return( cfbam31Id64GenRepository.findByDefSchemaIdx(optionalDefSchemaId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
		return( cfbam31Id64GenRepository.findByDefSchemaIdx(key.getOptionalDefSchemaId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Id64GenRepository.findByPrevIdx(optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findByPrevIdx(ICFBamValueByPrevIdxKey key) {
		return( cfbam31Id64GenRepository.findByPrevIdx(key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Id64GenRepository.findByNextIdx(optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findByNextIdx(ICFBamValueByNextIdxKey key) {
		return( cfbam31Id64GenRepository.findByNextIdx(key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Id64GenRepository.findByContPrevIdx(requiredScopeId,
			optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
		return( cfbam31Id64GenRepository.findByContPrevIdx(key.getRequiredScopeId(), key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Id64GenRepository.findByContNextIdx(requiredScopeId,
			optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findByContNextIdx(ICFBamValueByContNextIdxKey key) {
		return( cfbam31Id64GenRepository.findByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findBySchemaIdx(@Param("schemaDefId") CFLibDbKeyHash256 requiredSchemaDefId) {
		return( cfbam31Id64GenRepository.findBySchemaIdx(requiredSchemaDefId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> findBySchemaIdx(ICFBamInt64TypeBySchemaIdxKey key) {
		return( cfbam31Id64GenRepository.findBySchemaIdx(key.getRequiredSchemaDefId()));
	}

	// CFBamId64Gen specified index finders
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaId64Gen lockByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId) {
		return( cfbam31Id64GenRepository.lockByIdIdx(requiredId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaId64Gen lockByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName) {
		return( cfbam31Id64GenRepository.lockByUNameIdx(requiredScopeId,
			requiredName));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaId64Gen lockByUNameIdx(ICFBamValueByUNameIdxKey key) {
		return( cfbam31Id64GenRepository.lockByUNameIdx(key.getRequiredScopeId(), key.getRequiredName()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId) {
		return( cfbam31Id64GenRepository.lockByScopeIdx(requiredScopeId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockByScopeIdx(ICFBamValueByScopeIdxKey key) {
		return( cfbam31Id64GenRepository.lockByScopeIdx(key.getRequiredScopeId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId) {
		return( cfbam31Id64GenRepository.lockByDefSchemaIdx(optionalDefSchemaId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
		return( cfbam31Id64GenRepository.lockByDefSchemaIdx(key.getOptionalDefSchemaId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Id64GenRepository.lockByPrevIdx(optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockByPrevIdx(ICFBamValueByPrevIdxKey key) {
		return( cfbam31Id64GenRepository.lockByPrevIdx(key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Id64GenRepository.lockByNextIdx(optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockByNextIdx(ICFBamValueByNextIdxKey key) {
		return( cfbam31Id64GenRepository.lockByNextIdx(key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Id64GenRepository.lockByContPrevIdx(requiredScopeId,
			optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
		return( cfbam31Id64GenRepository.lockByContPrevIdx(key.getRequiredScopeId(), key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Id64GenRepository.lockByContNextIdx(requiredScopeId,
			optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockByContNextIdx(ICFBamValueByContNextIdxKey key) {
		return( cfbam31Id64GenRepository.lockByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockBySchemaIdx(@Param("schemaDefId") CFLibDbKeyHash256 requiredSchemaDefId) {
		return( cfbam31Id64GenRepository.lockBySchemaIdx(requiredSchemaDefId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaId64Gen> lockBySchemaIdx(ICFBamInt64TypeBySchemaIdxKey key) {
		return( cfbam31Id64GenRepository.lockBySchemaIdx(key.getRequiredSchemaDefId()));
	}

	// CFBamId64Gen specified lock-by-index methods
	...
	public void deleteByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId) {
		cfbam31Id64GenRepository.deleteByIdIdx(requiredId);
	}
	...
	public void deleteByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName) {
		cfbam31Id64GenRepository.deleteByUNameIdx(requiredScopeId,
			requiredName);
	}
	...
	public void deleteByUNameIdx(ICFBamValueByUNameIdxKey key) {
		cfbam31Id64GenRepository.deleteByUNameIdx(key.getRequiredScopeId(), key.getRequiredName());
	}
	...
	public void deleteByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId) {
		cfbam31Id64GenRepository.deleteByScopeIdx(requiredScopeId);
	}
	...
	public void deleteByScopeIdx(ICFBamValueByScopeIdxKey key) {
		cfbam31Id64GenRepository.deleteByScopeIdx(key.getRequiredScopeId());
	}
	...
	public void deleteByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId) {
		cfbam31Id64GenRepository.deleteByDefSchemaIdx(optionalDefSchemaId);
	}
	...
	public void deleteByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
		cfbam31Id64GenRepository.deleteByDefSchemaIdx(key.getOptionalDefSchemaId());
	}
	...
	public void deleteByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		cfbam31Id64GenRepository.deleteByPrevIdx(optionalPrevId);
	}
	...
	public void deleteByPrevIdx(ICFBamValueByPrevIdxKey key) {
		cfbam31Id64GenRepository.deleteByPrevIdx(key.getOptionalPrevId());
	}
	...
	public void deleteByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		cfbam31Id64GenRepository.deleteByNextIdx(optionalNextId);
	}
	...
	public void deleteByNextIdx(ICFBamValueByNextIdxKey key) {
		cfbam31Id64GenRepository.deleteByNextIdx(key.getOptionalNextId());
	}
	...
	public void deleteByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		cfbam31Id64GenRepository.deleteByContPrevIdx(requiredScopeId,
			optionalPrevId);
	}
	...
	public void deleteByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
		cfbam31Id64GenRepository.deleteByContPrevIdx(key.getRequiredScopeId(), key.getOptionalPrevId());
	}
	...
	public void deleteByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		cfbam31Id64GenRepository.deleteByContNextIdx(requiredScopeId,
			optionalNextId);
	}
	...
	public void deleteByContNextIdx(ICFBamValueByContNextIdxKey key) {
		cfbam31Id64GenRepository.deleteByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId());
	}
	...
	public void deleteBySchemaIdx(@Param("schemaDefId") CFLibDbKeyHash256 requiredSchemaDefId) {
		cfbam31Id64GenRepository.deleteBySchemaIdx(requiredSchemaDefId);
	}
	...
	public void deleteBySchemaIdx(ICFBamInt64TypeBySchemaIdxKey key) {
		cfbam31Id64GenRepository.deleteBySchemaIdx(key.getRequiredSchemaDefId());
	}

	// CFBamId64Gen specified delete-by-index methods
}
