// Description: Java 25 Spring JPA Service for Int16Def
...
/**
 *	Service for the CFBamInt16Def entities defined in io.github.msobkow.v3_1.cfbam.cfbam.jpa
 *	using the CFBamInt16DefRepository to access them.
 */
@Service("cfbam31JpaInt16DefService")
public class CFBamJpaInt16DefService {
	...
	@Autowired
	private CFBamJpaInt16DefRepository cfbam31Int16DefRepository;

	/**
	 *	Create an entity, generating any database keys required along the way.
	 *
	 *		@param	data	The entity to be instantiated; must be a specific instance of CFBamJpaInt16Def, not a subclass.
	 *
	...
	public CFBamJpaInt16Def create(CFBamJpaInt16Def data) {
		...
		try {
			...
			if(data.getPKey() != null && cfbam31Int16DefRepository.existsById((CFLibDbKeyHash256)data.getPKey())) {
				return( (CFBamJpaInt16Def)(cfbam31Int16DefRepository.findById((CFLibDbKeyHash256)(data.getPKey())).get()));
			}
			return cfbam31Int16DefRepository.save(data);
		}
		catch(Exception ex) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED,rollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt16Def update(CFBamJpaInt16Def data) {
		...
		CFBamJpaInt16Def existing = cfbam31Int16DefRepository.findById((CFLibDbKeyHash256)(data.getPKey()))
		...
		return cfbam31Int16DefRepository.save(existing);
	}
	...
	public CFBamJpaInt16Def find(@Param("id") CFLibDbKeyHash256 requiredId) {
		return( cfbam31Int16DefRepository.get(requiredId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> findAll() {
		return( cfbam31Int16DefRepository.findAll() );
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt16Def findByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName) {
		return( cfbam31Int16DefRepository.findByUNameIdx(requiredScopeId,
			requiredName));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt16Def findByUNameIdx(ICFBamValueByUNameIdxKey key) {
		return( cfbam31Int16DefRepository.findByUNameIdx(key.getRequiredScopeId(), key.getRequiredName()));
	}
	 ...
	 *		@param requiredScopeId
	 *
	 *		@return List&lt;CFBamJpaInt16Def&gt; of the found entities, or an empty list if no such entities exist.
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> findByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId) {
		return( cfbam31Int16DefRepository.findByScopeIdx(requiredScopeId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> findByScopeIdx(ICFBamValueByScopeIdxKey key) {
		return( cfbam31Int16DefRepository.findByScopeIdx(key.getRequiredScopeId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> findByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId) {
		return( cfbam31Int16DefRepository.findByDefSchemaIdx(optionalDefSchemaId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> findByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
		return( cfbam31Int16DefRepository.findByDefSchemaIdx(key.getOptionalDefSchemaId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> findByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Int16DefRepository.findByPrevIdx(optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> findByPrevIdx(ICFBamValueByPrevIdxKey key) {
		return( cfbam31Int16DefRepository.findByPrevIdx(key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> findByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Int16DefRepository.findByNextIdx(optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> findByNextIdx(ICFBamValueByNextIdxKey key) {
		return( cfbam31Int16DefRepository.findByNextIdx(key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> findByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Int16DefRepository.findByContPrevIdx(requiredScopeId,
			optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> findByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
		return( cfbam31Int16DefRepository.findByContPrevIdx(key.getRequiredScopeId(), key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> findByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Int16DefRepository.findByContNextIdx(requiredScopeId,
			optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> findByContNextIdx(ICFBamValueByContNextIdxKey key) {
		return( cfbam31Int16DefRepository.findByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt16Def lockByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId) {
		return( cfbam31Int16DefRepository.lockByIdIdx(requiredId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt16Def lockByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName) {
		return( cfbam31Int16DefRepository.lockByUNameIdx(requiredScopeId,
			requiredName));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt16Def lockByUNameIdx(ICFBamValueByUNameIdxKey key) {
		return( cfbam31Int16DefRepository.lockByUNameIdx(key.getRequiredScopeId(), key.getRequiredName()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> lockByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId) {
		return( cfbam31Int16DefRepository.lockByScopeIdx(requiredScopeId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> lockByScopeIdx(ICFBamValueByScopeIdxKey key) {
		return( cfbam31Int16DefRepository.lockByScopeIdx(key.getRequiredScopeId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> lockByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId) {
		return( cfbam31Int16DefRepository.lockByDefSchemaIdx(optionalDefSchemaId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> lockByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
		return( cfbam31Int16DefRepository.lockByDefSchemaIdx(key.getOptionalDefSchemaId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> lockByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Int16DefRepository.lockByPrevIdx(optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> lockByPrevIdx(ICFBamValueByPrevIdxKey key) {
		return( cfbam31Int16DefRepository.lockByPrevIdx(key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> lockByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Int16DefRepository.lockByNextIdx(optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> lockByNextIdx(ICFBamValueByNextIdxKey key) {
		return( cfbam31Int16DefRepository.lockByNextIdx(key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> lockByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Int16DefRepository.lockByContPrevIdx(requiredScopeId,
			optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> lockByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
		return( cfbam31Int16DefRepository.lockByContPrevIdx(key.getRequiredScopeId(), key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> lockByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Int16DefRepository.lockByContNextIdx(requiredScopeId,
			optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Def> lockByContNextIdx(ICFBamValueByContNextIdxKey key) {
		return( cfbam31Int16DefRepository.lockByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId()));
	}
	...
	public void deleteByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId) {
		cfbam31Int16DefRepository.deleteByIdIdx(requiredId);
	}
	...
	public void deleteByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName) {
		cfbam31Int16DefRepository.deleteByUNameIdx(requiredScopeId,
			requiredName);
	}
	...
	public void deleteByUNameIdx(ICFBamValueByUNameIdxKey key) {
		cfbam31Int16DefRepository.deleteByUNameIdx(key.getRequiredScopeId(), key.getRequiredName());
	}
	...
	public void deleteByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId) {
		cfbam31Int16DefRepository.deleteByScopeIdx(requiredScopeId);
	}
	...
	public void deleteByScopeIdx(ICFBamValueByScopeIdxKey key) {
		cfbam31Int16DefRepository.deleteByScopeIdx(key.getRequiredScopeId());
	}
	...
	public void deleteByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId) {
		cfbam31Int16DefRepository.deleteByDefSchemaIdx(optionalDefSchemaId);
	}
	...
	public void deleteByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
		cfbam31Int16DefRepository.deleteByDefSchemaIdx(key.getOptionalDefSchemaId());
	}
	...
	public void deleteByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		cfbam31Int16DefRepository.deleteByPrevIdx(optionalPrevId);
	}
	...
	public void deleteByPrevIdx(ICFBamValueByPrevIdxKey key) {
		cfbam31Int16DefRepository.deleteByPrevIdx(key.getOptionalPrevId());
	}
	...
	public void deleteByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		cfbam31Int16DefRepository.deleteByNextIdx(optionalNextId);
	}
	...
	public void deleteByNextIdx(ICFBamValueByNextIdxKey key) {
		cfbam31Int16DefRepository.deleteByNextIdx(key.getOptionalNextId());
	}
	...
	public void deleteByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		cfbam31Int16DefRepository.deleteByContPrevIdx(requiredScopeId,
			optionalPrevId);
	}
	...
	public void deleteByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
		cfbam31Int16DefRepository.deleteByContPrevIdx(key.getRequiredScopeId(), key.getOptionalPrevId());
	}
	...
	public void deleteByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		cfbam31Int16DefRepository.deleteByContNextIdx(requiredScopeId,
			optionalNextId);
	}
	...
	public void deleteByContNextIdx(ICFBamValueByContNextIdxKey key) {
		cfbam31Int16DefRepository.deleteByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId());
	}
