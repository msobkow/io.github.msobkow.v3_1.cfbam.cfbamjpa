...
public class CFBamJpaTimestampDefTable implements ICFBamTimestampDefTable
{
		...
		ICFBamTimestampDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaTimestampDef created = timestampdefService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamTimestampDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaTimestampDef jparec = (CFBamJpaTimestampDef)rec;
			CFBamJpaTimestampDef updated = timestampdefService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamTimestampDef rec )
	{
		...
		if (rec instanceof CFBamJpaTimestampDef) {
			CFBamJpaTimestampDef jparec = (CFBamJpaTimestampDef)rec;
			timestampdefService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		timestampdefService.deleteByIdIdx(argKey);
	}
	...
	public void deleteTimestampDefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		timestampdefService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		timestampdefService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTimestampDefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		timestampdefService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		timestampdefService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		timestampdefService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		timestampdefService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		timestampdefService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		timestampdefService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		timestampdefService.deleteByNextIdx(argNextId);
	}
	...
	{
		timestampdefService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteTimestampDefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		timestampdefService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		timestampdefService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTimestampDefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		timestampdefService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		timestampdefService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( timestampdefService.find(PKey) );
	}
	...
	public ICFBamTimestampDef lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( timestampdefService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamTimestampDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaTimestampDef> results = timestampdefService.findAll();
	...
	{
		return( timestampdefService.find(argId) );
	}
	...
	public ICFBamTimestampDef readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( timestampdefService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamTimestampDef[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaTimestampDef> results = timestampdefService.findByScopeIdx(argScopeId);
		ICFBamTimestampDef[] retset = new ICFBamTimestampDef[results.size()];
		int idx = 0;
		for (CFBamJpaTimestampDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTimestampDef[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaTimestampDef> results = timestampdefService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamTimestampDef[] retset = new ICFBamTimestampDef[results.size()];
		int idx = 0;
		for (CFBamJpaTimestampDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTimestampDef[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTimestampDef> results = timestampdefService.findByPrevIdx(argPrevId);
		ICFBamTimestampDef[] retset = new ICFBamTimestampDef[results.size()];
		int idx = 0;
		for (CFBamJpaTimestampDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTimestampDef[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTimestampDef> results = timestampdefService.findByNextIdx(argNextId);
		ICFBamTimestampDef[] retset = new ICFBamTimestampDef[results.size()];
		int idx = 0;
		for (CFBamJpaTimestampDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTimestampDef[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTimestampDef> results = timestampdefService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamTimestampDef[] retset = new ICFBamTimestampDef[results.size()];
		int idx = 0;
		for (CFBamJpaTimestampDef cur: results) {
	...
	public ICFBamTimestampDef[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTimestampDef> results = timestampdefService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamTimestampDef[] retset = new ICFBamTimestampDef[results.size()];
		int idx = 0;
		for (CFBamJpaTimestampDef cur: results) {
