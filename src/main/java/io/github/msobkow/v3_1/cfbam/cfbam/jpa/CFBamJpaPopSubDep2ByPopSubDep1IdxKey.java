// Description: Java 25 JPA implementation of a PopSubDep2 by PopSubDep1Idx index key object.
...
public class CFBamJpaPopSubDep2ByPopSubDep1IdxKey
	implements ICFBamPopSubDep2ByPopSubDep1IdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamPopSubDep2ByPopSubDep1IdxKey, ICFBamPopSubDep2, ICFBamPopSubDep2H");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPopSubDep2ByPopSubDep1IdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
