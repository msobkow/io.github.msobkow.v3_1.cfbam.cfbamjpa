// Description: Java 25 JPA implementation of a RelationCol by RelNextIdx index key object.
...
public class CFBamJpaRelationColByRelNextIdxKey
	implements ICFBamRelationColByRelNextIdxKey, Comparable<Object>, Serializable
{
	...
	public CFBamJpaRelationColByRelNextIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamRelationColByRelNextIdxKey, ICFBamRelationCol, ICFBamRelationColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamRelationColByRelNextIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
