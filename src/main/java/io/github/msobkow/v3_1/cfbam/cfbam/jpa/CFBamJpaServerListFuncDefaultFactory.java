...
// Description: Java 25 JPA Default Factory implementation for ServerListFunc.
...
/*
 *	CFBamServerListFuncFactory JPA implementation for ServerListFunc
 */
public class CFBamJpaServerListFuncDefaultFactory
    implements ICFBamServerListFuncFactory
{
    public CFBamJpaServerListFuncDefaultFactory() {
    }

    @Override
    public ICFBamServerListFuncByRetTblIdxKey newByRetTblIdxKey() {
	ICFBamServerListFuncByRetTblIdxKey key =
            new CFBamJpaServerListFuncByRetTblIdxKey();
	return( key );
    }
