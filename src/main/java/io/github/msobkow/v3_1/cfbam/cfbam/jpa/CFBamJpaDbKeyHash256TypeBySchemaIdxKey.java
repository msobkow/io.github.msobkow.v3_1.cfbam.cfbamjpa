// Description: Java 25 JPA implementation of a DbKeyHash256Type by SchemaIdx index key object.
...
public class CFBamJpaDbKeyHash256TypeBySchemaIdxKey
	implements ICFBamDbKeyHash256TypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaDbKeyHash256TypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDbKeyHash256TypeBySchemaIdxKey, ICFBamDbKeyHash256Type, ICFBamDbKeyHash256TypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDbKeyHash256TypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
