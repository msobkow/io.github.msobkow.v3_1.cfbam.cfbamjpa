...
public class CFBamJpaClearTopDepTable implements ICFBamClearTopDepTable
{
		...
		ICFBamClearTopDep rec )
	{
		if (rec == null) {
			...
			CFBamJpaClearTopDep created = cleartopdepService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamClearTopDep rec )
	{
		if (rec == null) {
			...
			CFBamJpaClearTopDep jparec = (CFBamJpaClearTopDep)rec;
			CFBamJpaClearTopDep updated = cleartopdepService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamClearTopDep rec )
	{
		...
		if (rec instanceof CFBamJpaClearTopDep) {
			CFBamJpaClearTopDep jparec = (CFBamJpaClearTopDep)rec;
			cleartopdepService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		cleartopdepService.deleteByClrTopDepTblIdx(argTableId);
	}
	...
	{
		cleartopdepService.deleteByClrTopDepTblIdx(argKey.getRequiredTableId());
	}
	...
	public void deleteClearTopDepByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		cleartopdepService.deleteByUNameIdx(argTableId,
		argName);
	}
	...
	{
		cleartopdepService.deleteByUNameIdx(argKey.getRequiredTableId(),
	...
	{
		cleartopdepService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		cleartopdepService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		cleartopdepService.deleteByNextIdx(argNextId);
	}
	...
	{
		cleartopdepService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	{
		cleartopdepService.deleteByClearDepIdx(argRelationId);
	}
	...
	{
		cleartopdepService.deleteByClearDepIdx(argKey.getRequiredRelationId());
	}
	...
	{
		cleartopdepService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		cleartopdepService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		cleartopdepService.deleteByIdIdx(argKey);
	}
	...
	{
		cleartopdepService.deleteByTenantIdx(argTenantId);
	}
	...
	{
		cleartopdepService.deleteByTenantIdx(argKey.getRequiredTenantId());
	}
	...
	{
		return( cleartopdepService.find(PKey) );
	}
	...
	public ICFBamClearTopDep lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( cleartopdepService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamClearTopDep[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaClearTopDep> results = cleartopdepService.findAll();
	...
	{
		return( cleartopdepService.find(argId) );
	}
	...
	public ICFBamClearTopDep[] readDerivedByTenantIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTenantId )
	{
		List<CFBamJpaClearTopDep> results = cleartopdepService.findByTenantIdx(argTenantId);
		ICFBamClearTopDep[] retset = new ICFBamClearTopDep[results.size()];
		int idx = 0;
		for (CFBamJpaClearTopDep cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamClearTopDep[] readDerivedByClearDepIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argRelationId )
	{
		List<CFBamJpaClearTopDep> results = cleartopdepService.findByClearDepIdx(argRelationId);
		ICFBamClearTopDep[] retset = new ICFBamClearTopDep[results.size()];
		int idx = 0;
		for (CFBamJpaClearTopDep cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamClearTopDep[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaClearTopDep> results = cleartopdepService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamClearTopDep[] retset = new ICFBamClearTopDep[results.size()];
		int idx = 0;
		for (CFBamJpaClearTopDep cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamClearTopDep[] readDerivedByClrTopDepTblIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaClearTopDep> results = cleartopdepService.findByClrTopDepTblIdx(argTableId);
		ICFBamClearTopDep[] retset = new ICFBamClearTopDep[results.size()];
		int idx = 0;
		for (CFBamJpaClearTopDep cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamClearTopDep readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( cleartopdepService.findByUNameIdx(argTableId,
		argName) );
	}
	...
	public ICFBamClearTopDep[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaClearTopDep> results = cleartopdepService.findByPrevIdx(argPrevId);
		ICFBamClearTopDep[] retset = new ICFBamClearTopDep[results.size()];
		int idx = 0;
		for (CFBamJpaClearTopDep cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamClearTopDep[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaClearTopDep> results = cleartopdepService.findByNextIdx(argNextId);
		ICFBamClearTopDep[] retset = new ICFBamClearTopDep[results.size()];
		int idx = 0;
		for (CFBamJpaClearTopDep cur: results) {
			retset[idx++] = cur;
