// Description: Java 25 JPA implementation of a DbKeyHash128Type by SchemaIdx index key object.
...
public class CFBamJpaDbKeyHash128TypeBySchemaIdxKey
	implements ICFBamDbKeyHash128TypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaDbKeyHash128TypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDbKeyHash128TypeBySchemaIdxKey, ICFBamDbKeyHash128Type, ICFBamDbKeyHash128TypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDbKeyHash128TypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
