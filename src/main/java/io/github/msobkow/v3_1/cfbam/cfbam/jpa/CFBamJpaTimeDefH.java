// Description: Java 25 JPA implementation of TimeDef history objects
...
/**
 *  CFBamJpaTimeDefH provides history objects matching the CFBamTimeDef change history.
 */
@Entity
@Table(
    name = "tmdef_h", schema = "CFBam31",
    indexes = {
        @Index(name = "TimeDefIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true)
    }
)
    ...
    implements ICFBamTimeDefH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaTimeDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
