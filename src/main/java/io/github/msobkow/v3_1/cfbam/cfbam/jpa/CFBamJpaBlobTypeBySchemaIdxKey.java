// Description: Java 25 JPA implementation of a BlobType by SchemaIdx index key object.
...
public class CFBamJpaBlobTypeBySchemaIdxKey
	implements ICFBamBlobTypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaBlobTypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamBlobTypeBySchemaIdxKey, ICFBamBlobType, ICFBamBlobTypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamBlobTypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
