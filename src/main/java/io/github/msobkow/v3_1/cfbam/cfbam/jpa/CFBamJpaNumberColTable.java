...
public class CFBamJpaNumberColTable implements ICFBamNumberColTable
{
		...
		ICFBamNumberCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaNumberCol created = numbercolService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamNumberCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaNumberCol jparec = (CFBamJpaNumberCol)rec;
			CFBamJpaNumberCol updated = numbercolService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamNumberCol rec )
	{
		...
		if (rec instanceof CFBamJpaNumberCol) {
			CFBamJpaNumberCol jparec = (CFBamJpaNumberCol)rec;
			numbercolService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		numbercolService.deleteByTableIdx(argTableId);
	}
	...
	{
		numbercolService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		numbercolService.deleteByIdIdx(argKey);
	}
	...
	public void deleteNumberColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		numbercolService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		numbercolService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteNumberColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		numbercolService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		numbercolService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		numbercolService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		numbercolService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		numbercolService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		numbercolService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		numbercolService.deleteByNextIdx(argNextId);
	}
	...
	{
		numbercolService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteNumberColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		numbercolService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		numbercolService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteNumberColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		numbercolService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		numbercolService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( numbercolService.find(PKey) );
	}
	...
	public ICFBamNumberCol lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( numbercolService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamNumberCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaNumberCol> results = numbercolService.findAll();
	...
	{
		return( numbercolService.find(argId) );
	}
	...
	public ICFBamNumberCol readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( numbercolService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamNumberCol[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaNumberCol> results = numbercolService.findByScopeIdx(argScopeId);
		ICFBamNumberCol[] retset = new ICFBamNumberCol[results.size()];
		int idx = 0;
		for (CFBamJpaNumberCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNumberCol[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaNumberCol> results = numbercolService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamNumberCol[] retset = new ICFBamNumberCol[results.size()];
		int idx = 0;
		for (CFBamJpaNumberCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNumberCol[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaNumberCol> results = numbercolService.findByPrevIdx(argPrevId);
		ICFBamNumberCol[] retset = new ICFBamNumberCol[results.size()];
		int idx = 0;
		for (CFBamJpaNumberCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNumberCol[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaNumberCol> results = numbercolService.findByNextIdx(argNextId);
		ICFBamNumberCol[] retset = new ICFBamNumberCol[results.size()];
		int idx = 0;
		for (CFBamJpaNumberCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNumberCol[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaNumberCol> results = numbercolService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamNumberCol[] retset = new ICFBamNumberCol[results.size()];
		int idx = 0;
		for (CFBamJpaNumberCol cur: results) {
	...
	public ICFBamNumberCol[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaNumberCol> results = numbercolService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamNumberCol[] retset = new ICFBamNumberCol[results.size()];
		int idx = 0;
		for (CFBamJpaNumberCol cur: results) {
	...
	public ICFBamNumberCol[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaNumberCol> results = numbercolService.findByTableIdx(argTableId);
		ICFBamNumberCol[] retset = new ICFBamNumberCol[results.size()];
		int idx = 0;
		for (CFBamJpaNumberCol cur: results) {
			retset[idx++] = cur;
