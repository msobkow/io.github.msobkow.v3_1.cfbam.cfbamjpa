// Description: Java 25 JPA implementation of a Index by UNameIdx index key object.
	...
	implements ICFBamIndexByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamIndexByUNameIdxKey, ICFBamIndex, ICFBamIndexH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamIndexByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
