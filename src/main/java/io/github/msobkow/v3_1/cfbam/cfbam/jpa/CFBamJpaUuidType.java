// Description: Java 25 JPA implementation of a UuidType entity definition object.
...
@Entity
@Table(
	name = "uuidtyp", schema = "CFBam31",
	indexes = {
		@Index(name = "UuidTypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "UuidTypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaUuidType extends CFBamJpaUuidDef
	implements ICFBamUuidType
{
	...
	public String toString() {
		String ret = "<CFBamJpaUuidType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
