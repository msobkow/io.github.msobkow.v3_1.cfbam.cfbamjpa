...
public class CFBamJpaBoolDefTable implements ICFBamBoolDefTable
{
		...
		ICFBamBoolDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaBoolDef created = booldefService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamBoolDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaBoolDef jparec = (CFBamJpaBoolDef)rec;
			CFBamJpaBoolDef updated = booldefService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamBoolDef rec )
	{
		...
		if (rec instanceof CFBamJpaBoolDef) {
			CFBamJpaBoolDef jparec = (CFBamJpaBoolDef)rec;
			booldefService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		booldefService.deleteByIdIdx(argKey);
	}
	...
	public void deleteBoolDefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		booldefService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		booldefService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteBoolDefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		booldefService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		booldefService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		booldefService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		booldefService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		booldefService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		booldefService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		booldefService.deleteByNextIdx(argNextId);
	}
	...
	{
		booldefService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteBoolDefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		booldefService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		booldefService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteBoolDefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		booldefService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		booldefService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( booldefService.find(PKey) );
	}
	...
	public ICFBamBoolDef lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( booldefService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamBoolDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaBoolDef> results = booldefService.findAll();
	...
	{
		return( booldefService.find(argId) );
	}
	...
	public ICFBamBoolDef readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( booldefService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamBoolDef[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaBoolDef> results = booldefService.findByScopeIdx(argScopeId);
		ICFBamBoolDef[] retset = new ICFBamBoolDef[results.size()];
		int idx = 0;
		for (CFBamJpaBoolDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamBoolDef[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaBoolDef> results = booldefService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamBoolDef[] retset = new ICFBamBoolDef[results.size()];
		int idx = 0;
		for (CFBamJpaBoolDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamBoolDef[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaBoolDef> results = booldefService.findByPrevIdx(argPrevId);
		ICFBamBoolDef[] retset = new ICFBamBoolDef[results.size()];
		int idx = 0;
		for (CFBamJpaBoolDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamBoolDef[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaBoolDef> results = booldefService.findByNextIdx(argNextId);
		ICFBamBoolDef[] retset = new ICFBamBoolDef[results.size()];
		int idx = 0;
		for (CFBamJpaBoolDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamBoolDef[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaBoolDef> results = booldefService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamBoolDef[] retset = new ICFBamBoolDef[results.size()];
		int idx = 0;
		for (CFBamJpaBoolDef cur: results) {
	...
	public ICFBamBoolDef[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaBoolDef> results = booldefService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamBoolDef[] retset = new ICFBamBoolDef[results.size()];
		int idx = 0;
		for (CFBamJpaBoolDef cur: results) {
