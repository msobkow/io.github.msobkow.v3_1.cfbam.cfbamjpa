...
public class CFBamJpaEnumTagTable implements ICFBamEnumTagTable
{
		...
		ICFBamEnumTag rec )
	{
		if (rec == null) {
			...
			CFBamJpaEnumTag created = enumtagService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamEnumTag rec )
	{
		if (rec == null) {
			...
			CFBamJpaEnumTag jparec = (CFBamJpaEnumTag)rec;
			CFBamJpaEnumTag updated = enumtagService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamEnumTag rec )
	{
		...
		if (rec instanceof CFBamJpaEnumTag) {
			CFBamJpaEnumTag jparec = (CFBamJpaEnumTag)rec;
			enumtagService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		enumtagService.deleteByIdIdx(argKey);
	}
	...
	{
		enumtagService.deleteByEnumIdx(argEnumId);
	}
	...
	{
		enumtagService.deleteByEnumIdx(argKey.getRequiredEnumId());
	}
	...
	{
		enumtagService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		enumtagService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	public void deleteEnumTagByEnumNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		enumtagService.deleteByEnumNameIdx(argEnumId,
		argName);
	}
	...
	{
		enumtagService.deleteByEnumNameIdx(argKey.getRequiredEnumId(),
	...
	{
		enumtagService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		enumtagService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		enumtagService.deleteByNextIdx(argNextId);
	}
	...
	{
		enumtagService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	{
		return( enumtagService.find(PKey) );
	}
	...
	public ICFBamEnumTag lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( enumtagService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamEnumTag[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaEnumTag> results = enumtagService.findAll();
	...
	{
		return( enumtagService.find(argId) );
	}
	...
	public ICFBamEnumTag[] readDerivedByEnumIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argEnumId )
	{
		List<CFBamJpaEnumTag> results = enumtagService.findByEnumIdx(argEnumId);
		ICFBamEnumTag[] retset = new ICFBamEnumTag[results.size()];
		int idx = 0;
		for (CFBamJpaEnumTag cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamEnumTag[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaEnumTag> results = enumtagService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamEnumTag[] retset = new ICFBamEnumTag[results.size()];
		int idx = 0;
		for (CFBamJpaEnumTag cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamEnumTag readDerivedByEnumNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( enumtagService.findByEnumNameIdx(argEnumId,
		argName) );
	}
	...
	public ICFBamEnumTag[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaEnumTag> results = enumtagService.findByPrevIdx(argPrevId);
		ICFBamEnumTag[] retset = new ICFBamEnumTag[results.size()];
		int idx = 0;
		for (CFBamJpaEnumTag cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamEnumTag[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaEnumTag> results = enumtagService.findByNextIdx(argNextId);
		ICFBamEnumTag[] retset = new ICFBamEnumTag[results.size()];
		int idx = 0;
		for (CFBamJpaEnumTag cur: results) {
			retset[idx++] = cur;
