...
// Description: Java 25 JPA Default Factory implementation for StringDef.
...
/*
 *	CFBamStringDefFactory JPA implementation for StringDef
 */
public class CFBamJpaStringDefDefaultFactory
    implements ICFBamStringDefFactory
{
    public CFBamJpaStringDefDefaultFactory() {
    }

    @Override
    public ICFBamStringDef newRec() {
        ICFBamStringDef rec =
            new CFBamJpaStringDef();
        return( rec );
    }
