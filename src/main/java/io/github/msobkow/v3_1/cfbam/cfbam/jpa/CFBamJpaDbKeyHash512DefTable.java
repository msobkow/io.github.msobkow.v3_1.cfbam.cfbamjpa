...
public class CFBamJpaDbKeyHash512DefTable implements ICFBamDbKeyHash512DefTable
{
		...
		ICFBamDbKeyHash512Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash512Def created = dbkeyhash512defService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamDbKeyHash512Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash512Def jparec = (CFBamJpaDbKeyHash512Def)rec;
			CFBamJpaDbKeyHash512Def updated = dbkeyhash512defService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamDbKeyHash512Def rec )
	{
		...
		if (rec instanceof CFBamJpaDbKeyHash512Def) {
			CFBamJpaDbKeyHash512Def jparec = (CFBamJpaDbKeyHash512Def)rec;
			dbkeyhash512defService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		dbkeyhash512defService.deleteByIdIdx(argKey);
	}
	...
	public void deleteDbKeyHash512DefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		dbkeyhash512defService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		dbkeyhash512defService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash512DefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		dbkeyhash512defService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		dbkeyhash512defService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		dbkeyhash512defService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		dbkeyhash512defService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		dbkeyhash512defService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		dbkeyhash512defService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		dbkeyhash512defService.deleteByNextIdx(argNextId);
	}
	...
	{
		dbkeyhash512defService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteDbKeyHash512DefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		dbkeyhash512defService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		dbkeyhash512defService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash512DefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		dbkeyhash512defService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		dbkeyhash512defService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( dbkeyhash512defService.find(PKey) );
	}
	...
	public ICFBamDbKeyHash512Def lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( dbkeyhash512defService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamDbKeyHash512Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaDbKeyHash512Def> results = dbkeyhash512defService.findAll();
	...
	{
		return( dbkeyhash512defService.find(argId) );
	}
	...
	public ICFBamDbKeyHash512Def readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( dbkeyhash512defService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamDbKeyHash512Def[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaDbKeyHash512Def> results = dbkeyhash512defService.findByScopeIdx(argScopeId);
		ICFBamDbKeyHash512Def[] retset = new ICFBamDbKeyHash512Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash512Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash512Def[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaDbKeyHash512Def> results = dbkeyhash512defService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamDbKeyHash512Def[] retset = new ICFBamDbKeyHash512Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash512Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash512Def[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash512Def> results = dbkeyhash512defService.findByPrevIdx(argPrevId);
		ICFBamDbKeyHash512Def[] retset = new ICFBamDbKeyHash512Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash512Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash512Def[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash512Def> results = dbkeyhash512defService.findByNextIdx(argNextId);
		ICFBamDbKeyHash512Def[] retset = new ICFBamDbKeyHash512Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash512Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash512Def[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash512Def> results = dbkeyhash512defService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamDbKeyHash512Def[] retset = new ICFBamDbKeyHash512Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash512Def cur: results) {
	...
	public ICFBamDbKeyHash512Def[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash512Def> results = dbkeyhash512defService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamDbKeyHash512Def[] retset = new ICFBamDbKeyHash512Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash512Def cur: results) {
