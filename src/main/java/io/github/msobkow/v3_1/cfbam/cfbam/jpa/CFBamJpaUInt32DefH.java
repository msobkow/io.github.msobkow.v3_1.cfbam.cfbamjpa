// Description: Java 25 JPA implementation of UInt32Def history objects
...
/**
 *  CFBamJpaUInt32DefH provides history objects matching the CFBamUInt32Def change history.
 */
@Entity
@Table(
    name = "u32def_h", schema = "CFBam31",
    indexes = {
        @Index(name = "UInt32DefIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true)
    }
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43107")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaUInt32DefH extends CFBamJpaAtomH
    implements ICFBamUInt32DefH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof ICFBamUInt32Def ) {
			setUInt32Def( (ICFBamUInt32Def)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamJpaUInt32DefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
