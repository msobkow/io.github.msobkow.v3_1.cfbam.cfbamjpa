// Description: Java 25 Spring JPA Repository for Int16Def
...
/**
 *	JpaRepository for the CFBamJpaInt16Def entities defined in io.github.msobkow.v3_1.cfbam.cfbam.jpa.
 *	The manufactured repositories try to provide a rich, do-it-all interface to the JPA data store, with both object and argument-based implementations of the interface defined.
 */
@Transactional(readOnly = true)
public interface CFBamJpaInt16DefRepository extends JpaRepository<CFBamJpaInt16Def, CFLibDbKeyHash256> {
	...
	CFBamJpaInt16Def get(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	CFBamJpaInt16Def findByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity, typically from the JPA cache, or null if no such entity exists.
	 */
	default CFBamJpaInt16Def findByUNameIdx(ICFBamValueByUNameIdxKey key) {
	 ...
	 *		@param requiredScopeId
	 *
	 *		@return List&lt;CFBamJpaInt16Def&gt; of the found entities, typically from the JPA cache, or an empty list if no such entities exist.
	 */
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId")
	List<CFBamJpaInt16Def> findByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId);
	 ...
	 */
	default List<CFBamJpaInt16Def> findByScopeIdx(ICFBamValueByScopeIdxKey key) {
	...
	List<CFBamJpaInt16Def> findByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaInt16Def> findByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
	...
	List<CFBamJpaInt16Def> findByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaInt16Def> findByPrevIdx(ICFBamValueByPrevIdxKey key) {
	...
	List<CFBamJpaInt16Def> findByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaInt16Def> findByNextIdx(ICFBamValueByNextIdxKey key) {
	...
	List<CFBamJpaInt16Def> findByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaInt16Def> findByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
	...
	List<CFBamJpaInt16Def> findByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaInt16Def> findByContNextIdx(ICFBamValueByContNextIdxKey key) {
	...
	@Query("select r from CFBamJpaValue r where r.requiredId = :id")
	CFBamJpaInt16Def lockByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.requiredName = :name")
	CFBamJpaInt16Def lockByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName);
	 ...
	 *		@return The locked entity, refreshed from the data store, or null if no such entity exists.
	 */
	default CFBamJpaInt16Def lockByUNameIdx(ICFBamValueByUNameIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId")
	List<CFBamJpaInt16Def> lockByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaInt16Def> lockByScopeIdx(ICFBamValueByScopeIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaInt16Def> lockByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaInt16Def> lockByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaInt16Def> lockByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaInt16Def> lockByPrevIdx(ICFBamValueByPrevIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaInt16Def> lockByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaInt16Def> lockByNextIdx(ICFBamValueByNextIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaInt16Def> lockByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaInt16Def> lockByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaInt16Def> lockByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaInt16Def> lockByContNextIdx(ICFBamValueByContNextIdxKey key) {
