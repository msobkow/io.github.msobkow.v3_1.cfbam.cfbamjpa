// Description: Java 25 JPA implementation of a DelTopDep by PrevIdx index key object.
	...
	implements ICFBamDelTopDepByPrevIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDelTopDepByPrevIdxKey, ICFBamDelTopDep, ICFBamDelTopDepH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDelTopDepByPrevIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
