...
public class CFBamJpaDateDefTable implements ICFBamDateDefTable
{
		...
		ICFBamDateDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaDateDef created = datedefService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamDateDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaDateDef jparec = (CFBamJpaDateDef)rec;
			CFBamJpaDateDef updated = datedefService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamDateDef rec )
	{
		...
		if (rec instanceof CFBamJpaDateDef) {
			CFBamJpaDateDef jparec = (CFBamJpaDateDef)rec;
			datedefService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		datedefService.deleteByIdIdx(argKey);
	}
	...
	public void deleteDateDefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		datedefService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		datedefService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDateDefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		datedefService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		datedefService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		datedefService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		datedefService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		datedefService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		datedefService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		datedefService.deleteByNextIdx(argNextId);
	}
	...
	{
		datedefService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteDateDefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		datedefService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		datedefService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDateDefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		datedefService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		datedefService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( datedefService.find(PKey) );
	}
	...
	public ICFBamDateDef lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( datedefService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamDateDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaDateDef> results = datedefService.findAll();
	...
	{
		return( datedefService.find(argId) );
	}
	...
	public ICFBamDateDef readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( datedefService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamDateDef[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaDateDef> results = datedefService.findByScopeIdx(argScopeId);
		ICFBamDateDef[] retset = new ICFBamDateDef[results.size()];
		int idx = 0;
		for (CFBamJpaDateDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDateDef[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaDateDef> results = datedefService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamDateDef[] retset = new ICFBamDateDef[results.size()];
		int idx = 0;
		for (CFBamJpaDateDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDateDef[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDateDef> results = datedefService.findByPrevIdx(argPrevId);
		ICFBamDateDef[] retset = new ICFBamDateDef[results.size()];
		int idx = 0;
		for (CFBamJpaDateDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDateDef[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDateDef> results = datedefService.findByNextIdx(argNextId);
		ICFBamDateDef[] retset = new ICFBamDateDef[results.size()];
		int idx = 0;
		for (CFBamJpaDateDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDateDef[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDateDef> results = datedefService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamDateDef[] retset = new ICFBamDateDef[results.size()];
		int idx = 0;
		for (CFBamJpaDateDef cur: results) {
	...
	public ICFBamDateDef[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDateDef> results = datedefService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamDateDef[] retset = new ICFBamDateDef[results.size()];
		int idx = 0;
		for (CFBamJpaDateDef cur: results) {
