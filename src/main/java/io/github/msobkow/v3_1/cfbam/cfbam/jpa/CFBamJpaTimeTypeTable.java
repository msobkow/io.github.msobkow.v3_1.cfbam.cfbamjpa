...
public class CFBamJpaTimeTypeTable implements ICFBamTimeTypeTable
{
		...
		ICFBamTimeType rec )
	{
		if (rec == null) {
			...
			CFBamJpaTimeType created = timetypeService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamTimeType rec )
	{
		if (rec == null) {
			...
			CFBamJpaTimeType jparec = (CFBamJpaTimeType)rec;
			CFBamJpaTimeType updated = timetypeService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamTimeType rec )
	{
		...
		if (rec instanceof CFBamJpaTimeType) {
			CFBamJpaTimeType jparec = (CFBamJpaTimeType)rec;
			timetypeService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		timetypeService.deleteBySchemaIdx(argSchemaDefId);
	}
	...
	{
		timetypeService.deleteBySchemaIdx(argKey.getRequiredSchemaDefId());
	}
	...
	{
		timetypeService.deleteByIdIdx(argKey);
	}
	...
	public void deleteTimeTypeByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		timetypeService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		timetypeService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTimeTypeByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		timetypeService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		timetypeService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		timetypeService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		timetypeService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		timetypeService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		timetypeService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		timetypeService.deleteByNextIdx(argNextId);
	}
	...
	{
		timetypeService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteTimeTypeByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		timetypeService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		timetypeService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTimeTypeByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		timetypeService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		timetypeService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( timetypeService.find(PKey) );
	}
	...
	public ICFBamTimeType lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( timetypeService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamTimeType[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaTimeType> results = timetypeService.findAll();
	...
	{
		return( timetypeService.find(argId) );
	}
	...
	public ICFBamTimeType readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( timetypeService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamTimeType[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaTimeType> results = timetypeService.findByScopeIdx(argScopeId);
		ICFBamTimeType[] retset = new ICFBamTimeType[results.size()];
		int idx = 0;
		for (CFBamJpaTimeType cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTimeType[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaTimeType> results = timetypeService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamTimeType[] retset = new ICFBamTimeType[results.size()];
		int idx = 0;
		for (CFBamJpaTimeType cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTimeType[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTimeType> results = timetypeService.findByPrevIdx(argPrevId);
		ICFBamTimeType[] retset = new ICFBamTimeType[results.size()];
		int idx = 0;
		for (CFBamJpaTimeType cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTimeType[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTimeType> results = timetypeService.findByNextIdx(argNextId);
		ICFBamTimeType[] retset = new ICFBamTimeType[results.size()];
		int idx = 0;
		for (CFBamJpaTimeType cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTimeType[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTimeType> results = timetypeService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamTimeType[] retset = new ICFBamTimeType[results.size()];
		int idx = 0;
		for (CFBamJpaTimeType cur: results) {
	...
	public ICFBamTimeType[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTimeType> results = timetypeService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamTimeType[] retset = new ICFBamTimeType[results.size()];
		int idx = 0;
		for (CFBamJpaTimeType cur: results) {
	...
	public ICFBamTimeType[] readDerivedBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argSchemaDefId )
	{
		List<CFBamJpaTimeType> results = timetypeService.findBySchemaIdx(argSchemaDefId);
		ICFBamTimeType[] retset = new ICFBamTimeType[results.size()];
		int idx = 0;
		for (CFBamJpaTimeType cur: results) {
			retset[idx++] = cur;
