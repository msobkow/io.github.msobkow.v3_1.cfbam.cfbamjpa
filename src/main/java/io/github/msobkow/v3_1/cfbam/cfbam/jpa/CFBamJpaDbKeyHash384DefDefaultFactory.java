...
// Description: Java 25 JPA Default Factory implementation for DbKeyHash384Def.
...
/*
 *	CFBamDbKeyHash384DefFactory JPA implementation for DbKeyHash384Def
 */
public class CFBamJpaDbKeyHash384DefDefaultFactory
    implements ICFBamDbKeyHash384DefFactory
{
    public CFBamJpaDbKeyHash384DefDefaultFactory() {
    }

    @Override
    public ICFBamDbKeyHash384Def newRec() {
        ICFBamDbKeyHash384Def rec =
            new CFBamJpaDbKeyHash384Def();
        return( rec );
    }
	...
	public CFBamJpaDbKeyHash384Def ensureRec(ICFBamDbKeyHash384Def rec) {
		if( rec == null ) {
			...
			return( (CFBamJpaDbKeyHash384Def)rec );
		}
		else {
	...
	public CFBamJpaDbKeyHash384DefH ensureHRec(ICFBamDbKeyHash384DefH hrec) {
		...
		else if( hrec instanceof CFBamJpaDbKeyHash384DefH) {
			return( (CFBamJpaDbKeyHash384DefH)hrec );
		}
		else {
