// Description: Java 25 JPA implementation of a DelDep by DelDepIdx index key object.
...
public class CFBamJpaDelDepByDelDepIdxKey
	implements ICFBamDelDepByDelDepIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDelDepByDelDepIdxKey, ICFBamDelDep, ICFBamDelDepH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDelDepByDelDepIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
