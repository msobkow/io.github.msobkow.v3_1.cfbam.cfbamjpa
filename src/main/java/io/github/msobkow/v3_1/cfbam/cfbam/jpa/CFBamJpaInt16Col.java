// Description: Java 25 JPA implementation of a Int16Col entity definition object.
...
@Entity
@Table(
	name = "int16col", schema = "CFBam31",
	indexes = {
		@Index(name = "Int16ColIdIdx", columnList = "Id", unique = true),
		@Index(name = "Int16ColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaInt16Col extends CFBamJpaInt16Def
	implements ICFBamInt16Col
{
	...
	public String toString() {
		String ret = "<CFBamJpaInt16Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
