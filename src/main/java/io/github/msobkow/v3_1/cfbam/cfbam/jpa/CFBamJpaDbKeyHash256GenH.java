// Description: Java 25 JPA implementation of DbKeyHash256Gen history objects
...
/**
 *  CFBamJpaDbKeyHash256GenH provides history objects matching the CFBamDbKeyHash256Gen change history.
 */
@Entity
@Table(
    name = "idgdbk256_h", schema = "CFBam31",
    indexes = {
        @Index(name = "DbKeyHash256GenIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true)
    }
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43079")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaDbKeyHash256GenH extends CFBamJpaDbKeyHash256TypeH
    implements ICFBamDbKeyHash256GenH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof ICFBamDbKeyHash256Gen ) {
			setDbKeyHash256Gen( (ICFBamDbKeyHash256Gen)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamJpaDbKeyHash256GenH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
