// Description: Java 25 Spring JPA Repository for Atom
...
/**
 *	JpaRepository for the CFBamJpaAtom entities defined in io.github.msobkow.v3_1.cfbam.cfbam.jpa.
 *	The manufactured repositories try to provide a rich, do-it-all interface to the JPA data store, with both object and argument-based implementations of the interface defined.
 */
@Transactional(readOnly = true)
public interface CFBamJpaAtomRepository extends JpaRepository<CFBamJpaAtom, CFLibDbKeyHash256> {
	...
	CFBamJpaAtom get(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	CFBamJpaAtom findByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity, typically from the JPA cache, or null if no such entity exists.
	 */
	default CFBamJpaAtom findByUNameIdx(ICFBamValueByUNameIdxKey key) {
	 ...
	 *		@param requiredScopeId
	 *
	 *		@return List&lt;CFBamJpaAtom&gt; of the found entities, typically from the JPA cache, or an empty list if no such entities exist.
	 */
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId")
	List<CFBamJpaAtom> findByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId);
	 ...
	 */
	default List<CFBamJpaAtom> findByScopeIdx(ICFBamValueByScopeIdxKey key) {
	...
	List<CFBamJpaAtom> findByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaAtom> findByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
	...
	List<CFBamJpaAtom> findByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaAtom> findByPrevIdx(ICFBamValueByPrevIdxKey key) {
	...
	List<CFBamJpaAtom> findByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaAtom> findByNextIdx(ICFBamValueByNextIdxKey key) {
	...
	List<CFBamJpaAtom> findByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaAtom> findByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
	...
	List<CFBamJpaAtom> findByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaAtom> findByContNextIdx(ICFBamValueByContNextIdxKey key) {
	...
	@Query("select r from CFBamJpaValue r where r.requiredId = :id")
	CFBamJpaAtom lockByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.requiredName = :name")
	CFBamJpaAtom lockByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName);
	 ...
	 *		@return The locked entity, refreshed from the data store, or null if no such entity exists.
	 */
	default CFBamJpaAtom lockByUNameIdx(ICFBamValueByUNameIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId")
	List<CFBamJpaAtom> lockByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaAtom> lockByScopeIdx(ICFBamValueByScopeIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaAtom> lockByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaAtom> lockByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaAtom> lockByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaAtom> lockByPrevIdx(ICFBamValueByPrevIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaAtom> lockByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaAtom> lockByNextIdx(ICFBamValueByNextIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaAtom> lockByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaAtom> lockByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaAtom> lockByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaAtom> lockByContNextIdx(ICFBamValueByContNextIdxKey key) {
