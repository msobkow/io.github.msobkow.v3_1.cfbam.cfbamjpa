...
public class CFBamJpaDbKeyHash224GenTable implements ICFBamDbKeyHash224GenTable
{
		...
		ICFBamDbKeyHash224Gen rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash224Gen created = dbkeyhash224genService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamDbKeyHash224Gen rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash224Gen jparec = (CFBamJpaDbKeyHash224Gen)rec;
			CFBamJpaDbKeyHash224Gen updated = dbkeyhash224genService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamDbKeyHash224Gen rec )
	{
		...
		if (rec instanceof CFBamJpaDbKeyHash224Gen) {
			CFBamJpaDbKeyHash224Gen jparec = (CFBamJpaDbKeyHash224Gen)rec;
			dbkeyhash224genService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		dbkeyhash224genService.deleteBySchemaIdx(argSchemaDefId);
	}
	...
	{
		dbkeyhash224genService.deleteBySchemaIdx(argKey.getRequiredSchemaDefId());
	}
	...
	{
		dbkeyhash224genService.deleteByIdIdx(argKey);
	}
	...
	public void deleteDbKeyHash224GenByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		dbkeyhash224genService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		dbkeyhash224genService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash224GenByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		dbkeyhash224genService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		dbkeyhash224genService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		dbkeyhash224genService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		dbkeyhash224genService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		dbkeyhash224genService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		dbkeyhash224genService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		dbkeyhash224genService.deleteByNextIdx(argNextId);
	}
	...
	{
		dbkeyhash224genService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteDbKeyHash224GenByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		dbkeyhash224genService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		dbkeyhash224genService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash224GenByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		dbkeyhash224genService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		dbkeyhash224genService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( dbkeyhash224genService.find(PKey) );
	}
	...
	public ICFBamDbKeyHash224Gen lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( dbkeyhash224genService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamDbKeyHash224Gen[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaDbKeyHash224Gen> results = dbkeyhash224genService.findAll();
	...
	{
		return( dbkeyhash224genService.find(argId) );
	}
	...
	public ICFBamDbKeyHash224Gen readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( dbkeyhash224genService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamDbKeyHash224Gen[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaDbKeyHash224Gen> results = dbkeyhash224genService.findByScopeIdx(argScopeId);
		ICFBamDbKeyHash224Gen[] retset = new ICFBamDbKeyHash224Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Gen cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash224Gen[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaDbKeyHash224Gen> results = dbkeyhash224genService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamDbKeyHash224Gen[] retset = new ICFBamDbKeyHash224Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Gen cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash224Gen[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash224Gen> results = dbkeyhash224genService.findByPrevIdx(argPrevId);
		ICFBamDbKeyHash224Gen[] retset = new ICFBamDbKeyHash224Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Gen cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash224Gen[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash224Gen> results = dbkeyhash224genService.findByNextIdx(argNextId);
		ICFBamDbKeyHash224Gen[] retset = new ICFBamDbKeyHash224Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Gen cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash224Gen[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash224Gen> results = dbkeyhash224genService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamDbKeyHash224Gen[] retset = new ICFBamDbKeyHash224Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Gen cur: results) {
	...
	public ICFBamDbKeyHash224Gen[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash224Gen> results = dbkeyhash224genService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamDbKeyHash224Gen[] retset = new ICFBamDbKeyHash224Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Gen cur: results) {
	...
	public ICFBamDbKeyHash224Gen[] readDerivedBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argSchemaDefId )
	{
		List<CFBamJpaDbKeyHash224Gen> results = dbkeyhash224genService.findBySchemaIdx(argSchemaDefId);
		ICFBamDbKeyHash224Gen[] retset = new ICFBamDbKeyHash224Gen[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Gen cur: results) {
			retset[idx++] = cur;
