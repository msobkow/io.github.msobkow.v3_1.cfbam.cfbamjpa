...
// Description: Java 25 JPA Default Factory implementation for NmTokensCol.
...
/*
 *	CFBamNmTokensColFactory JPA implementation for NmTokensCol
 */
public class CFBamJpaNmTokensColDefaultFactory
    implements ICFBamNmTokensColFactory
{
    public CFBamJpaNmTokensColDefaultFactory() {
    }

    @Override
    public ICFBamNmTokensColByTableIdxKey newByTableIdxKey() {
	ICFBamNmTokensColByTableIdxKey key =
            new CFBamJpaNmTokensColByTableIdxKey();
	return( key );
    }

	public CFBamJpaNmTokensColByTableIdxKey ensureByTableIdxKey(ICFBamNmTokensColByTableIdxKey key) {
		if (key == null) {
			return( null );
		}
		else if (key instanceof CFBamJpaNmTokensColByTableIdxKey) {
			return( (CFBamJpaNmTokensColByTableIdxKey)key );
		}
		else {
			CFBamJpaNmTokensColByTableIdxKey mapped = new CFBamJpaNmTokensColByTableIdxKey();
    ...
    public ICFBamNmTokensCol newRec() {
        ICFBamNmTokensCol rec =
            new CFBamJpaNmTokensCol();
        return( rec );
    }

	public CFBamJpaNmTokensCol ensureRec(ICFBamNmTokensCol rec) {
		if( rec == null ) {
			return( null );
		}
