...
// Description: Java 25 JPA Default Factory implementation for NmTokensDef.
...
/*
 *	CFBamNmTokensDefFactory JPA implementation for NmTokensDef
 */
public class CFBamJpaNmTokensDefDefaultFactory
    implements ICFBamNmTokensDefFactory
{
    public CFBamJpaNmTokensDefDefaultFactory() {
    }

    @Override
    public ICFBamNmTokensDef newRec() {
        ICFBamNmTokensDef rec =
            new CFBamJpaNmTokensDef();
        return( rec );
    }
