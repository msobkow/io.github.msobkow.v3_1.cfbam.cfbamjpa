// Description: Java 25 JPA implementation of a RelationCol history primary key object.
...
/**
 *	CFBamJpaRelationColHPKey History Primary Key for RelationCol
 *		requiredId	Required object attribute Id.
 */
public class CFBamJpaRelationColHPKey
	implements ICFBamRelationColHPKey, Comparable<Object>, Serializable
{
	...
	public CFBamJpaRelationColHPKey() {
	...
	public String toString() {
		String ret = "<CFBamJpaRelationColHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
