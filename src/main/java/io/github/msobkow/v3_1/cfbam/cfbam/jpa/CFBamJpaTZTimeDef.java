// Description: Java 25 JPA implementation of a TZTimeDef entity definition object.
...
@Entity
@Table(
	name = "tmzdef", schema = "CFBam31",
	indexes = {
		@Index(name = "TZTimeDefIdIdx", columnList = "Id", unique = true)
	}
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43092")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaTZTimeDef extends CFBamJpaAtom
	implements ICFBamTZTimeDef
{
	...
	public String toString() {
		String ret = "<CFBamJpaTZTimeDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
