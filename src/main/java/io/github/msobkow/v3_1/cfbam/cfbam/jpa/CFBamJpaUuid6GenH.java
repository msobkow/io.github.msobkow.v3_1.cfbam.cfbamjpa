// Description: Java 25 JPA implementation of Uuid6Gen history objects
...
/**
 *  CFBamJpaUuid6GenH provides history objects matching the CFBamUuid6Gen change history.
 */
@Entity
@Table(
    name = "idguuid6_h", schema = "CFBam31",
    indexes = {
        @Index(name = "Uuid6GenIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true)
    }
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43145")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaUuid6GenH extends CFBamJpaUuid6TypeH
    implements ICFBamUuid6GenH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof ICFBamUuid6Gen ) {
			setUuid6Gen( (ICFBamUuid6Gen)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamJpaUuid6GenH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
