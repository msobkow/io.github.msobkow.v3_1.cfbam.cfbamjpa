// Description: Java 25 JPA implementation of a DelSubDep1 by UNameIdx index key object.
...
public class CFBamJpaDelSubDep1ByUNameIdxKey
	implements ICFBamDelSubDep1ByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public CFBamJpaDelSubDep1ByUNameIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDelSubDep1ByUNameIdxKey, ICFBamDelSubDep1, ICFBamDelSubDep1H");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDelSubDep1ByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
