// Description: Java 25 JPA implementation of a TZTimeCol entity definition object.
...
@Entity
@Table(
	name = "tmzcol", schema = "CFBam31",
	indexes = {
		@Index(name = "TZTimeColIdIdx", columnList = "Id", unique = true),
		@Index(name = "TZTimeColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaTZTimeCol extends CFBamJpaTZTimeDef
	implements ICFBamTZTimeCol
{
	...
	public String toString() {
		String ret = "<CFBamJpaTZTimeCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
