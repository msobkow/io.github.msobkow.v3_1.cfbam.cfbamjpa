...
// Description: Java 25 JPA Default Factory implementation for UInt64Col.
...
/*
 *	CFBamUInt64ColFactory JPA implementation for UInt64Col
 */
public class CFBamJpaUInt64ColDefaultFactory
    implements ICFBamUInt64ColFactory
{
    public CFBamJpaUInt64ColDefaultFactory() {
    }

    @Override
    public ICFBamUInt64ColByTableIdxKey newByTableIdxKey() {
	ICFBamUInt64ColByTableIdxKey key =
            new CFBamJpaUInt64ColByTableIdxKey();
	return( key );
    }
