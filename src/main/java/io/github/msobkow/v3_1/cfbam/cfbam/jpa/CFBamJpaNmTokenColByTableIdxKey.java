// Description: Java 25 JPA implementation of a NmTokenCol by TableIdx index key object.
...
public class CFBamJpaNmTokenColByTableIdxKey
	implements ICFBamNmTokenColByTableIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	public CFBamJpaNmTokenColByTableIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamNmTokenColByTableIdxKey, ICFBamNmTokenCol, ICFBamNmTokenColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamNmTokenColByTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
