// Description: Java 25 JPA implementation of a RelationCol by PrevIdx index key object.
	...
	implements ICFBamRelationColByPrevIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamRelationColByPrevIdxKey, ICFBamRelationCol, ICFBamRelationColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamRelationColByPrevIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
