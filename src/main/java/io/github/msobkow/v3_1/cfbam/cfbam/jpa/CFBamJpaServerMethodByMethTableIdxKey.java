// Description: Java 25 JPA implementation of a ServerMethod by MethTableIdx index key object.
...
public class CFBamJpaServerMethodByMethTableIdxKey
	implements ICFBamServerMethodByMethTableIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamServerMethodByMethTableIdxKey, ICFBamServerMethod, ICFBamServerMethodH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamServerMethodByMethTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
