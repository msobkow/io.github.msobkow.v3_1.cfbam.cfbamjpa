// Description: Java 25 JPA implementation of a UInt16Type entity definition object.
...
@Entity
@Table(
	name = "uint16typ", schema = "CFBam31",
	indexes = {
		@Index(name = "UInt16TypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "UInt16TypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaUInt16Type extends CFBamJpaUInt16Def
	implements ICFBamUInt16Type
{
	...
	public String toString() {
		String ret = "<CFBamJpaUInt16Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
