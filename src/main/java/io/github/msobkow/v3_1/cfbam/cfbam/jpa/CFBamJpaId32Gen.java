// Description: Java 25 JPA implementation of a Id32Gen entity definition object.
...
@Entity
@Table(
	name = "idg32", schema = "CFBam31",
	indexes = {
		@Index(name = "Id32GenIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaId32Gen extends CFBamJpaInt32Type
	implements ICFBamId32Gen
{
	...
	public String toString() {
		String ret = "<CFBamJpaId32Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
