...
public class CFBamJpaUInt32DefTable implements ICFBamUInt32DefTable
{
		...
		ICFBamUInt32Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaUInt32Def created = uint32defService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamUInt32Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaUInt32Def jparec = (CFBamJpaUInt32Def)rec;
			CFBamJpaUInt32Def updated = uint32defService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamUInt32Def rec )
	{
		...
		if (rec instanceof CFBamJpaUInt32Def) {
			CFBamJpaUInt32Def jparec = (CFBamJpaUInt32Def)rec;
			uint32defService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		uint32defService.deleteByIdIdx(argKey);
	}
	...
	public void deleteUInt32DefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		uint32defService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		uint32defService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteUInt32DefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		uint32defService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		uint32defService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		uint32defService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		uint32defService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		uint32defService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		uint32defService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		uint32defService.deleteByNextIdx(argNextId);
	}
	...
	{
		uint32defService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteUInt32DefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		uint32defService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		uint32defService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteUInt32DefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		uint32defService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		uint32defService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( uint32defService.find(PKey) );
	}
	...
	public ICFBamUInt32Def lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( uint32defService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamUInt32Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaUInt32Def> results = uint32defService.findAll();
	...
	{
		return( uint32defService.find(argId) );
	}
	...
	public ICFBamUInt32Def readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( uint32defService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamUInt32Def[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaUInt32Def> results = uint32defService.findByScopeIdx(argScopeId);
		ICFBamUInt32Def[] retset = new ICFBamUInt32Def[results.size()];
		int idx = 0;
		for (CFBamJpaUInt32Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt32Def[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaUInt32Def> results = uint32defService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamUInt32Def[] retset = new ICFBamUInt32Def[results.size()];
		int idx = 0;
		for (CFBamJpaUInt32Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt32Def[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaUInt32Def> results = uint32defService.findByPrevIdx(argPrevId);
		ICFBamUInt32Def[] retset = new ICFBamUInt32Def[results.size()];
		int idx = 0;
		for (CFBamJpaUInt32Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt32Def[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaUInt32Def> results = uint32defService.findByNextIdx(argNextId);
		ICFBamUInt32Def[] retset = new ICFBamUInt32Def[results.size()];
		int idx = 0;
		for (CFBamJpaUInt32Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt32Def[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaUInt32Def> results = uint32defService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamUInt32Def[] retset = new ICFBamUInt32Def[results.size()];
		int idx = 0;
		for (CFBamJpaUInt32Def cur: results) {
	...
	public ICFBamUInt32Def[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaUInt32Def> results = uint32defService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamUInt32Def[] retset = new ICFBamUInt32Def[results.size()];
		int idx = 0;
		for (CFBamJpaUInt32Def cur: results) {
