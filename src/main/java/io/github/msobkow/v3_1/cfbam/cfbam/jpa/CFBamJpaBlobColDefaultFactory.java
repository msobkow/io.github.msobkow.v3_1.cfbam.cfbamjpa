...
// Description: Java 25 JPA Default Factory implementation for BlobCol.
...
/*
 *	CFBamBlobColFactory JPA implementation for BlobCol
 */
public class CFBamJpaBlobColDefaultFactory
    implements ICFBamBlobColFactory
{
    public CFBamJpaBlobColDefaultFactory() {
    }

    @Override
    public ICFBamBlobColByTableIdxKey newByTableIdxKey() {
	ICFBamBlobColByTableIdxKey key =
            new CFBamJpaBlobColByTableIdxKey();
	return( key );
    }

	public CFBamJpaBlobColByTableIdxKey ensureByTableIdxKey(ICFBamBlobColByTableIdxKey key) {
		if (key == null) {
			return( null );
		}
		else if (key instanceof CFBamJpaBlobColByTableIdxKey) {
	...
	public CFBamJpaBlobCol ensureRec(ICFBamBlobCol rec) {
		if( rec == null ) {
			return( null );
		}
