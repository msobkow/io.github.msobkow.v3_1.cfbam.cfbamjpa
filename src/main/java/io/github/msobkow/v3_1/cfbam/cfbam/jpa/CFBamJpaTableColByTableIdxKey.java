// Description: Java 25 JPA implementation of a TableCol by TableIdx index key object.
...
public class CFBamJpaTableColByTableIdxKey
	implements ICFBamTableColByTableIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	public CFBamJpaTableColByTableIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTableColByTableIdxKey, ICFBamTableCol, ICFBamTableColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTableColByTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
