// Description: Java 25 JPA implementation of a DateType by SchemaIdx index key object.
...
public class CFBamJpaDateTypeBySchemaIdxKey
	implements ICFBamDateTypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaDateTypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDateTypeBySchemaIdxKey, ICFBamDateType, ICFBamDateTypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDateTypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
