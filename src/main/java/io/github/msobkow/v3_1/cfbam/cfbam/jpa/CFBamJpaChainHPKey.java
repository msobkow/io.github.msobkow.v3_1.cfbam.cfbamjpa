// Description: Java 25 JPA implementation of a Chain history primary key object.
...
/**
 *	CFBamJpaChainHPKey History Primary Key for Chain
 *		requiredId	Required object attribute Id.
 */
public class CFBamJpaChainHPKey
	implements ICFBamChainHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamJpaChainHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
