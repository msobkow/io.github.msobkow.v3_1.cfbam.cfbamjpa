// Description: Java 25 JPA implementation of Int32Col history objects
...
/**
 *  CFBamJpaInt32ColH provides history objects matching the CFBamInt32Col change history.
 */
@Entity
@Table(
    name = "int32col_h", schema = "CFBam31",
    indexes = {
        @Index(name = "Int32ColIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "Int32ColTableIdx_h", columnList = "TableId", unique = false)
    }
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43126")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaInt32ColH extends CFBamJpaInt32DefH
    implements ICFBamInt32ColH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof ICFBamInt32Col ) {
			setInt32Col( (ICFBamInt32Col)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamJpaInt32ColH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
