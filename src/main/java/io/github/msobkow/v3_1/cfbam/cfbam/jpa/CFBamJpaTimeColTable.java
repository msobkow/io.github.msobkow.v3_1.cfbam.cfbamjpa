...
public class CFBamJpaTimeColTable implements ICFBamTimeColTable
{
		...
		ICFBamTimeCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaTimeCol created = timecolService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamTimeCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaTimeCol jparec = (CFBamJpaTimeCol)rec;
			CFBamJpaTimeCol updated = timecolService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamTimeCol rec )
	{
		...
		if (rec instanceof CFBamJpaTimeCol) {
			CFBamJpaTimeCol jparec = (CFBamJpaTimeCol)rec;
			timecolService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		timecolService.deleteByTableIdx(argTableId);
	}
	...
	{
		timecolService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		timecolService.deleteByIdIdx(argKey);
	}
	...
	public void deleteTimeColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		timecolService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		timecolService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTimeColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		timecolService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		timecolService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		timecolService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		timecolService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		timecolService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		timecolService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		timecolService.deleteByNextIdx(argNextId);
	}
	...
	{
		timecolService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteTimeColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		timecolService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		timecolService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTimeColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		timecolService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		timecolService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( timecolService.find(PKey) );
	}
	...
	public ICFBamTimeCol lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( timecolService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamTimeCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaTimeCol> results = timecolService.findAll();
	...
	{
		return( timecolService.find(argId) );
	}
	...
	public ICFBamTimeCol readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( timecolService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamTimeCol[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaTimeCol> results = timecolService.findByScopeIdx(argScopeId);
		ICFBamTimeCol[] retset = new ICFBamTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTimeCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTimeCol[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaTimeCol> results = timecolService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamTimeCol[] retset = new ICFBamTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTimeCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTimeCol[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTimeCol> results = timecolService.findByPrevIdx(argPrevId);
		ICFBamTimeCol[] retset = new ICFBamTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTimeCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTimeCol[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTimeCol> results = timecolService.findByNextIdx(argNextId);
		ICFBamTimeCol[] retset = new ICFBamTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTimeCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTimeCol[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTimeCol> results = timecolService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamTimeCol[] retset = new ICFBamTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTimeCol cur: results) {
	...
	public ICFBamTimeCol[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTimeCol> results = timecolService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamTimeCol[] retset = new ICFBamTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTimeCol cur: results) {
	...
	public ICFBamTimeCol[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaTimeCol> results = timecolService.findByTableIdx(argTableId);
		ICFBamTimeCol[] retset = new ICFBamTimeCol[results.size()];
		int idx = 0;
		for (CFBamJpaTimeCol cur: results) {
			retset[idx++] = cur;
