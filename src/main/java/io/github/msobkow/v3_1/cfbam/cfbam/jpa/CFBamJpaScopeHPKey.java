// Description: Java 25 JPA implementation of a Scope history primary key object.
...
/**
 *	CFBamJpaScopeHPKey History Primary Key for Scope
 *		requiredId	Required object attribute Id.
 */
public class CFBamJpaScopeHPKey
	implements ICFBamScopeHPKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamJpaScopeHPKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
