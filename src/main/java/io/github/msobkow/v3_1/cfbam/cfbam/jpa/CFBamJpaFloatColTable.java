...
public class CFBamJpaFloatColTable implements ICFBamFloatColTable
{
		...
		ICFBamFloatCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaFloatCol created = floatcolService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamFloatCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaFloatCol jparec = (CFBamJpaFloatCol)rec;
			CFBamJpaFloatCol updated = floatcolService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamFloatCol rec )
	{
		...
		if (rec instanceof CFBamJpaFloatCol) {
			CFBamJpaFloatCol jparec = (CFBamJpaFloatCol)rec;
			floatcolService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		floatcolService.deleteByTableIdx(argTableId);
	}
	...
	{
		floatcolService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		floatcolService.deleteByIdIdx(argKey);
	}
	...
	public void deleteFloatColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		floatcolService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		floatcolService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteFloatColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		floatcolService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		floatcolService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		floatcolService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		floatcolService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		floatcolService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		floatcolService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		floatcolService.deleteByNextIdx(argNextId);
	}
	...
	{
		floatcolService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteFloatColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		floatcolService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		floatcolService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteFloatColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		floatcolService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		floatcolService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( floatcolService.find(PKey) );
	}
	...
	public ICFBamFloatCol lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( floatcolService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamFloatCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaFloatCol> results = floatcolService.findAll();
	...
	{
		return( floatcolService.find(argId) );
	}
	...
	public ICFBamFloatCol readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( floatcolService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamFloatCol[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaFloatCol> results = floatcolService.findByScopeIdx(argScopeId);
		ICFBamFloatCol[] retset = new ICFBamFloatCol[results.size()];
		int idx = 0;
		for (CFBamJpaFloatCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamFloatCol[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaFloatCol> results = floatcolService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamFloatCol[] retset = new ICFBamFloatCol[results.size()];
		int idx = 0;
		for (CFBamJpaFloatCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamFloatCol[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaFloatCol> results = floatcolService.findByPrevIdx(argPrevId);
		ICFBamFloatCol[] retset = new ICFBamFloatCol[results.size()];
		int idx = 0;
		for (CFBamJpaFloatCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamFloatCol[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaFloatCol> results = floatcolService.findByNextIdx(argNextId);
		ICFBamFloatCol[] retset = new ICFBamFloatCol[results.size()];
		int idx = 0;
		for (CFBamJpaFloatCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamFloatCol[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaFloatCol> results = floatcolService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamFloatCol[] retset = new ICFBamFloatCol[results.size()];
		int idx = 0;
		for (CFBamJpaFloatCol cur: results) {
	...
	public ICFBamFloatCol[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaFloatCol> results = floatcolService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamFloatCol[] retset = new ICFBamFloatCol[results.size()];
		int idx = 0;
		for (CFBamJpaFloatCol cur: results) {
	...
	public ICFBamFloatCol[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaFloatCol> results = floatcolService.findByTableIdx(argTableId);
		ICFBamFloatCol[] retset = new ICFBamFloatCol[results.size()];
		int idx = 0;
		for (CFBamJpaFloatCol cur: results) {
			retset[idx++] = cur;
