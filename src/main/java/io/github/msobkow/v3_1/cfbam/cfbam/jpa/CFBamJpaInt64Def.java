// Description: Java 25 JPA implementation of a Int64Def entity definition object.
...
@Entity
@Table(
	name = "int64def", schema = "CFBam31",
	indexes = {
		@Index(name = "Int64DefIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaInt64Def extends CFBamJpaAtom
	implements ICFBamInt64Def
{
	...
	public String toString() {
		String ret = "<CFBamJpaInt64Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
