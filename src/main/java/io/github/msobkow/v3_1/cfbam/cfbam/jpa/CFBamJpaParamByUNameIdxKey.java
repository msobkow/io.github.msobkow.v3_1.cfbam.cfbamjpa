// Description: Java 25 JPA implementation of a Param by UNameIdx index key object.
	...
	implements ICFBamParamByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamParamByUNameIdxKey, ICFBamParam, ICFBamParamH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamParamByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
