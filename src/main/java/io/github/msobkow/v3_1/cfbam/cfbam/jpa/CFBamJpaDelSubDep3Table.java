...
public class CFBamJpaDelSubDep3Table implements ICFBamDelSubDep3Table
{
		...
		ICFBamDelSubDep3 rec )
	{
		if (rec == null) {
			...
			CFBamJpaDelSubDep3 created = delsubdep3Service.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamDelSubDep3 rec )
	{
		if (rec == null) {
			...
			CFBamJpaDelSubDep3 jparec = (CFBamJpaDelSubDep3)rec;
			CFBamJpaDelSubDep3 updated = delsubdep3Service.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamDelSubDep3 rec )
	{
		...
		if (rec instanceof CFBamJpaDelSubDep3) {
			CFBamJpaDelSubDep3 jparec = (CFBamJpaDelSubDep3)rec;
			delsubdep3Service.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		delsubdep3Service.deleteByDelSubDep2Idx(argDelSubDep2Id);
	}
	...
	{
		delsubdep3Service.deleteByDelSubDep2Idx(argKey.getRequiredDelSubDep2Id());
	}
	...
	public void deleteDelSubDep3ByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		delsubdep3Service.deleteByUNameIdx(argDelSubDep2Id,
		argName);
	}
	...
	{
		delsubdep3Service.deleteByUNameIdx(argKey.getRequiredDelSubDep2Id(),
	...
	{
		delsubdep3Service.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		delsubdep3Service.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		delsubdep3Service.deleteByDelDepIdx(argRelationId);
	}
	...
	{
		delsubdep3Service.deleteByDelDepIdx(argKey.getRequiredRelationId());
	}
	...
	{
		delsubdep3Service.deleteByIdIdx(argKey);
	}
	...
	{
		delsubdep3Service.deleteByTenantIdx(argTenantId);
	}
	...
	{
		delsubdep3Service.deleteByTenantIdx(argKey.getRequiredTenantId());
	}
	...
	{
		return( delsubdep3Service.find(PKey) );
	}
	...
	public ICFBamDelSubDep3 lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( delsubdep3Service.lockByIdIdx(PKey) );
	}
	...
	public ICFBamDelSubDep3[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaDelSubDep3> results = delsubdep3Service.findAll();
	...
	{
		return( delsubdep3Service.find(argId) );
	}
	...
	public ICFBamDelSubDep3[] readDerivedByTenantIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTenantId )
	{
		List<CFBamJpaDelSubDep3> results = delsubdep3Service.findByTenantIdx(argTenantId);
		ICFBamDelSubDep3[] retset = new ICFBamDelSubDep3[results.size()];
		int idx = 0;
		for (CFBamJpaDelSubDep3 cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDelSubDep3[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaDelSubDep3> results = delsubdep3Service.findByDefSchemaIdx(argDefSchemaId);
		ICFBamDelSubDep3[] retset = new ICFBamDelSubDep3[results.size()];
		int idx = 0;
		for (CFBamJpaDelSubDep3 cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDelSubDep3[] readDerivedByDelDepIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argRelationId )
	{
		List<CFBamJpaDelSubDep3> results = delsubdep3Service.findByDelDepIdx(argRelationId);
		ICFBamDelSubDep3[] retset = new ICFBamDelSubDep3[results.size()];
		int idx = 0;
		for (CFBamJpaDelSubDep3 cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDelSubDep3[] readDerivedByDelSubDep2Idx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDelSubDep2Id )
	{
		List<CFBamJpaDelSubDep3> results = delsubdep3Service.findByDelSubDep2Idx(argDelSubDep2Id);
		ICFBamDelSubDep3[] retset = new ICFBamDelSubDep3[results.size()];
		int idx = 0;
		for (CFBamJpaDelSubDep3 cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDelSubDep3 readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( delsubdep3Service.findByUNameIdx(argDelSubDep2Id,
		argName) );
	}
