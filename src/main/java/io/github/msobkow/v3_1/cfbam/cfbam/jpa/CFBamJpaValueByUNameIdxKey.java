// Description: Java 25 JPA implementation of a Value by UNameIdx index key object.
...
public class CFBamJpaValueByUNameIdxKey
	implements ICFBamValueByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamValueByUNameIdxKey, ICFBamValue, ICFBamValueH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamValueByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
