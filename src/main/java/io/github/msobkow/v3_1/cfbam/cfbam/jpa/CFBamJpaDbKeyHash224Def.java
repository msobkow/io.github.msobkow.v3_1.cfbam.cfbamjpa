// Description: Java 25 JPA implementation of a DbKeyHash224Def entity definition object.
...
@Entity
@Table(
	name = "dbk224def", schema = "CFBam31",
	indexes = {
		@Index(name = "DbKeyHash224DefIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaDbKeyHash224Def extends CFBamJpaAtom
	implements ICFBamDbKeyHash224Def
{
	...
	public CFBamJpaDbKeyHash224Def() {
		super();
	...
	public String toString() {
		String ret = "<CFBamJpaDbKeyHash224Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
