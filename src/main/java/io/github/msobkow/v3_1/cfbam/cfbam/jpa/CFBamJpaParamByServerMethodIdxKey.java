// Description: Java 25 JPA implementation of a Param by ServerMethodIdx index key object.
...
public class CFBamJpaParamByServerMethodIdxKey
	implements ICFBamParamByServerMethodIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamParamByServerMethodIdxKey, ICFBamParam, ICFBamParamH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamParamByServerMethodIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
