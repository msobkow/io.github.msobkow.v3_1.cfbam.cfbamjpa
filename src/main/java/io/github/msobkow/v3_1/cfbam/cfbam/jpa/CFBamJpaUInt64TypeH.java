// Description: Java 25 JPA implementation of UInt64Type history objects
...
/**
 *  CFBamJpaUInt64TypeH provides history objects matching the CFBamUInt64Type change history.
 */
@Entity
@Table(
    name = "uint64typ_h", schema = "CFBam31",
    indexes = {
        @Index(name = "UInt64TypeIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "UInt64TypeSchemaDefIdx_h", columnList = "SchemaDefId", unique = false)
    }
)
...
public class CFBamJpaUInt64TypeH extends CFBamJpaUInt64DefH
    implements ICFBamUInt64TypeH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaUInt64TypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
