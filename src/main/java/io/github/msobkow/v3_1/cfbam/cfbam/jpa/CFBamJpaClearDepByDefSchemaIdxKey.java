// Description: Java 25 JPA implementation of a ClearDep by DefSchemaIdx index key object.
...
public class CFBamJpaClearDepByDefSchemaIdxKey
	implements ICFBamClearDepByDefSchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalDefSchemaId;
	public CFBamJpaClearDepByDefSchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamClearDepByDefSchemaIdxKey, ICFBamClearDep, ICFBamClearDepH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamClearDepByDefSchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
