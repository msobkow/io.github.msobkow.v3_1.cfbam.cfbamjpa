// Description: Java 25 JPA implementation of NmTokensDef history objects
...
/**
 *  CFBamJpaNmTokensDefH provides history objects matching the CFBamNmTokensDef change history.
 */
@Entity
@Table(
    name = "nmtknsdef_h", schema = "CFBam31",
    indexes = {
        @Index(name = "NmTokensDefIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true)
    }
)
...
public class CFBamJpaNmTokensDefH extends CFBamJpaAtomH
    implements ICFBamNmTokensDefH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaNmTokensDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
