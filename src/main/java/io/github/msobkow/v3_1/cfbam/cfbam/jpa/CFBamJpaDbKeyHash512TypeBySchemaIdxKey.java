// Description: Java 25 JPA implementation of a DbKeyHash512Type by SchemaIdx index key object.
...
public class CFBamJpaDbKeyHash512TypeBySchemaIdxKey
	implements ICFBamDbKeyHash512TypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaDbKeyHash512TypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDbKeyHash512TypeBySchemaIdxKey, ICFBamDbKeyHash512Type, ICFBamDbKeyHash512TypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDbKeyHash512TypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
