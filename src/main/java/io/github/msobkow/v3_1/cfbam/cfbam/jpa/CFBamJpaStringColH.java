// Description: Java 25 JPA implementation of StringCol history objects
...
/**
 *  CFBamJpaStringColH provides history objects matching the CFBamStringCol change history.
 */
@Entity
@Table(
    name = "strcol_h", schema = "CFBam31",
    indexes = {
        @Index(name = "StringColIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "StringColTableIdx_h", columnList = "TableId", unique = false)
    }
)
...
public class CFBamJpaStringColH extends CFBamJpaStringDefH
    implements ICFBamStringColH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaStringColH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
