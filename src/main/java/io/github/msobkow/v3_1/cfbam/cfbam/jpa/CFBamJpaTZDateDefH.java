// Description: Java 25 JPA implementation of TZDateDef history objects
...
/**
 *  CFBamJpaTZDateDefH provides history objects matching the CFBamTZDateDef change history.
 */
@Entity
@Table(
    name = "dzdef_h", schema = "CFBam31",
    indexes = {
        @Index(name = "TZDateDefIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true)
    }
)
    ...
    implements ICFBamTZDateDefH
{
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof ICFBamTZDateDef ) {
			setTZDateDef( (ICFBamTZDateDef)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamJpaTZDateDefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
