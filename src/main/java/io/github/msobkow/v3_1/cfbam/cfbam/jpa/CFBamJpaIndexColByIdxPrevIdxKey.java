// Description: Java 25 JPA implementation of a IndexCol by IdxPrevIdx index key object.
...
public class CFBamJpaIndexColByIdxPrevIdxKey
	implements ICFBamIndexColByIdxPrevIdxKey, Comparable<Object>, Serializable
{
	...
	public CFBamJpaIndexColByIdxPrevIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamIndexColByIdxPrevIdxKey, ICFBamIndexCol, ICFBamIndexColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamIndexColByIdxPrevIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
