// Description: Java 25 JPA implementation of a Int32Col entity definition object.
...
@Entity
@Table(
	name = "int32col", schema = "CFBam31",
	indexes = {
		@Index(name = "Int32ColIdIdx", columnList = "Id", unique = true),
		@Index(name = "Int32ColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaInt32Col extends CFBamJpaInt32Def
	implements ICFBamInt32Col
{
	...
	public String toString() {
		String ret = "<CFBamJpaInt32Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
