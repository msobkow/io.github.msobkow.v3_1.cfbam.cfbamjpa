// Description: Java 25 JPA implementation of a NmTokensType entity definition object.
...
@Entity
@Table(
	name = "nmtknstyp", schema = "CFBam31",
	indexes = {
		@Index(name = "NmTokensTypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "NmTokensTypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaNmTokensType extends CFBamJpaNmTokensDef
	implements ICFBamNmTokensType
{
	...
	public String toString() {
		String ret = "<CFBamJpaNmTokensType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
