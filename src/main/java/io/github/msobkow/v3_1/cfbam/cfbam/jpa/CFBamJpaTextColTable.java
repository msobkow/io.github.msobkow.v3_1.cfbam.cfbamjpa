...
public class CFBamJpaTextColTable implements ICFBamTextColTable
{
		...
		ICFBamTextCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaTextCol created = textcolService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamTextCol rec )
	{
		if (rec == null) {
			...
			CFBamJpaTextCol jparec = (CFBamJpaTextCol)rec;
			CFBamJpaTextCol updated = textcolService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamTextCol rec )
	{
		...
		if (rec instanceof CFBamJpaTextCol) {
			CFBamJpaTextCol jparec = (CFBamJpaTextCol)rec;
			textcolService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		textcolService.deleteByTableIdx(argTableId);
	}
	...
	{
		textcolService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		textcolService.deleteByIdIdx(argKey);
	}
	...
	public void deleteTextColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		textcolService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		textcolService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTextColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		textcolService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		textcolService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		textcolService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		textcolService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		textcolService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		textcolService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		textcolService.deleteByNextIdx(argNextId);
	}
	...
	{
		textcolService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteTextColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		textcolService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		textcolService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTextColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		textcolService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		textcolService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( textcolService.find(PKey) );
	}
	...
	public ICFBamTextCol lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( textcolService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamTextCol[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaTextCol> results = textcolService.findAll();
	...
	{
		return( textcolService.find(argId) );
	}
	...
	public ICFBamTextCol readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( textcolService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamTextCol[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaTextCol> results = textcolService.findByScopeIdx(argScopeId);
		ICFBamTextCol[] retset = new ICFBamTextCol[results.size()];
		int idx = 0;
		for (CFBamJpaTextCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTextCol[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaTextCol> results = textcolService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamTextCol[] retset = new ICFBamTextCol[results.size()];
		int idx = 0;
		for (CFBamJpaTextCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTextCol[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTextCol> results = textcolService.findByPrevIdx(argPrevId);
		ICFBamTextCol[] retset = new ICFBamTextCol[results.size()];
		int idx = 0;
		for (CFBamJpaTextCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTextCol[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTextCol> results = textcolService.findByNextIdx(argNextId);
		ICFBamTextCol[] retset = new ICFBamTextCol[results.size()];
		int idx = 0;
		for (CFBamJpaTextCol cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTextCol[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTextCol> results = textcolService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamTextCol[] retset = new ICFBamTextCol[results.size()];
		int idx = 0;
		for (CFBamJpaTextCol cur: results) {
	...
	public ICFBamTextCol[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTextCol> results = textcolService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamTextCol[] retset = new ICFBamTextCol[results.size()];
		int idx = 0;
		for (CFBamJpaTextCol cur: results) {
	...
	public ICFBamTextCol[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaTextCol> results = textcolService.findByTableIdx(argTableId);
		ICFBamTextCol[] retset = new ICFBamTextCol[results.size()];
		int idx = 0;
		for (CFBamJpaTextCol cur: results) {
			retset[idx++] = cur;
