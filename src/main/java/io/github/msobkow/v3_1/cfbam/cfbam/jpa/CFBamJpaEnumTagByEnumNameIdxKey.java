// Description: Java 25 JPA implementation of a EnumTag by EnumNameIdx index key object.
...
public class CFBamJpaEnumTagByEnumNameIdxKey
	implements ICFBamEnumTagByEnumNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamEnumTagByEnumNameIdxKey, ICFBamEnumTag, ICFBamEnumTagH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamEnumTagByEnumNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
