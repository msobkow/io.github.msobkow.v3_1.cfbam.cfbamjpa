// Description: Java 25 JPA implementation of a TextType by SchemaIdx index key object.
...
public class CFBamJpaTextTypeBySchemaIdxKey
	implements ICFBamTextTypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaTextTypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTextTypeBySchemaIdxKey, ICFBamTextType, ICFBamTextTypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTextTypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
