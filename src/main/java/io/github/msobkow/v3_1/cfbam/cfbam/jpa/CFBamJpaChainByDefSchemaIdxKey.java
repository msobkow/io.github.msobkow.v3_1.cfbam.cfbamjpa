// Description: Java 25 JPA implementation of a Chain by DefSchemaIdx index key object.
...
public class CFBamJpaChainByDefSchemaIdxKey
	implements ICFBamChainByDefSchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalDefSchemaId;
	public CFBamJpaChainByDefSchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamChainByDefSchemaIdxKey, ICFBamChain, ICFBamChainH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamChainByDefSchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
