// Description: Java 25 JPA implementation of a UInt32Type by SchemaIdx index key object.
...
public class CFBamJpaUInt32TypeBySchemaIdxKey
	implements ICFBamUInt32TypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaUInt32TypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamUInt32TypeBySchemaIdxKey, ICFBamUInt32Type, ICFBamUInt32TypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamUInt32TypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
