// Description: Java 25 JPA implementation of a EnumTag by DefSchemaIdx index key object.
...
public class CFBamJpaEnumTagByDefSchemaIdxKey
	implements ICFBamEnumTagByDefSchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalDefSchemaId;
	public CFBamJpaEnumTagByDefSchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamEnumTagByDefSchemaIdxKey, ICFBamEnumTag, ICFBamEnumTagH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamEnumTagByDefSchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
