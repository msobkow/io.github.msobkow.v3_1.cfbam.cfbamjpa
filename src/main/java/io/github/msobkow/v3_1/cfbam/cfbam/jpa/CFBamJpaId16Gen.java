// Description: Java 25 JPA implementation of a Id16Gen entity definition object.
...
@Entity
@Table(
	name = "idg16", schema = "CFBam31",
	indexes = {
		@Index(name = "Id16GenIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaId16Gen extends CFBamJpaInt16Type
	implements ICFBamId16Gen
{
	...
	public String toString() {
		String ret = "<CFBamJpaId16Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
