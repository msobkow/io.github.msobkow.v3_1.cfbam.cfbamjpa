// Description: Java 25 JPA implementation of a TimeCol entity definition object.
...
@Entity
@Table(
	name = "tmcol", schema = "CFBam31",
	indexes = {
		@Index(name = "TimeColIdIdx", columnList = "Id", unique = true),
		@Index(name = "TimeColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaTimeCol extends CFBamJpaTimeDef
	implements ICFBamTimeCol
{
	...
	public String toString() {
		String ret = "<CFBamJpaTimeCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
