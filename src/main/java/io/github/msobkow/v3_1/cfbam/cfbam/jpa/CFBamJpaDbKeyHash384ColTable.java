...
public class CFBamJpaDbKeyHash384ColTable implements ICFBamDbKeyHash384ColTable
{
		...
		ICFBamDbKeyHash384Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash384Col created = dbkeyhash384colService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamDbKeyHash384Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash384Col jparec = (CFBamJpaDbKeyHash384Col)rec;
			CFBamJpaDbKeyHash384Col updated = dbkeyhash384colService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamDbKeyHash384Col rec )
	{
		...
		if (rec instanceof CFBamJpaDbKeyHash384Col) {
			CFBamJpaDbKeyHash384Col jparec = (CFBamJpaDbKeyHash384Col)rec;
			dbkeyhash384colService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		dbkeyhash384colService.deleteByTableIdx(argTableId);
	}
	...
	{
		dbkeyhash384colService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		dbkeyhash384colService.deleteByIdIdx(argKey);
	}
	...
	public void deleteDbKeyHash384ColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		dbkeyhash384colService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		dbkeyhash384colService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash384ColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		dbkeyhash384colService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		dbkeyhash384colService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		dbkeyhash384colService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		dbkeyhash384colService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		dbkeyhash384colService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		dbkeyhash384colService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		dbkeyhash384colService.deleteByNextIdx(argNextId);
	}
	...
	{
		dbkeyhash384colService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteDbKeyHash384ColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		dbkeyhash384colService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		dbkeyhash384colService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash384ColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		dbkeyhash384colService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		dbkeyhash384colService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( dbkeyhash384colService.find(PKey) );
	}
	...
	public ICFBamDbKeyHash384Col lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( dbkeyhash384colService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamDbKeyHash384Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaDbKeyHash384Col> results = dbkeyhash384colService.findAll();
	...
	{
		return( dbkeyhash384colService.find(argId) );
	}
	...
	public ICFBamDbKeyHash384Col readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( dbkeyhash384colService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamDbKeyHash384Col[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaDbKeyHash384Col> results = dbkeyhash384colService.findByScopeIdx(argScopeId);
		ICFBamDbKeyHash384Col[] retset = new ICFBamDbKeyHash384Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash384Col[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaDbKeyHash384Col> results = dbkeyhash384colService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamDbKeyHash384Col[] retset = new ICFBamDbKeyHash384Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash384Col[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash384Col> results = dbkeyhash384colService.findByPrevIdx(argPrevId);
		ICFBamDbKeyHash384Col[] retset = new ICFBamDbKeyHash384Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash384Col[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash384Col> results = dbkeyhash384colService.findByNextIdx(argNextId);
		ICFBamDbKeyHash384Col[] retset = new ICFBamDbKeyHash384Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash384Col[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash384Col> results = dbkeyhash384colService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamDbKeyHash384Col[] retset = new ICFBamDbKeyHash384Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Col cur: results) {
	...
	public ICFBamDbKeyHash384Col[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash384Col> results = dbkeyhash384colService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamDbKeyHash384Col[] retset = new ICFBamDbKeyHash384Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Col cur: results) {
	...
	public ICFBamDbKeyHash384Col[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaDbKeyHash384Col> results = dbkeyhash384colService.findByTableIdx(argTableId);
		ICFBamDbKeyHash384Col[] retset = new ICFBamDbKeyHash384Col[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Col cur: results) {
			retset[idx++] = cur;
