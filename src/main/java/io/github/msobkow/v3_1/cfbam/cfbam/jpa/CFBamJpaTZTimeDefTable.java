...
public class CFBamJpaTZTimeDefTable implements ICFBamTZTimeDefTable
{
		...
		ICFBamTZTimeDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaTZTimeDef created = tztimedefService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamTZTimeDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaTZTimeDef jparec = (CFBamJpaTZTimeDef)rec;
			CFBamJpaTZTimeDef updated = tztimedefService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamTZTimeDef rec )
	{
		...
		if (rec instanceof CFBamJpaTZTimeDef) {
			CFBamJpaTZTimeDef jparec = (CFBamJpaTZTimeDef)rec;
			tztimedefService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		tztimedefService.deleteByIdIdx(argKey);
	}
	...
	public void deleteTZTimeDefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		tztimedefService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		tztimedefService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTZTimeDefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		tztimedefService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		tztimedefService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		tztimedefService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		tztimedefService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		tztimedefService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		tztimedefService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		tztimedefService.deleteByNextIdx(argNextId);
	}
	...
	{
		tztimedefService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteTZTimeDefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		tztimedefService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		tztimedefService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTZTimeDefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		tztimedefService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		tztimedefService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( tztimedefService.find(PKey) );
	}
	...
	public ICFBamTZTimeDef lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( tztimedefService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamTZTimeDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaTZTimeDef> results = tztimedefService.findAll();
	...
	{
		return( tztimedefService.find(argId) );
	}
	...
	public ICFBamTZTimeDef readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( tztimedefService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamTZTimeDef[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaTZTimeDef> results = tztimedefService.findByScopeIdx(argScopeId);
		ICFBamTZTimeDef[] retset = new ICFBamTZTimeDef[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimeDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTZTimeDef[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaTZTimeDef> results = tztimedefService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamTZTimeDef[] retset = new ICFBamTZTimeDef[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimeDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTZTimeDef[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTZTimeDef> results = tztimedefService.findByPrevIdx(argPrevId);
		ICFBamTZTimeDef[] retset = new ICFBamTZTimeDef[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimeDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTZTimeDef[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTZTimeDef> results = tztimedefService.findByNextIdx(argNextId);
		ICFBamTZTimeDef[] retset = new ICFBamTZTimeDef[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimeDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTZTimeDef[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTZTimeDef> results = tztimedefService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamTZTimeDef[] retset = new ICFBamTZTimeDef[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimeDef cur: results) {
	...
	public ICFBamTZTimeDef[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTZTimeDef> results = tztimedefService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamTZTimeDef[] retset = new ICFBamTZTimeDef[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimeDef cur: results) {
