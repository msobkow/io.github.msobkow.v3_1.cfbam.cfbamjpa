// Description: Java 25 JPA implementation of a DoubleDef entity definition object.
...
@Entity
@Table(
	name = "dbldef", schema = "CFBam31",
	indexes = {
		@Index(name = "DoubleDefIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaDoubleDef extends CFBamJpaAtom
	implements ICFBamDoubleDef
{
	...
	public String toString() {
		String ret = "<CFBamJpaDoubleDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
