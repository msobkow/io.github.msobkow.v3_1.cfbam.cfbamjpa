// Description: Java 25 JPA implementation of Int16Def history objects
...
/**
 *  CFBamJpaInt16DefH provides history objects matching the CFBamInt16Def change history.
 */
@Entity
@Table(
    name = "int16def_h", schema = "CFBam31",
    indexes = {
        @Index(name = "Int16DefIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true)
    }
)
...
public class CFBamJpaInt16DefH extends CFBamJpaAtomH
    implements ICFBamInt16DefH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaInt16DefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
