// Description: Java 25 JPA implementation of a DbKeyHash256Type entity definition object.
...
@Entity
@Table(
	name = "dbk256typ", schema = "CFBam31",
	indexes = {
		@Index(name = "DbKeyHash256TypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "DbKeyHash256TypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaDbKeyHash256Type extends CFBamJpaDbKeyHash256Def
	implements ICFBamDbKeyHash256Type
{
	...
	public String toString() {
		String ret = "<CFBamJpaDbKeyHash256Type" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
