// Description: Java 25 JPA implementation of a UInt32Def entity definition object.
...
@Entity
@Table(
	name = "u32def", schema = "CFBam31",
	indexes = {
		@Index(name = "UInt32DefIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaUInt32Def extends CFBamJpaAtom
	implements ICFBamUInt32Def
{
	...
	public String toString() {
		String ret = "<CFBamJpaUInt32Def" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
