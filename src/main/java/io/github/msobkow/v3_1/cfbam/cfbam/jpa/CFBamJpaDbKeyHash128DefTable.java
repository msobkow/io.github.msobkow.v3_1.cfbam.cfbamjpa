...
public class CFBamJpaDbKeyHash128DefTable implements ICFBamDbKeyHash128DefTable
{
		...
		ICFBamDbKeyHash128Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash128Def created = dbkeyhash128defService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamDbKeyHash128Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash128Def jparec = (CFBamJpaDbKeyHash128Def)rec;
			CFBamJpaDbKeyHash128Def updated = dbkeyhash128defService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamDbKeyHash128Def rec )
	{
		...
		if (rec instanceof CFBamJpaDbKeyHash128Def) {
			CFBamJpaDbKeyHash128Def jparec = (CFBamJpaDbKeyHash128Def)rec;
			dbkeyhash128defService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		dbkeyhash128defService.deleteByIdIdx(argKey);
	}
	...
	public void deleteDbKeyHash128DefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		dbkeyhash128defService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		dbkeyhash128defService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash128DefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		dbkeyhash128defService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		dbkeyhash128defService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		dbkeyhash128defService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		dbkeyhash128defService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		dbkeyhash128defService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		dbkeyhash128defService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		dbkeyhash128defService.deleteByNextIdx(argNextId);
	}
	...
	{
		dbkeyhash128defService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteDbKeyHash128DefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		dbkeyhash128defService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		dbkeyhash128defService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash128DefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		dbkeyhash128defService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		dbkeyhash128defService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( dbkeyhash128defService.find(PKey) );
	}
	...
	public ICFBamDbKeyHash128Def lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( dbkeyhash128defService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamDbKeyHash128Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaDbKeyHash128Def> results = dbkeyhash128defService.findAll();
	...
	{
		return( dbkeyhash128defService.find(argId) );
	}
	...
	public ICFBamDbKeyHash128Def readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( dbkeyhash128defService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamDbKeyHash128Def[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaDbKeyHash128Def> results = dbkeyhash128defService.findByScopeIdx(argScopeId);
		ICFBamDbKeyHash128Def[] retset = new ICFBamDbKeyHash128Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash128Def[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaDbKeyHash128Def> results = dbkeyhash128defService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamDbKeyHash128Def[] retset = new ICFBamDbKeyHash128Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash128Def[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash128Def> results = dbkeyhash128defService.findByPrevIdx(argPrevId);
		ICFBamDbKeyHash128Def[] retset = new ICFBamDbKeyHash128Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash128Def[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash128Def> results = dbkeyhash128defService.findByNextIdx(argNextId);
		ICFBamDbKeyHash128Def[] retset = new ICFBamDbKeyHash128Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash128Def[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash128Def> results = dbkeyhash128defService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamDbKeyHash128Def[] retset = new ICFBamDbKeyHash128Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Def cur: results) {
	...
	public ICFBamDbKeyHash128Def[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash128Def> results = dbkeyhash128defService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamDbKeyHash128Def[] retset = new ICFBamDbKeyHash128Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Def cur: results) {
