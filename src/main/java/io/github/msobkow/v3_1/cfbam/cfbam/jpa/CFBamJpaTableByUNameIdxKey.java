// Description: Java 25 JPA implementation of a Table by UNameIdx index key object.
	...
	implements ICFBamTableByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTableByUNameIdxKey, ICFBamTable, ICFBamTableH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTableByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
