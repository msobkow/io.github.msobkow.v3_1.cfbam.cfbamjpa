...
// Description: Java 25 JPA Default Factory implementation for DbKeyHash512Def.
...
/*
 *	CFBamDbKeyHash512DefFactory JPA implementation for DbKeyHash512Def
 */
public class CFBamJpaDbKeyHash512DefDefaultFactory
    implements ICFBamDbKeyHash512DefFactory
{
    public CFBamJpaDbKeyHash512DefDefaultFactory() {
    }

    @Override
    public ICFBamDbKeyHash512Def newRec() {
        ICFBamDbKeyHash512Def rec =
            new CFBamJpaDbKeyHash512Def();
        return( rec );
    }
