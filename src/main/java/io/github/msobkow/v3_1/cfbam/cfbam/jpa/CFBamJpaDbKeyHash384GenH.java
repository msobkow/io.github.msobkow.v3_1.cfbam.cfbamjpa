// Description: Java 25 JPA implementation of DbKeyHash384Gen history objects
...
/**
 *  CFBamJpaDbKeyHash384GenH provides history objects matching the CFBamDbKeyHash384Gen change history.
 */
@Entity
@Table(
    name = "idgdbk384_h", schema = "CFBam31",
    indexes = {
        @Index(name = "DbKeyHash384GenIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true)
    }
)
...
public class CFBamJpaDbKeyHash384GenH extends CFBamJpaDbKeyHash384TypeH
    implements ICFBamDbKeyHash384GenH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaDbKeyHash384GenH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
