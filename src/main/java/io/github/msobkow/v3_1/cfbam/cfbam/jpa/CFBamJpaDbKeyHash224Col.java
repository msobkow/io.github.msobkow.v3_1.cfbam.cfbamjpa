// Description: Java 25 JPA implementation of a DbKeyHash224Col entity definition object.
...
@Entity
@Table(
	name = "dbk224col", schema = "CFBam31",
	indexes = {
		@Index(name = "DbKeyHash224ColIdIdx", columnList = "Id", unique = true),
		@Index(name = "DbKeyHash224ColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaDbKeyHash224Col extends CFBamJpaDbKeyHash224Def
	implements ICFBamDbKeyHash224Col
{
	...
	public CFBamJpaDbKeyHash224Col() {
		super();
	...
	public String toString() {
		String ret = "<CFBamJpaDbKeyHash224Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
