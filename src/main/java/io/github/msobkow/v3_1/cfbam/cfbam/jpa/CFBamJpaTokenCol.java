// Description: Java 25 JPA implementation of a TokenCol entity definition object.
...
@Entity
@Table(
	name = "tkncol", schema = "CFBam31",
	indexes = {
		@Index(name = "TokenColIdIdx", columnList = "Id", unique = true),
		@Index(name = "TokenColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaTokenCol extends CFBamJpaTokenDef
	implements ICFBamTokenCol
{
	...
	public String toString() {
		String ret = "<CFBamJpaTokenCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
