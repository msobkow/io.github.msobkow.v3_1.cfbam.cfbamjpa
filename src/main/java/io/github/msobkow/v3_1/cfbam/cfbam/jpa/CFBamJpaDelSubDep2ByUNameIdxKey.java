// Description: Java 25 JPA implementation of a DelSubDep2 by UNameIdx index key object.
...
public class CFBamJpaDelSubDep2ByUNameIdxKey
	implements ICFBamDelSubDep2ByUNameIdxKey, Comparable<Object>, Serializable
{
	...
	public CFBamJpaDelSubDep2ByUNameIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDelSubDep2ByUNameIdxKey, ICFBamDelSubDep2, ICFBamDelSubDep2H");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDelSubDep2ByUNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
