...
public class CFBamJpaDbKeyHash128TypeTable implements ICFBamDbKeyHash128TypeTable
{
		...
		ICFBamDbKeyHash128Type rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash128Type created = dbkeyhash128typeService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamDbKeyHash128Type rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash128Type jparec = (CFBamJpaDbKeyHash128Type)rec;
			CFBamJpaDbKeyHash128Type updated = dbkeyhash128typeService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamDbKeyHash128Type rec )
	{
		...
		if (rec instanceof CFBamJpaDbKeyHash128Type) {
			CFBamJpaDbKeyHash128Type jparec = (CFBamJpaDbKeyHash128Type)rec;
			dbkeyhash128typeService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		dbkeyhash128typeService.deleteBySchemaIdx(argSchemaDefId);
	}
	...
	{
		dbkeyhash128typeService.deleteBySchemaIdx(argKey.getRequiredSchemaDefId());
	}
	...
	{
		dbkeyhash128typeService.deleteByIdIdx(argKey);
	}
	...
	public void deleteDbKeyHash128TypeByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		dbkeyhash128typeService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		dbkeyhash128typeService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash128TypeByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		dbkeyhash128typeService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		dbkeyhash128typeService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		dbkeyhash128typeService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		dbkeyhash128typeService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		dbkeyhash128typeService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		dbkeyhash128typeService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		dbkeyhash128typeService.deleteByNextIdx(argNextId);
	}
	...
	{
		dbkeyhash128typeService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteDbKeyHash128TypeByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		dbkeyhash128typeService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		dbkeyhash128typeService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash128TypeByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		dbkeyhash128typeService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		dbkeyhash128typeService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( dbkeyhash128typeService.find(PKey) );
	}
	...
	public ICFBamDbKeyHash128Type lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( dbkeyhash128typeService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamDbKeyHash128Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaDbKeyHash128Type> results = dbkeyhash128typeService.findAll();
	...
	{
		return( dbkeyhash128typeService.find(argId) );
	}
	...
	public ICFBamDbKeyHash128Type readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( dbkeyhash128typeService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamDbKeyHash128Type[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaDbKeyHash128Type> results = dbkeyhash128typeService.findByScopeIdx(argScopeId);
		ICFBamDbKeyHash128Type[] retset = new ICFBamDbKeyHash128Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash128Type[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaDbKeyHash128Type> results = dbkeyhash128typeService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamDbKeyHash128Type[] retset = new ICFBamDbKeyHash128Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash128Type[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash128Type> results = dbkeyhash128typeService.findByPrevIdx(argPrevId);
		ICFBamDbKeyHash128Type[] retset = new ICFBamDbKeyHash128Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash128Type[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash128Type> results = dbkeyhash128typeService.findByNextIdx(argNextId);
		ICFBamDbKeyHash128Type[] retset = new ICFBamDbKeyHash128Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash128Type[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash128Type> results = dbkeyhash128typeService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamDbKeyHash128Type[] retset = new ICFBamDbKeyHash128Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Type cur: results) {
	...
	public ICFBamDbKeyHash128Type[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash128Type> results = dbkeyhash128typeService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamDbKeyHash128Type[] retset = new ICFBamDbKeyHash128Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Type cur: results) {
	...
	public ICFBamDbKeyHash128Type[] readDerivedBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argSchemaDefId )
	{
		List<CFBamJpaDbKeyHash128Type> results = dbkeyhash128typeService.findBySchemaIdx(argSchemaDefId);
		ICFBamDbKeyHash128Type[] retset = new ICFBamDbKeyHash128Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash128Type cur: results) {
			retset[idx++] = cur;
