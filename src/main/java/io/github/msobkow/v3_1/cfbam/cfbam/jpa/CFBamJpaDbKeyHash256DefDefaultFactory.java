...
// Description: Java 25 JPA Default Factory implementation for DbKeyHash256Def.
...
/*
 *	CFBamDbKeyHash256DefFactory JPA implementation for DbKeyHash256Def
 */
public class CFBamJpaDbKeyHash256DefDefaultFactory
    implements ICFBamDbKeyHash256DefFactory
{
    public CFBamJpaDbKeyHash256DefDefaultFactory() {
    }

    @Override
    public ICFBamDbKeyHash256Def newRec() {
        ICFBamDbKeyHash256Def rec =
            new CFBamJpaDbKeyHash256Def();
        return( rec );
    }
	...
	public CFBamJpaDbKeyHash256Def ensureRec(ICFBamDbKeyHash256Def rec) {
		if( rec == null ) {
			...
			return( (CFBamJpaDbKeyHash256Def)rec );
		}
		else {
	...
	public CFBamJpaDbKeyHash256DefH ensureHRec(ICFBamDbKeyHash256DefH hrec) {
		...
		else if( hrec instanceof CFBamJpaDbKeyHash256DefH) {
			return( (CFBamJpaDbKeyHash256DefH)hrec );
		}
		else {
