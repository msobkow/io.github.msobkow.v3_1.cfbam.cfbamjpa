// Description: Java 25 Spring JPA Service for Int16Type
...
/**
 *	Service for the CFBamInt16Type entities defined in io.github.msobkow.v3_1.cfbam.cfbam.jpa
 *	using the CFBamInt16TypeRepository to access them.
 */
@Service("cfbam31JpaInt16TypeService")
public class CFBamJpaInt16TypeService {
	...
	@Autowired
	private CFBamJpaInt16TypeRepository cfbam31Int16TypeRepository;

	/**
	 *	Create an entity, generating any database keys required along the way.
	 *
	 *		@param	data	The entity to be instantiated; must be a specific instance of CFBamJpaInt16Type, not a subclass.
	 *
	...
	public CFBamJpaInt16Type create(CFBamJpaInt16Type data) {
		...
		try {
			...
			if(data.getPKey() != null && cfbam31Int16TypeRepository.existsById((CFLibDbKeyHash256)data.getPKey())) {
				return( (CFBamJpaInt16Type)(cfbam31Int16TypeRepository.findById((CFLibDbKeyHash256)(data.getPKey())).get()));
			}
			return cfbam31Int16TypeRepository.save(data);
		}
		catch(Exception ex) {
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED,rollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt16Type update(CFBamJpaInt16Type data) {
		...
		CFBamJpaInt16Type existing = cfbam31Int16TypeRepository.findById((CFLibDbKeyHash256)(data.getPKey()))
		...
		return cfbam31Int16TypeRepository.save(existing);
	}
	...
	public CFBamJpaInt16Type find(@Param("id") CFLibDbKeyHash256 requiredId) {
		return( cfbam31Int16TypeRepository.get(requiredId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findAll() {
		return( cfbam31Int16TypeRepository.findAll() );
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt16Type findByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName) {
		return( cfbam31Int16TypeRepository.findByUNameIdx(requiredScopeId,
			requiredName));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt16Type findByUNameIdx(ICFBamValueByUNameIdxKey key) {
		return( cfbam31Int16TypeRepository.findByUNameIdx(key.getRequiredScopeId(), key.getRequiredName()));
	}
	 ...
	 *		@param requiredScopeId
	 *
	 *		@return List&lt;CFBamJpaInt16Type&gt; of the found entities, or an empty list if no such entities exist.
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId) {
		return( cfbam31Int16TypeRepository.findByScopeIdx(requiredScopeId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findByScopeIdx(ICFBamValueByScopeIdxKey key) {
		return( cfbam31Int16TypeRepository.findByScopeIdx(key.getRequiredScopeId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId) {
		return( cfbam31Int16TypeRepository.findByDefSchemaIdx(optionalDefSchemaId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
		return( cfbam31Int16TypeRepository.findByDefSchemaIdx(key.getOptionalDefSchemaId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Int16TypeRepository.findByPrevIdx(optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findByPrevIdx(ICFBamValueByPrevIdxKey key) {
		return( cfbam31Int16TypeRepository.findByPrevIdx(key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Int16TypeRepository.findByNextIdx(optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findByNextIdx(ICFBamValueByNextIdxKey key) {
		return( cfbam31Int16TypeRepository.findByNextIdx(key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Int16TypeRepository.findByContPrevIdx(requiredScopeId,
			optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
		return( cfbam31Int16TypeRepository.findByContPrevIdx(key.getRequiredScopeId(), key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Int16TypeRepository.findByContNextIdx(requiredScopeId,
			optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findByContNextIdx(ICFBamValueByContNextIdxKey key) {
		return( cfbam31Int16TypeRepository.findByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findBySchemaIdx(@Param("schemaDefId") CFLibDbKeyHash256 requiredSchemaDefId) {
		return( cfbam31Int16TypeRepository.findBySchemaIdx(requiredSchemaDefId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> findBySchemaIdx(ICFBamInt16TypeBySchemaIdxKey key) {
		return( cfbam31Int16TypeRepository.findBySchemaIdx(key.getRequiredSchemaDefId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt16Type lockByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId) {
		return( cfbam31Int16TypeRepository.lockByIdIdx(requiredId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt16Type lockByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName) {
		return( cfbam31Int16TypeRepository.lockByUNameIdx(requiredScopeId,
			requiredName));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public CFBamJpaInt16Type lockByUNameIdx(ICFBamValueByUNameIdxKey key) {
		return( cfbam31Int16TypeRepository.lockByUNameIdx(key.getRequiredScopeId(), key.getRequiredName()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId) {
		return( cfbam31Int16TypeRepository.lockByScopeIdx(requiredScopeId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockByScopeIdx(ICFBamValueByScopeIdxKey key) {
		return( cfbam31Int16TypeRepository.lockByScopeIdx(key.getRequiredScopeId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId) {
		return( cfbam31Int16TypeRepository.lockByDefSchemaIdx(optionalDefSchemaId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
		return( cfbam31Int16TypeRepository.lockByDefSchemaIdx(key.getOptionalDefSchemaId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Int16TypeRepository.lockByPrevIdx(optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockByPrevIdx(ICFBamValueByPrevIdxKey key) {
		return( cfbam31Int16TypeRepository.lockByPrevIdx(key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Int16TypeRepository.lockByNextIdx(optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockByNextIdx(ICFBamValueByNextIdxKey key) {
		return( cfbam31Int16TypeRepository.lockByNextIdx(key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		return( cfbam31Int16TypeRepository.lockByContPrevIdx(requiredScopeId,
			optionalPrevId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
		return( cfbam31Int16TypeRepository.lockByContPrevIdx(key.getRequiredScopeId(), key.getOptionalPrevId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		return( cfbam31Int16TypeRepository.lockByContNextIdx(requiredScopeId,
			optionalNextId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockByContNextIdx(ICFBamValueByContNextIdxKey key) {
		return( cfbam31Int16TypeRepository.lockByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId()));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockBySchemaIdx(@Param("schemaDefId") CFLibDbKeyHash256 requiredSchemaDefId) {
		return( cfbam31Int16TypeRepository.lockBySchemaIdx(requiredSchemaDefId));
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED, noRollbackFor = NoResultException.class, transactionManager = "cfbam31TransactionManager")
	public List<CFBamJpaInt16Type> lockBySchemaIdx(ICFBamInt16TypeBySchemaIdxKey key) {
		return( cfbam31Int16TypeRepository.lockBySchemaIdx(key.getRequiredSchemaDefId()));
	}
	...
	public void deleteByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId) {
		cfbam31Int16TypeRepository.deleteByIdIdx(requiredId);
	}
	...
	public void deleteByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName) {
		cfbam31Int16TypeRepository.deleteByUNameIdx(requiredScopeId,
			requiredName);
	}
	...
	public void deleteByUNameIdx(ICFBamValueByUNameIdxKey key) {
		cfbam31Int16TypeRepository.deleteByUNameIdx(key.getRequiredScopeId(), key.getRequiredName());
	}
	...
	public void deleteByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId) {
		cfbam31Int16TypeRepository.deleteByScopeIdx(requiredScopeId);
	}
	...
	public void deleteByScopeIdx(ICFBamValueByScopeIdxKey key) {
		cfbam31Int16TypeRepository.deleteByScopeIdx(key.getRequiredScopeId());
	}
	...
	public void deleteByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId) {
		cfbam31Int16TypeRepository.deleteByDefSchemaIdx(optionalDefSchemaId);
	}
	...
	public void deleteByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
		cfbam31Int16TypeRepository.deleteByDefSchemaIdx(key.getOptionalDefSchemaId());
	}
	...
	public void deleteByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		cfbam31Int16TypeRepository.deleteByPrevIdx(optionalPrevId);
	}
	...
	public void deleteByPrevIdx(ICFBamValueByPrevIdxKey key) {
		cfbam31Int16TypeRepository.deleteByPrevIdx(key.getOptionalPrevId());
	}
	...
	public void deleteByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		cfbam31Int16TypeRepository.deleteByNextIdx(optionalNextId);
	}
	...
	public void deleteByNextIdx(ICFBamValueByNextIdxKey key) {
		cfbam31Int16TypeRepository.deleteByNextIdx(key.getOptionalNextId());
	}
	...
	public void deleteByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId) {
		cfbam31Int16TypeRepository.deleteByContPrevIdx(requiredScopeId,
			optionalPrevId);
	}
	...
	public void deleteByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
		cfbam31Int16TypeRepository.deleteByContPrevIdx(key.getRequiredScopeId(), key.getOptionalPrevId());
	}
	...
	public void deleteByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId) {
		cfbam31Int16TypeRepository.deleteByContNextIdx(requiredScopeId,
			optionalNextId);
	}
	...
	public void deleteByContNextIdx(ICFBamValueByContNextIdxKey key) {
		cfbam31Int16TypeRepository.deleteByContNextIdx(key.getRequiredScopeId(), key.getOptionalNextId());
	}
	...
	public void deleteBySchemaIdx(@Param("schemaDefId") CFLibDbKeyHash256 requiredSchemaDefId) {
		cfbam31Int16TypeRepository.deleteBySchemaIdx(requiredSchemaDefId);
	}
	...
	public void deleteBySchemaIdx(ICFBamInt16TypeBySchemaIdxKey key) {
		cfbam31Int16TypeRepository.deleteBySchemaIdx(key.getRequiredSchemaDefId());
	}
}
