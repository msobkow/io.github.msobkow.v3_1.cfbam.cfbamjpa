// Description: Java 25 JPA implementation of a DelTopDep by DelTopDepTblIdx index key object.
...
public class CFBamJpaDelTopDepByDelTopDepTblIdxKey
	implements ICFBamDelTopDepByDelTopDepTblIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	public CFBamJpaDelTopDepByDelTopDepTblIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDelTopDepByDelTopDepTblIdxKey, ICFBamDelTopDep, ICFBamDelTopDepH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDelTopDepByDelTopDepTblIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
