// Description: Java 25 JPA implementation of a NmTokenType entity definition object.
...
@Entity
@Table(
	name = "nmtkntyp", schema = "CFBam31",
	indexes = {
		@Index(name = "NmTokenTypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "NmTokenTypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaNmTokenType extends CFBamJpaNmTokenDef
	implements ICFBamNmTokenType
{
	...
	public String toString() {
		String ret = "<CFBamJpaNmTokenType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
