...
public class CFBamJpaUuidDefTable implements ICFBamUuidDefTable
{
		...
		ICFBamUuidDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaUuidDef created = uuiddefService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamUuidDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaUuidDef jparec = (CFBamJpaUuidDef)rec;
			CFBamJpaUuidDef updated = uuiddefService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamUuidDef rec )
	{
		...
		if (rec instanceof CFBamJpaUuidDef) {
			CFBamJpaUuidDef jparec = (CFBamJpaUuidDef)rec;
			uuiddefService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		uuiddefService.deleteByIdIdx(argKey);
	}
	...
	public void deleteUuidDefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		uuiddefService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		uuiddefService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteUuidDefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		uuiddefService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		uuiddefService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		uuiddefService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		uuiddefService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		uuiddefService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		uuiddefService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		uuiddefService.deleteByNextIdx(argNextId);
	}
	...
	{
		uuiddefService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteUuidDefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		uuiddefService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		uuiddefService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteUuidDefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		uuiddefService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		uuiddefService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( uuiddefService.find(PKey) );
	}
	...
	public ICFBamUuidDef lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( uuiddefService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamUuidDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaUuidDef> results = uuiddefService.findAll();
	...
	{
		return( uuiddefService.find(argId) );
	}
	...
	public ICFBamUuidDef readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( uuiddefService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamUuidDef[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaUuidDef> results = uuiddefService.findByScopeIdx(argScopeId);
		ICFBamUuidDef[] retset = new ICFBamUuidDef[results.size()];
		int idx = 0;
		for (CFBamJpaUuidDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUuidDef[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaUuidDef> results = uuiddefService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamUuidDef[] retset = new ICFBamUuidDef[results.size()];
		int idx = 0;
		for (CFBamJpaUuidDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUuidDef[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaUuidDef> results = uuiddefService.findByPrevIdx(argPrevId);
		ICFBamUuidDef[] retset = new ICFBamUuidDef[results.size()];
		int idx = 0;
		for (CFBamJpaUuidDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUuidDef[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaUuidDef> results = uuiddefService.findByNextIdx(argNextId);
		ICFBamUuidDef[] retset = new ICFBamUuidDef[results.size()];
		int idx = 0;
		for (CFBamJpaUuidDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUuidDef[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaUuidDef> results = uuiddefService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamUuidDef[] retset = new ICFBamUuidDef[results.size()];
		int idx = 0;
		for (CFBamJpaUuidDef cur: results) {
	...
	public ICFBamUuidDef[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaUuidDef> results = uuiddefService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamUuidDef[] retset = new ICFBamUuidDef[results.size()];
		int idx = 0;
		for (CFBamJpaUuidDef cur: results) {
