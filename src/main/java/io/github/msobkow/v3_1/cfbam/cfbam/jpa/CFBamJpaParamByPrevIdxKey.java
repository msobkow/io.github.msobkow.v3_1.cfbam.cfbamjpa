// Description: Java 25 JPA implementation of a Param by PrevIdx index key object.
	...
	implements ICFBamParamByPrevIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamParamByPrevIdxKey, ICFBamParam, ICFBamParamH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamParamByPrevIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
