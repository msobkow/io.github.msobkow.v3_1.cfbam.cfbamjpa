// Description: Java 25 JPA implementation of a DbKeyHash512Col entity definition object.
...
@Entity
@Table(
	name = "dbk512col", schema = "CFBam31",
	indexes = {
		@Index(name = "DbKeyHash512ColIdIdx", columnList = "Id", unique = true),
		@Index(name = "DbKeyHash512ColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaDbKeyHash512Col extends CFBamJpaDbKeyHash512Def
	implements ICFBamDbKeyHash512Col
{
	...
	public String toString() {
		String ret = "<CFBamJpaDbKeyHash512Col" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
