// Description: Java 25 JPA implementation of a TZDateType by SchemaIdx index key object.
...
public class CFBamJpaTZDateTypeBySchemaIdxKey
	implements ICFBamTZDateTypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaTZDateTypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTZDateTypeBySchemaIdxKey, ICFBamTZDateType, ICFBamTZDateTypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTZDateTypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
