// Description: Java 25 JPA implementation of a ServerProc entity definition object.
...
@Entity
@Table(
	name = "srvprc", schema = "CFBam31",
	indexes = {
		@Index(name = "ServerProcIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaServerProc extends CFBamJpaServerMethod
	implements ICFBamServerProc
{
	...
	public String toString() {
		String ret = "<CFBamJpaServerProc" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
