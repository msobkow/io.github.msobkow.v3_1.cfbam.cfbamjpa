...
// Description: Java 25 JPA Default Factory implementation for UInt16Def.
...
/*
 *	CFBamUInt16DefFactory JPA implementation for UInt16Def
 */
public class CFBamJpaUInt16DefDefaultFactory
    implements ICFBamUInt16DefFactory
{
    public CFBamJpaUInt16DefDefaultFactory() {
    }

    @Override
    public ICFBamUInt16Def newRec() {
        ICFBamUInt16Def rec =
            new CFBamJpaUInt16Def();
        return( rec );
    }
