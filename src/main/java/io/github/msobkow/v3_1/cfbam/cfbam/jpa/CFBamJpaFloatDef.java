// Description: Java 25 JPA implementation of a FloatDef entity definition object.
...
@Entity
@Table(
	name = "fltdef", schema = "CFBam31",
	indexes = {
		@Index(name = "FloatDefIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaFloatDef extends CFBamJpaAtom
	implements ICFBamFloatDef
{
	...
	public String toString() {
		String ret = "<CFBamJpaFloatDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
