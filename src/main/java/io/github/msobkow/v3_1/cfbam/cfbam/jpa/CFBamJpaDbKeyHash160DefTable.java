...
public class CFBamJpaDbKeyHash160DefTable implements ICFBamDbKeyHash160DefTable
{
		...
		ICFBamDbKeyHash160Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash160Def created = dbkeyhash160defService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamDbKeyHash160Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash160Def jparec = (CFBamJpaDbKeyHash160Def)rec;
			CFBamJpaDbKeyHash160Def updated = dbkeyhash160defService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamDbKeyHash160Def rec )
	{
		...
		if (rec instanceof CFBamJpaDbKeyHash160Def) {
			CFBamJpaDbKeyHash160Def jparec = (CFBamJpaDbKeyHash160Def)rec;
			dbkeyhash160defService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		dbkeyhash160defService.deleteByIdIdx(argKey);
	}
	...
	public void deleteDbKeyHash160DefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		dbkeyhash160defService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		dbkeyhash160defService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash160DefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		dbkeyhash160defService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		dbkeyhash160defService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		dbkeyhash160defService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		dbkeyhash160defService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		dbkeyhash160defService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		dbkeyhash160defService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		dbkeyhash160defService.deleteByNextIdx(argNextId);
	}
	...
	{
		dbkeyhash160defService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteDbKeyHash160DefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		dbkeyhash160defService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		dbkeyhash160defService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash160DefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		dbkeyhash160defService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		dbkeyhash160defService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( dbkeyhash160defService.find(PKey) );
	}
	...
	public ICFBamDbKeyHash160Def lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( dbkeyhash160defService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamDbKeyHash160Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaDbKeyHash160Def> results = dbkeyhash160defService.findAll();
	...
	{
		return( dbkeyhash160defService.find(argId) );
	}
	...
	public ICFBamDbKeyHash160Def readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( dbkeyhash160defService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamDbKeyHash160Def[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaDbKeyHash160Def> results = dbkeyhash160defService.findByScopeIdx(argScopeId);
		ICFBamDbKeyHash160Def[] retset = new ICFBamDbKeyHash160Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash160Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash160Def[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaDbKeyHash160Def> results = dbkeyhash160defService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamDbKeyHash160Def[] retset = new ICFBamDbKeyHash160Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash160Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash160Def[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash160Def> results = dbkeyhash160defService.findByPrevIdx(argPrevId);
		ICFBamDbKeyHash160Def[] retset = new ICFBamDbKeyHash160Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash160Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash160Def[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash160Def> results = dbkeyhash160defService.findByNextIdx(argNextId);
		ICFBamDbKeyHash160Def[] retset = new ICFBamDbKeyHash160Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash160Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash160Def[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash160Def> results = dbkeyhash160defService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamDbKeyHash160Def[] retset = new ICFBamDbKeyHash160Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash160Def cur: results) {
	...
	public ICFBamDbKeyHash160Def[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash160Def> results = dbkeyhash160defService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamDbKeyHash160Def[] retset = new ICFBamDbKeyHash160Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash160Def cur: results) {
