...
public class CFBamJpaUuid6DefTable implements ICFBamUuid6DefTable
{
		...
		ICFBamUuid6Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaUuid6Def created = uuid6defService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamUuid6Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaUuid6Def jparec = (CFBamJpaUuid6Def)rec;
			CFBamJpaUuid6Def updated = uuid6defService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamUuid6Def rec )
	{
		...
		if (rec instanceof CFBamJpaUuid6Def) {
			CFBamJpaUuid6Def jparec = (CFBamJpaUuid6Def)rec;
			uuid6defService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		uuid6defService.deleteByIdIdx(argKey);
	}
	...
	public void deleteUuid6DefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		uuid6defService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		uuid6defService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteUuid6DefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		uuid6defService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		uuid6defService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		uuid6defService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		uuid6defService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		uuid6defService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		uuid6defService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		uuid6defService.deleteByNextIdx(argNextId);
	}
	...
	{
		uuid6defService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteUuid6DefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		uuid6defService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		uuid6defService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteUuid6DefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		uuid6defService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		uuid6defService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( uuid6defService.find(PKey) );
	}
	...
	public ICFBamUuid6Def lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( uuid6defService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamUuid6Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaUuid6Def> results = uuid6defService.findAll();
	...
	{
		return( uuid6defService.find(argId) );
	}
	...
	public ICFBamUuid6Def readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( uuid6defService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamUuid6Def[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaUuid6Def> results = uuid6defService.findByScopeIdx(argScopeId);
		ICFBamUuid6Def[] retset = new ICFBamUuid6Def[results.size()];
		int idx = 0;
		for (CFBamJpaUuid6Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUuid6Def[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaUuid6Def> results = uuid6defService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamUuid6Def[] retset = new ICFBamUuid6Def[results.size()];
		int idx = 0;
		for (CFBamJpaUuid6Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUuid6Def[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaUuid6Def> results = uuid6defService.findByPrevIdx(argPrevId);
		ICFBamUuid6Def[] retset = new ICFBamUuid6Def[results.size()];
		int idx = 0;
		for (CFBamJpaUuid6Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUuid6Def[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaUuid6Def> results = uuid6defService.findByNextIdx(argNextId);
		ICFBamUuid6Def[] retset = new ICFBamUuid6Def[results.size()];
		int idx = 0;
		for (CFBamJpaUuid6Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUuid6Def[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaUuid6Def> results = uuid6defService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamUuid6Def[] retset = new ICFBamUuid6Def[results.size()];
		int idx = 0;
		for (CFBamJpaUuid6Def cur: results) {
	...
	public ICFBamUuid6Def[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaUuid6Def> results = uuid6defService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamUuid6Def[] retset = new ICFBamUuid6Def[results.size()];
		int idx = 0;
		for (CFBamJpaUuid6Def cur: results) {
