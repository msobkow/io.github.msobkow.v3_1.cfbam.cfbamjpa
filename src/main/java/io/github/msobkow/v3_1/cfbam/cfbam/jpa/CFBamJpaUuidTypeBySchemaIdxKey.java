// Description: Java 25 JPA implementation of a UuidType by SchemaIdx index key object.
...
public class CFBamJpaUuidTypeBySchemaIdxKey
	implements ICFBamUuidTypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaUuidTypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamUuidTypeBySchemaIdxKey, ICFBamUuidType, ICFBamUuidTypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamUuidTypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
