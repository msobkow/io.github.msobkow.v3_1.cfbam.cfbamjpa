// Description: Java 25 JPA implementation of a Param by ContNextIdx index key object.
...
public class CFBamJpaParamByContNextIdxKey
	implements ICFBamParamByContNextIdxKey, Comparable<Object>, Serializable
{
	...
	public CFBamJpaParamByContNextIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamParamByContNextIdxKey, ICFBamParam, ICFBamParamH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamParamByContNextIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
