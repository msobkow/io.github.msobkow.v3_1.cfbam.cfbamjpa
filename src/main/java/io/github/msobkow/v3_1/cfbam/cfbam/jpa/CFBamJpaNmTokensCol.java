// Description: Java 25 JPA implementation of a NmTokensCol entity definition object.
...
@Entity
@Table(
	name = "nmtknscol", schema = "CFBam31",
	indexes = {
		@Index(name = "NmTokensColIdIdx", columnList = "Id", unique = true),
		@Index(name = "NmTokensColTableIdx", columnList = "TableId", unique = false)
	}
)
...
public class CFBamJpaNmTokensCol extends CFBamJpaNmTokensDef
	implements ICFBamNmTokensCol
{
	...
	public String toString() {
		String ret = "<CFBamJpaNmTokensCol" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
