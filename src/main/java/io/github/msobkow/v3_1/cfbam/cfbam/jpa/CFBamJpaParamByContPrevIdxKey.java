// Description: Java 25 JPA implementation of a Param by ContPrevIdx index key object.
...
public class CFBamJpaParamByContPrevIdxKey
	implements ICFBamParamByContPrevIdxKey, Comparable<Object>, Serializable
{
	...
	public String toString() {
		String ret = "<CFBamParamByContPrevIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
