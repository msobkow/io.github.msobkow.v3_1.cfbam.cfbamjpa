// Description: Java 25 JPA implementation of a IndexCol by DefSchemaIdx index key object.
...
public class CFBamJpaIndexColByDefSchemaIdxKey
	implements ICFBamIndexColByDefSchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalDefSchemaId;
	public CFBamJpaIndexColByDefSchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamIndexColByDefSchemaIdxKey, ICFBamIndexCol, ICFBamIndexColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamIndexColByDefSchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
