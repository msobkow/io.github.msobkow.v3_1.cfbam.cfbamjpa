...
// Description: Java 25 JPA Default Factory implementation for NmTokenDef.
...
/*
 *	CFBamNmTokenDefFactory JPA implementation for NmTokenDef
 */
public class CFBamJpaNmTokenDefDefaultFactory
    implements ICFBamNmTokenDefFactory
{
    public CFBamJpaNmTokenDefDefaultFactory() {
    }

    @Override
    public ICFBamNmTokenDef newRec() {
        ICFBamNmTokenDef rec =
            new CFBamJpaNmTokenDef();
        return( rec );
    }
	...
	public CFBamJpaNmTokenDefH ensureHRec(ICFBamNmTokenDefH hrec) {
		...
		else if( hrec instanceof CFBamJpaNmTokenDefH) {
			return( (CFBamJpaNmTokenDefH)hrec );
		}
		else {
