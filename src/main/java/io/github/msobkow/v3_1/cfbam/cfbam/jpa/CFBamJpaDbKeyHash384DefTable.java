...
public class CFBamJpaDbKeyHash384DefTable implements ICFBamDbKeyHash384DefTable
{
		...
		ICFBamDbKeyHash384Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash384Def created = dbkeyhash384defService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamDbKeyHash384Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash384Def jparec = (CFBamJpaDbKeyHash384Def)rec;
			CFBamJpaDbKeyHash384Def updated = dbkeyhash384defService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamDbKeyHash384Def rec )
	{
		...
		if (rec instanceof CFBamJpaDbKeyHash384Def) {
			CFBamJpaDbKeyHash384Def jparec = (CFBamJpaDbKeyHash384Def)rec;
			dbkeyhash384defService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		dbkeyhash384defService.deleteByIdIdx(argKey);
	}
	...
	public void deleteDbKeyHash384DefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		dbkeyhash384defService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		dbkeyhash384defService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash384DefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		dbkeyhash384defService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		dbkeyhash384defService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		dbkeyhash384defService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		dbkeyhash384defService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		dbkeyhash384defService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		dbkeyhash384defService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		dbkeyhash384defService.deleteByNextIdx(argNextId);
	}
	...
	{
		dbkeyhash384defService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteDbKeyHash384DefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		dbkeyhash384defService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		dbkeyhash384defService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash384DefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		dbkeyhash384defService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		dbkeyhash384defService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( dbkeyhash384defService.find(PKey) );
	}
	...
	public ICFBamDbKeyHash384Def lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( dbkeyhash384defService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamDbKeyHash384Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaDbKeyHash384Def> results = dbkeyhash384defService.findAll();
	...
	{
		return( dbkeyhash384defService.find(argId) );
	}
	...
	public ICFBamDbKeyHash384Def readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( dbkeyhash384defService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamDbKeyHash384Def[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaDbKeyHash384Def> results = dbkeyhash384defService.findByScopeIdx(argScopeId);
		ICFBamDbKeyHash384Def[] retset = new ICFBamDbKeyHash384Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash384Def[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaDbKeyHash384Def> results = dbkeyhash384defService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamDbKeyHash384Def[] retset = new ICFBamDbKeyHash384Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash384Def[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash384Def> results = dbkeyhash384defService.findByPrevIdx(argPrevId);
		ICFBamDbKeyHash384Def[] retset = new ICFBamDbKeyHash384Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash384Def[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash384Def> results = dbkeyhash384defService.findByNextIdx(argNextId);
		ICFBamDbKeyHash384Def[] retset = new ICFBamDbKeyHash384Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash384Def[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash384Def> results = dbkeyhash384defService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamDbKeyHash384Def[] retset = new ICFBamDbKeyHash384Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Def cur: results) {
	...
	public ICFBamDbKeyHash384Def[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash384Def> results = dbkeyhash384defService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamDbKeyHash384Def[] retset = new ICFBamDbKeyHash384Def[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash384Def cur: results) {
