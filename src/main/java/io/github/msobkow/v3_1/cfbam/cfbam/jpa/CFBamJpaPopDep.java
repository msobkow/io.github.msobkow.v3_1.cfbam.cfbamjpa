// Description: Java 25 JPA implementation of a PopDep entity definition object.
...
@Entity
@Table(
	name = "pop_dep", schema = "CFBam31",
	indexes = {
		@Index(name = "PopDepIdIdx", columnList = "Id", unique = true),
		@Index(name = "PopDepRelationIdx", columnList = "RelationId", unique = false),
		@Index(name = "PopDepDefSchemaDefIdx", columnList = "defschid", unique = false)
	}
)
...
public class CFBamJpaPopDep extends CFBamJpaScope
	implements ICFBamPopDep
{
	...
	public String toString() {
		String ret = "<CFBamJpaPopDep" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
