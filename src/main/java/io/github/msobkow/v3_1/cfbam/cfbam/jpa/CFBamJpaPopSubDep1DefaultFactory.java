...
// Description: Java 25 JPA Default Factory implementation for PopSubDep1.
...
/*
 *	CFBamPopSubDep1Factory JPA implementation for PopSubDep1
 */
public class CFBamJpaPopSubDep1DefaultFactory
    implements ICFBamPopSubDep1Factory
{
    public CFBamJpaPopSubDep1DefaultFactory() {
    }

    @Override
    public ICFBamPopSubDep1ByPopTopDepIdxKey newByPopTopDepIdxKey() {
	ICFBamPopSubDep1ByPopTopDepIdxKey key =
            new CFBamJpaPopSubDep1ByPopTopDepIdxKey();
	return( key );
    }
