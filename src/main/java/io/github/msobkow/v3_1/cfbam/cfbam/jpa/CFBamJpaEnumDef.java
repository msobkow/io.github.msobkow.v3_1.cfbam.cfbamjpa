// Description: Java 25 JPA implementation of a EnumDef entity definition object.
...
@Entity
@Table(
	name = "enumdef", schema = "CFBam31",
	indexes = {
		@Index(name = "EnumDefIdIdx", columnList = "Id", unique = true)
	}
)
	...
	implements ICFBamEnumDef
{
	...
	public String toString() {
		String ret = "<CFBamJpaEnumDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
