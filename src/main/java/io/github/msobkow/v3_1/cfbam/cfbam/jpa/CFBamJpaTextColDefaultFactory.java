...
// Description: Java 25 JPA Default Factory implementation for TextCol.
...
/*
 *	CFBamTextColFactory JPA implementation for TextCol
 */
public class CFBamJpaTextColDefaultFactory
    implements ICFBamTextColFactory
{
    public CFBamJpaTextColDefaultFactory() {
    }

    @Override
    public ICFBamTextColByTableIdxKey newByTableIdxKey() {
	ICFBamTextColByTableIdxKey key =
            new CFBamJpaTextColByTableIdxKey();
	return( key );
    }
