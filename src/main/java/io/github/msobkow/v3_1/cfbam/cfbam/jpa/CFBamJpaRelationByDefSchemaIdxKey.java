// Description: Java 25 JPA implementation of a Relation by DefSchemaIdx index key object.
...
public class CFBamJpaRelationByDefSchemaIdxKey
	implements ICFBamRelationByDefSchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalDefSchemaId;
	public CFBamJpaRelationByDefSchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamRelationByDefSchemaIdxKey, ICFBamRelation, ICFBamRelationH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamRelationByDefSchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
