// Description: Java 25 JPA implementation of UuidCol history objects
...
/**
 *  CFBamJpaUuidColH provides history objects matching the CFBamUuidCol change history.
 */
@Entity
@Table(
    name = "uuidcol_h", schema = "CFBam31",
    indexes = {
        @Index(name = "UuidColIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "UuidColTableIdx_h", columnList = "TableId", unique = false)
    }
)
...
public class CFBamJpaUuidColH extends CFBamJpaUuidDefH
    implements ICFBamUuidColH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaUuidColH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
