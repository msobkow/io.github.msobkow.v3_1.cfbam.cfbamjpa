// Description: Java 25 JPA implementation of ServerListFunc history objects
...
/**
 *  CFBamJpaServerListFuncH provides history objects matching the CFBamServerListFunc change history.
 */
@Entity
@Table(
    name = "srvlfunc_h", schema = "CFBam31",
    indexes = {
        @Index(name = "ServerListFuncIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "ServerListFuncRetTableIdx_h", columnList = "rettblid", unique = false)
    }
)
...
public class CFBamJpaServerListFuncH extends CFBamJpaServerMethodH
    implements ICFBamServerListFuncH
{
    ...
    public void set( ICFBamScope src ) {
		if( src instanceof ICFBamServerListFunc ) {
			setServerListFunc( (ICFBamServerListFunc)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamJpaServerListFuncH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
