// Description: Java 25 JPA implementation of ServerObjFunc history objects
...
/**
 *  CFBamJpaServerObjFuncH provides history objects matching the CFBamServerObjFunc change history.
 */
@Entity
@Table(
    name = "srvofunc_h", schema = "CFBam31",
    indexes = {
        @Index(name = "ServerObjFuncIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "ServerObjFuncRetTableIdx_h", columnList = "rettblid", unique = false)
    }
)
...
public class CFBamJpaServerObjFuncH extends CFBamJpaServerMethodH
    implements ICFBamServerObjFuncH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaServerObjFuncH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
