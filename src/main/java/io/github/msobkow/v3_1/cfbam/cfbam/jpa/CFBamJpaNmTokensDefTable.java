...
public class CFBamJpaNmTokensDefTable implements ICFBamNmTokensDefTable
{
		...
		ICFBamNmTokensDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaNmTokensDef created = nmtokensdefService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamNmTokensDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaNmTokensDef jparec = (CFBamJpaNmTokensDef)rec;
			CFBamJpaNmTokensDef updated = nmtokensdefService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamNmTokensDef rec )
	{
		...
		if (rec instanceof CFBamJpaNmTokensDef) {
			CFBamJpaNmTokensDef jparec = (CFBamJpaNmTokensDef)rec;
			nmtokensdefService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		nmtokensdefService.deleteByIdIdx(argKey);
	}
	...
	public void deleteNmTokensDefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		nmtokensdefService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		nmtokensdefService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteNmTokensDefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		nmtokensdefService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		nmtokensdefService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		nmtokensdefService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		nmtokensdefService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		nmtokensdefService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		nmtokensdefService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		nmtokensdefService.deleteByNextIdx(argNextId);
	}
	...
	{
		nmtokensdefService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteNmTokensDefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		nmtokensdefService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		nmtokensdefService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteNmTokensDefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		nmtokensdefService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		nmtokensdefService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( nmtokensdefService.find(PKey) );
	}
	...
	public ICFBamNmTokensDef lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( nmtokensdefService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamNmTokensDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaNmTokensDef> results = nmtokensdefService.findAll();
	...
	{
		return( nmtokensdefService.find(argId) );
	}
	...
	public ICFBamNmTokensDef readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( nmtokensdefService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamNmTokensDef[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaNmTokensDef> results = nmtokensdefService.findByScopeIdx(argScopeId);
		ICFBamNmTokensDef[] retset = new ICFBamNmTokensDef[results.size()];
		int idx = 0;
		for (CFBamJpaNmTokensDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNmTokensDef[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaNmTokensDef> results = nmtokensdefService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamNmTokensDef[] retset = new ICFBamNmTokensDef[results.size()];
		int idx = 0;
		for (CFBamJpaNmTokensDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNmTokensDef[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaNmTokensDef> results = nmtokensdefService.findByPrevIdx(argPrevId);
		ICFBamNmTokensDef[] retset = new ICFBamNmTokensDef[results.size()];
		int idx = 0;
		for (CFBamJpaNmTokensDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNmTokensDef[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaNmTokensDef> results = nmtokensdefService.findByNextIdx(argNextId);
		ICFBamNmTokensDef[] retset = new ICFBamNmTokensDef[results.size()];
		int idx = 0;
		for (CFBamJpaNmTokensDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNmTokensDef[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaNmTokensDef> results = nmtokensdefService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamNmTokensDef[] retset = new ICFBamNmTokensDef[results.size()];
		int idx = 0;
		for (CFBamJpaNmTokensDef cur: results) {
	...
	public ICFBamNmTokensDef[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaNmTokensDef> results = nmtokensdefService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamNmTokensDef[] retset = new ICFBamNmTokensDef[results.size()];
		int idx = 0;
		for (CFBamJpaNmTokensDef cur: results) {
