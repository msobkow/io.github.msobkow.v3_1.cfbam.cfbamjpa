...
public class CFBamJpaNumberDefTable implements ICFBamNumberDefTable
{
		...
		ICFBamNumberDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaNumberDef created = numberdefService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamNumberDef rec )
	{
		if (rec == null) {
			...
			CFBamJpaNumberDef jparec = (CFBamJpaNumberDef)rec;
			CFBamJpaNumberDef updated = numberdefService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamNumberDef rec )
	{
		...
		if (rec instanceof CFBamJpaNumberDef) {
			CFBamJpaNumberDef jparec = (CFBamJpaNumberDef)rec;
			numberdefService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		numberdefService.deleteByIdIdx(argKey);
	}
	...
	public void deleteNumberDefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		numberdefService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		numberdefService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteNumberDefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		numberdefService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		numberdefService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		numberdefService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		numberdefService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		numberdefService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		numberdefService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		numberdefService.deleteByNextIdx(argNextId);
	}
	...
	{
		numberdefService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteNumberDefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		numberdefService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		numberdefService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteNumberDefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		numberdefService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		numberdefService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( numberdefService.find(PKey) );
	}
	...
	public ICFBamNumberDef lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( numberdefService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamNumberDef[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaNumberDef> results = numberdefService.findAll();
	...
	{
		return( numberdefService.find(argId) );
	}
	...
	public ICFBamNumberDef readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( numberdefService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamNumberDef[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaNumberDef> results = numberdefService.findByScopeIdx(argScopeId);
		ICFBamNumberDef[] retset = new ICFBamNumberDef[results.size()];
		int idx = 0;
		for (CFBamJpaNumberDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNumberDef[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaNumberDef> results = numberdefService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamNumberDef[] retset = new ICFBamNumberDef[results.size()];
		int idx = 0;
		for (CFBamJpaNumberDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNumberDef[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaNumberDef> results = numberdefService.findByPrevIdx(argPrevId);
		ICFBamNumberDef[] retset = new ICFBamNumberDef[results.size()];
		int idx = 0;
		for (CFBamJpaNumberDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNumberDef[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaNumberDef> results = numberdefService.findByNextIdx(argNextId);
		ICFBamNumberDef[] retset = new ICFBamNumberDef[results.size()];
		int idx = 0;
		for (CFBamJpaNumberDef cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamNumberDef[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaNumberDef> results = numberdefService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamNumberDef[] retset = new ICFBamNumberDef[results.size()];
		int idx = 0;
		for (CFBamJpaNumberDef cur: results) {
	...
	public ICFBamNumberDef[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaNumberDef> results = numberdefService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamNumberDef[] retset = new ICFBamNumberDef[results.size()];
		int idx = 0;
		for (CFBamJpaNumberDef cur: results) {
