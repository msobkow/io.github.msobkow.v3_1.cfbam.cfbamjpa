// Description: Java 25 JPA implementation of a RelationCol by NextIdx index key object.
	...
	implements ICFBamRelationColByNextIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamRelationColByNextIdxKey, ICFBamRelationCol, ICFBamRelationColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamRelationColByNextIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
