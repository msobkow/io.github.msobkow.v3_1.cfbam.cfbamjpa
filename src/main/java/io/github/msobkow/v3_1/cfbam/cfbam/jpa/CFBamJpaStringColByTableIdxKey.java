// Description: Java 25 JPA implementation of a StringCol by TableIdx index key object.
...
public class CFBamJpaStringColByTableIdxKey
	implements ICFBamStringColByTableIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	public CFBamJpaStringColByTableIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamStringColByTableIdxKey, ICFBamStringCol, ICFBamStringColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamStringColByTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
