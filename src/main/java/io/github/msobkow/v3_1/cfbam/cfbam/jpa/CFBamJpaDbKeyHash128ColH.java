// Description: Java 25 JPA implementation of DbKeyHash128Col history objects
...
/**
 *  CFBamJpaDbKeyHash128ColH provides history objects matching the CFBamDbKeyHash128Col change history.
 */
@Entity
@Table(
    name = "dbk128col_h", schema = "CFBam31",
    indexes = {
        @Index(name = "DbKeyHash128ColIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "DbKeyHash128ColTableIdx_h", columnList = "TableId", unique = false)
    }
)
...
public class CFBamJpaDbKeyHash128ColH extends CFBamJpaDbKeyHash128DefH
    implements ICFBamDbKeyHash128ColH
{
    ...
    public CFBamJpaDbKeyHash128ColH() {
            super();
    ...
    public void set( ICFBamValue src ) {
		if( src instanceof ICFBamDbKeyHash128Col ) {
			setDbKeyHash128Col( (ICFBamDbKeyHash128Col)src );
		}
		else {
    ...
    public String toString() {
        String ret = "<CFBamJpaDbKeyHash128ColH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
