// Description: Java 25 JPA implementation of a Value by NextIdx index key object.
	...
	implements ICFBamValueByNextIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamValueByNextIdxKey, ICFBamValue, ICFBamValueH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamValueByNextIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
