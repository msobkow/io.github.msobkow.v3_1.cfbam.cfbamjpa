...
public class CFBamJpaTZTimestampTypeTable implements ICFBamTZTimestampTypeTable
{
		...
		ICFBamTZTimestampType rec )
	{
		if (rec == null) {
			...
			CFBamJpaTZTimestampType created = tztimestamptypeService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamTZTimestampType rec )
	{
		if (rec == null) {
			...
			CFBamJpaTZTimestampType jparec = (CFBamJpaTZTimestampType)rec;
			CFBamJpaTZTimestampType updated = tztimestamptypeService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamTZTimestampType rec )
	{
		...
		if (rec instanceof CFBamJpaTZTimestampType) {
			CFBamJpaTZTimestampType jparec = (CFBamJpaTZTimestampType)rec;
			tztimestamptypeService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		tztimestamptypeService.deleteBySchemaIdx(argSchemaDefId);
	}
	...
	{
		tztimestamptypeService.deleteBySchemaIdx(argKey.getRequiredSchemaDefId());
	}
	...
	{
		tztimestamptypeService.deleteByIdIdx(argKey);
	}
	...
	public void deleteTZTimestampTypeByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		tztimestamptypeService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		tztimestamptypeService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTZTimestampTypeByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		tztimestamptypeService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		tztimestamptypeService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		tztimestamptypeService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		tztimestamptypeService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		tztimestamptypeService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		tztimestamptypeService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		tztimestamptypeService.deleteByNextIdx(argNextId);
	}
	...
	{
		tztimestamptypeService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteTZTimestampTypeByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		tztimestamptypeService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		tztimestamptypeService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteTZTimestampTypeByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		tztimestamptypeService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		tztimestamptypeService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( tztimestamptypeService.find(PKey) );
	}
	...
	public ICFBamTZTimestampType lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( tztimestamptypeService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamTZTimestampType[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaTZTimestampType> results = tztimestamptypeService.findAll();
	...
	{
		return( tztimestamptypeService.find(argId) );
	}
	...
	public ICFBamTZTimestampType readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( tztimestamptypeService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamTZTimestampType[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaTZTimestampType> results = tztimestamptypeService.findByScopeIdx(argScopeId);
		ICFBamTZTimestampType[] retset = new ICFBamTZTimestampType[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimestampType cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTZTimestampType[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaTZTimestampType> results = tztimestamptypeService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamTZTimestampType[] retset = new ICFBamTZTimestampType[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimestampType cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTZTimestampType[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTZTimestampType> results = tztimestamptypeService.findByPrevIdx(argPrevId);
		ICFBamTZTimestampType[] retset = new ICFBamTZTimestampType[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimestampType cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTZTimestampType[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTZTimestampType> results = tztimestamptypeService.findByNextIdx(argNextId);
		ICFBamTZTimestampType[] retset = new ICFBamTZTimestampType[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimestampType cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamTZTimestampType[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaTZTimestampType> results = tztimestamptypeService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamTZTimestampType[] retset = new ICFBamTZTimestampType[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimestampType cur: results) {
	...
	public ICFBamTZTimestampType[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaTZTimestampType> results = tztimestamptypeService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamTZTimestampType[] retset = new ICFBamTZTimestampType[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimestampType cur: results) {
	...
	public ICFBamTZTimestampType[] readDerivedBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argSchemaDefId )
	{
		List<CFBamJpaTZTimestampType> results = tztimestamptypeService.findBySchemaIdx(argSchemaDefId);
		ICFBamTZTimestampType[] retset = new ICFBamTZTimestampType[results.size()];
		int idx = 0;
		for (CFBamJpaTZTimestampType cur: results) {
			retset[idx++] = cur;
