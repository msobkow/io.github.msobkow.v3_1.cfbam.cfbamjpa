// Description: Java 25 JPA implementation of a NumberCol by TableIdx index key object.
...
public class CFBamJpaNumberColByTableIdxKey
	implements ICFBamNumberColByTableIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamNumberColByTableIdxKey, ICFBamNumberCol, ICFBamNumberColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamNumberColByTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
