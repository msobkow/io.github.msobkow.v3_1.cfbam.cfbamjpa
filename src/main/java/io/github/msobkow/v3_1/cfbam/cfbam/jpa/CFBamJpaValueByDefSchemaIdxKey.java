// Description: Java 25 JPA implementation of a Value by DefSchemaIdx index key object.
...
public class CFBamJpaValueByDefSchemaIdxKey
	implements ICFBamValueByDefSchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalDefSchemaId;
	public CFBamJpaValueByDefSchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamValueByDefSchemaIdxKey, ICFBamValue, ICFBamValueH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamValueByDefSchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
