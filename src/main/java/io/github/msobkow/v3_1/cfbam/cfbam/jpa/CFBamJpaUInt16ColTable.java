...
public class CFBamJpaUInt16ColTable implements ICFBamUInt16ColTable
{
		...
		ICFBamUInt16Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaUInt16Col created = uint16colService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamUInt16Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaUInt16Col jparec = (CFBamJpaUInt16Col)rec;
			CFBamJpaUInt16Col updated = uint16colService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamUInt16Col rec )
	{
		...
		if (rec instanceof CFBamJpaUInt16Col) {
			CFBamJpaUInt16Col jparec = (CFBamJpaUInt16Col)rec;
			uint16colService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		uint16colService.deleteByTableIdx(argTableId);
	}
	...
	{
		uint16colService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		uint16colService.deleteByIdIdx(argKey);
	}
	...
	public void deleteUInt16ColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		uint16colService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		uint16colService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteUInt16ColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		uint16colService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		uint16colService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		uint16colService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		uint16colService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		uint16colService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		uint16colService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		uint16colService.deleteByNextIdx(argNextId);
	}
	...
	{
		uint16colService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteUInt16ColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		uint16colService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		uint16colService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteUInt16ColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		uint16colService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		uint16colService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( uint16colService.find(PKey) );
	}
	...
	public ICFBamUInt16Col lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( uint16colService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamUInt16Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaUInt16Col> results = uint16colService.findAll();
	...
	{
		return( uint16colService.find(argId) );
	}
	...
	public ICFBamUInt16Col readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( uint16colService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamUInt16Col[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaUInt16Col> results = uint16colService.findByScopeIdx(argScopeId);
		ICFBamUInt16Col[] retset = new ICFBamUInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt16Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt16Col[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaUInt16Col> results = uint16colService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamUInt16Col[] retset = new ICFBamUInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt16Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt16Col[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaUInt16Col> results = uint16colService.findByPrevIdx(argPrevId);
		ICFBamUInt16Col[] retset = new ICFBamUInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt16Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt16Col[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaUInt16Col> results = uint16colService.findByNextIdx(argNextId);
		ICFBamUInt16Col[] retset = new ICFBamUInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt16Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt16Col[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaUInt16Col> results = uint16colService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamUInt16Col[] retset = new ICFBamUInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt16Col cur: results) {
	...
	public ICFBamUInt16Col[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaUInt16Col> results = uint16colService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamUInt16Col[] retset = new ICFBamUInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt16Col cur: results) {
	...
	public ICFBamUInt16Col[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaUInt16Col> results = uint16colService.findByTableIdx(argTableId);
		ICFBamUInt16Col[] retset = new ICFBamUInt16Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt16Col cur: results) {
			retset[idx++] = cur;
