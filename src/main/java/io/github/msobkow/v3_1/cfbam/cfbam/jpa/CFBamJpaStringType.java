// Description: Java 25 JPA implementation of a StringType entity definition object.
...
@Entity
@Table(
	name = "strtyp", schema = "CFBam31",
	indexes = {
		@Index(name = "StringTypeIdIdx", columnList = "Id", unique = true),
		@Index(name = "StringTypeSchemaDefIdx", columnList = "SchemaDefId", unique = false)
	}
)
...
public class CFBamJpaStringType extends CFBamJpaStringDef
	implements ICFBamStringType
{
	...
	public String toString() {
		String ret = "<CFBamJpaStringType" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
