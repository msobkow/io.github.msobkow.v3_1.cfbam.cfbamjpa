// Description: Java 25 JPA implementation of a UuidCol by TableIdx index key object.
...
public class CFBamJpaUuidColByTableIdxKey
	implements ICFBamUuidColByTableIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	public CFBamJpaUuidColByTableIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamUuidColByTableIdxKey, ICFBamUuidCol, ICFBamUuidColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamUuidColByTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
