// Description: Java 25 Spring JPA Repository for BoolDef
...
/**
 *	JpaRepository for the CFBamJpaBoolDef entities defined in io.github.msobkow.v3_1.cfbam.cfbam.jpa.
 *	The manufactured repositories try to provide a rich, do-it-all interface to the JPA data store, with both object and argument-based implementations of the interface defined.
 */
@Transactional(readOnly = true)
public interface CFBamJpaBoolDefRepository extends JpaRepository<CFBamJpaBoolDef, CFLibDbKeyHash256> {
	...
	CFBamJpaBoolDef get(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	CFBamJpaBoolDef findByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity, typically from the JPA cache, or null if no such entity exists.
	 */
	default CFBamJpaBoolDef findByUNameIdx(ICFBamValueByUNameIdxKey key) {
	 ...
	 *		@param requiredScopeId
	 *
	 *		@return List&lt;CFBamJpaBoolDef&gt; of the found entities, typically from the JPA cache, or an empty list if no such entities exist.
	 */
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId")
	List<CFBamJpaBoolDef> findByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId);
	 ...
	 */
	default List<CFBamJpaBoolDef> findByScopeIdx(ICFBamValueByScopeIdxKey key) {
	...
	List<CFBamJpaBoolDef> findByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaBoolDef> findByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
	...
	List<CFBamJpaBoolDef> findByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaBoolDef> findByPrevIdx(ICFBamValueByPrevIdxKey key) {
	...
	List<CFBamJpaBoolDef> findByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaBoolDef> findByNextIdx(ICFBamValueByNextIdxKey key) {
	...
	List<CFBamJpaBoolDef> findByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaBoolDef> findByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
	...
	List<CFBamJpaBoolDef> findByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
	 ...
	 *		@return The found entity list, which may be empty, typically populated from the JPA cache.
	 */
	default List<CFBamJpaBoolDef> findByContNextIdx(ICFBamValueByContNextIdxKey key) {
	...
	@Query("select r from CFBamJpaValue r where r.requiredId = :id")
	CFBamJpaBoolDef lockByIdIdx(@Param("id") CFLibDbKeyHash256 requiredId);
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.requiredName = :name")
	CFBamJpaBoolDef lockByUNameIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("name") String requiredName);
	 ...
	 *		@return The locked entity, refreshed from the data store, or null if no such entity exists.
	 */
	default CFBamJpaBoolDef lockByUNameIdx(ICFBamValueByUNameIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId")
	List<CFBamJpaBoolDef> lockByScopeIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaBoolDef> lockByScopeIdx(ICFBamValueByScopeIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupDefSchema.requiredId = :defSchemaId")
	List<CFBamJpaBoolDef> lockByDefSchemaIdx(@Param("defSchemaId") CFLibDbKeyHash256 optionalDefSchemaId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaBoolDef> lockByDefSchemaIdx(ICFBamValueByDefSchemaIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaBoolDef> lockByPrevIdx(@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaBoolDef> lockByPrevIdx(ICFBamValueByPrevIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaBoolDef> lockByNextIdx(@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaBoolDef> lockByNextIdx(ICFBamValueByNextIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.optionalLookupPrev.requiredId = :prevId")
	List<CFBamJpaBoolDef> lockByContPrevIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("prevId") CFLibDbKeyHash256 optionalPrevId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaBoolDef> lockByContPrevIdx(ICFBamValueByContPrevIdxKey key) {
	...
	@Lock(LockModeType.WRITE)
	@Query("select r from CFBamJpaValue r where r.requiredScopeId = :scopeId and r.optionalLookupNext.requiredId = :nextId")
	List<CFBamJpaBoolDef> lockByContNextIdx(@Param("scopeId") CFLibDbKeyHash256 requiredScopeId,
		@Param("nextId") CFLibDbKeyHash256 optionalNextId);
	 ...
	 *		@return A list of locked entities, refreshed from the data store, or an empty list if no such entities exist.
	 */
	default List<CFBamJpaBoolDef> lockByContNextIdx(ICFBamValueByContNextIdxKey key) {
