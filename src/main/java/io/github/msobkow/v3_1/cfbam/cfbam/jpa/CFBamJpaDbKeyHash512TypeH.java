// Description: Java 25 JPA implementation of DbKeyHash512Type history objects
...
/**
 *  CFBamJpaDbKeyHash512TypeH provides history objects matching the CFBamDbKeyHash512Type change history.
 */
@Entity
@Table(
    name = "dbk512typ_h", schema = "CFBam31",
    indexes = {
        @Index(name = "DbKeyHash512TypeIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "DbKeyHash512TypeSchemaDefIdx_h", columnList = "SchemaDefId", unique = false)
    }
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43086")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaDbKeyHash512TypeH extends CFBamJpaDbKeyHash512DefH
    implements ICFBamDbKeyHash512TypeH
{
    ...
    public CFBamJpaDbKeyHash512TypeH() {
            super();
    ...
    public String toString() {
        String ret = "<CFBamJpaDbKeyHash512TypeH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
