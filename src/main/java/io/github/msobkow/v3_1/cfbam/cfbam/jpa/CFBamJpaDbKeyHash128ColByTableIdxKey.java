// Description: Java 25 JPA implementation of a DbKeyHash128Col by TableIdx index key object.
...
public class CFBamJpaDbKeyHash128ColByTableIdxKey
	implements ICFBamDbKeyHash128ColByTableIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	public CFBamJpaDbKeyHash128ColByTableIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamDbKeyHash128ColByTableIdxKey, ICFBamDbKeyHash128Col, ICFBamDbKeyHash128ColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamDbKeyHash128ColByTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
