...
public class CFBamJpaDbKeyHash224TypeTable implements ICFBamDbKeyHash224TypeTable
{
		...
		ICFBamDbKeyHash224Type rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash224Type created = dbkeyhash224typeService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamDbKeyHash224Type rec )
	{
		if (rec == null) {
			...
			CFBamJpaDbKeyHash224Type jparec = (CFBamJpaDbKeyHash224Type)rec;
			CFBamJpaDbKeyHash224Type updated = dbkeyhash224typeService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamDbKeyHash224Type rec )
	{
		...
		if (rec instanceof CFBamJpaDbKeyHash224Type) {
			CFBamJpaDbKeyHash224Type jparec = (CFBamJpaDbKeyHash224Type)rec;
			dbkeyhash224typeService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		dbkeyhash224typeService.deleteBySchemaIdx(argSchemaDefId);
	}
	...
	{
		dbkeyhash224typeService.deleteBySchemaIdx(argKey.getRequiredSchemaDefId());
	}
	...
	{
		dbkeyhash224typeService.deleteByIdIdx(argKey);
	}
	...
	public void deleteDbKeyHash224TypeByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		dbkeyhash224typeService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		dbkeyhash224typeService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash224TypeByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		dbkeyhash224typeService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		dbkeyhash224typeService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		dbkeyhash224typeService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		dbkeyhash224typeService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		dbkeyhash224typeService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		dbkeyhash224typeService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		dbkeyhash224typeService.deleteByNextIdx(argNextId);
	}
	...
	{
		dbkeyhash224typeService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteDbKeyHash224TypeByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		dbkeyhash224typeService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		dbkeyhash224typeService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteDbKeyHash224TypeByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		dbkeyhash224typeService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		dbkeyhash224typeService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( dbkeyhash224typeService.find(PKey) );
	}
	...
	public ICFBamDbKeyHash224Type lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( dbkeyhash224typeService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamDbKeyHash224Type[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaDbKeyHash224Type> results = dbkeyhash224typeService.findAll();
	...
	{
		return( dbkeyhash224typeService.find(argId) );
	}
	...
	public ICFBamDbKeyHash224Type readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( dbkeyhash224typeService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamDbKeyHash224Type[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaDbKeyHash224Type> results = dbkeyhash224typeService.findByScopeIdx(argScopeId);
		ICFBamDbKeyHash224Type[] retset = new ICFBamDbKeyHash224Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash224Type[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaDbKeyHash224Type> results = dbkeyhash224typeService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamDbKeyHash224Type[] retset = new ICFBamDbKeyHash224Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash224Type[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash224Type> results = dbkeyhash224typeService.findByPrevIdx(argPrevId);
		ICFBamDbKeyHash224Type[] retset = new ICFBamDbKeyHash224Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash224Type[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash224Type> results = dbkeyhash224typeService.findByNextIdx(argNextId);
		ICFBamDbKeyHash224Type[] retset = new ICFBamDbKeyHash224Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Type cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamDbKeyHash224Type[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaDbKeyHash224Type> results = dbkeyhash224typeService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamDbKeyHash224Type[] retset = new ICFBamDbKeyHash224Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Type cur: results) {
	...
	public ICFBamDbKeyHash224Type[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaDbKeyHash224Type> results = dbkeyhash224typeService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamDbKeyHash224Type[] retset = new ICFBamDbKeyHash224Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Type cur: results) {
	...
	public ICFBamDbKeyHash224Type[] readDerivedBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argSchemaDefId )
	{
		List<CFBamJpaDbKeyHash224Type> results = dbkeyhash224typeService.findBySchemaIdx(argSchemaDefId);
		ICFBamDbKeyHash224Type[] retset = new ICFBamDbKeyHash224Type[results.size()];
		int idx = 0;
		for (CFBamJpaDbKeyHash224Type cur: results) {
			retset[idx++] = cur;
