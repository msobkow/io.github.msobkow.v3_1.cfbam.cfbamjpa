...
public class CFBamJpaUInt32ColTable implements ICFBamUInt32ColTable
{
		...
		ICFBamUInt32Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaUInt32Col created = uint32colService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamUInt32Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaUInt32Col jparec = (CFBamJpaUInt32Col)rec;
			CFBamJpaUInt32Col updated = uint32colService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamUInt32Col rec )
	{
		...
		if (rec instanceof CFBamJpaUInt32Col) {
			CFBamJpaUInt32Col jparec = (CFBamJpaUInt32Col)rec;
			uint32colService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		uint32colService.deleteByTableIdx(argTableId);
	}
	...
	{
		uint32colService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		uint32colService.deleteByIdIdx(argKey);
	}
	...
	public void deleteUInt32ColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		uint32colService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		uint32colService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteUInt32ColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		uint32colService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		uint32colService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		uint32colService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		uint32colService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		uint32colService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		uint32colService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		uint32colService.deleteByNextIdx(argNextId);
	}
	...
	{
		uint32colService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteUInt32ColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		uint32colService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		uint32colService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteUInt32ColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		uint32colService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		uint32colService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( uint32colService.find(PKey) );
	}
	...
	public ICFBamUInt32Col lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( uint32colService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamUInt32Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaUInt32Col> results = uint32colService.findAll();
	...
	{
		return( uint32colService.find(argId) );
	}
	...
	public ICFBamUInt32Col readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( uint32colService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamUInt32Col[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaUInt32Col> results = uint32colService.findByScopeIdx(argScopeId);
		ICFBamUInt32Col[] retset = new ICFBamUInt32Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt32Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt32Col[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaUInt32Col> results = uint32colService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamUInt32Col[] retset = new ICFBamUInt32Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt32Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt32Col[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaUInt32Col> results = uint32colService.findByPrevIdx(argPrevId);
		ICFBamUInt32Col[] retset = new ICFBamUInt32Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt32Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt32Col[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaUInt32Col> results = uint32colService.findByNextIdx(argNextId);
		ICFBamUInt32Col[] retset = new ICFBamUInt32Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt32Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamUInt32Col[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaUInt32Col> results = uint32colService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamUInt32Col[] retset = new ICFBamUInt32Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt32Col cur: results) {
	...
	public ICFBamUInt32Col[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaUInt32Col> results = uint32colService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamUInt32Col[] retset = new ICFBamUInt32Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt32Col cur: results) {
	...
	public ICFBamUInt32Col[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaUInt32Col> results = uint32colService.findByTableIdx(argTableId);
		ICFBamUInt32Col[] retset = new ICFBamUInt32Col[results.size()];
		int idx = 0;
		for (CFBamJpaUInt32Col cur: results) {
			retset[idx++] = cur;
