...
// Description: Java 25 JPA Default Factory implementation for TZTimestampDef.
...
/*
 *	CFBamTZTimestampDefFactory JPA implementation for TZTimestampDef
 */
public class CFBamJpaTZTimestampDefDefaultFactory
    implements ICFBamTZTimestampDefFactory
{
    public CFBamJpaTZTimestampDefDefaultFactory() {
    }

    @Override
    public ICFBamTZTimestampDef newRec() {
        ICFBamTZTimestampDef rec =
            new CFBamJpaTZTimestampDef();
        return( rec );
    }
