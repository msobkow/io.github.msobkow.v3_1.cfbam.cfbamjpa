// Description: Java 25 JPA implementation of a PopDep by RelationIdx index key object.
...
public class CFBamJpaPopDepByRelationIdxKey
	implements ICFBamPopDepByRelationIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamPopDepByRelationIdxKey, ICFBamPopDep, ICFBamPopDepH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamPopDepByRelationIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
