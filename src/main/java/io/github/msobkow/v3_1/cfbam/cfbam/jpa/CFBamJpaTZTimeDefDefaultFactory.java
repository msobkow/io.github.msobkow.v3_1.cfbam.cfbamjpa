...
// Description: Java 25 JPA Default Factory implementation for TZTimeDef.
...
/*
 *	CFBamTZTimeDefFactory JPA implementation for TZTimeDef
 */
public class CFBamJpaTZTimeDefDefaultFactory
    implements ICFBamTZTimeDefFactory
{
    public CFBamJpaTZTimeDefDefaultFactory() {
    }

    @Override
    public ICFBamTZTimeDef newRec() {
        ICFBamTZTimeDef rec =
            new CFBamJpaTZTimeDef();
        return( rec );
    }

	public CFBamJpaTZTimeDef ensureRec(ICFBamTZTimeDef rec) {
		if( rec == null ) {
			return( null );
		}
