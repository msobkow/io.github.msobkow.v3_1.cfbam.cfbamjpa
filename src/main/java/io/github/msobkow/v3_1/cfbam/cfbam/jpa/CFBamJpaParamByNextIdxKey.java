// Description: Java 25 JPA implementation of a Param by NextIdx index key object.
	...
	implements ICFBamParamByNextIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamParamByNextIdxKey, ICFBamParam, ICFBamParamH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamParamByNextIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
