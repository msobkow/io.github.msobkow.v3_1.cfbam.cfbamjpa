// Description: Java 25 JPA implementation of a Uuid6Type by SchemaIdx index key object.
...
public class CFBamJpaUuid6TypeBySchemaIdxKey
	implements ICFBamUuid6TypeBySchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredSchemaDefId;
	public CFBamJpaUuid6TypeBySchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamUuid6TypeBySchemaIdxKey, ICFBamUuid6Type, ICFBamUuid6TypeH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamUuid6TypeBySchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
