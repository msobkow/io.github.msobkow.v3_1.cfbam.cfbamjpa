// Description: Java 25 JPA implementation of DbKeyHash128Def history objects
...
/**
 *  CFBamJpaDbKeyHash128DefH provides history objects matching the CFBamDbKeyHash128Def change history.
 */
@Entity
@Table(
    name = "dbk128def_h", schema = "CFBam31",
    indexes = {
        @Index(name = "DbKeyHash128DefIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true)
    }
)
    ...
    implements ICFBamDbKeyHash128DefH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaDbKeyHash128DefH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
