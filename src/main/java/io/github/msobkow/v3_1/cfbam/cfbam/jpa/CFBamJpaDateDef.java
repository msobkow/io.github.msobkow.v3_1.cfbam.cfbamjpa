// Description: Java 25 JPA implementation of a DateDef entity definition object.
...
@Entity
@Table(
	name = "dtdef", schema = "CFBam31",
	indexes = {
		@Index(name = "DateDefIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaDateDef extends CFBamJpaAtom
	implements ICFBamDateDef
{
	...
	public String toString() {
		String ret = "<CFBamJpaDateDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
