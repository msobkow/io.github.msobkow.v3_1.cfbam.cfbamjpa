// Description: Java 25 JPA implementation of DateCol history objects
...
/**
 *  CFBamJpaDateColH provides history objects matching the CFBamDateCol change history.
 */
@Entity
@Table(
    name = "dtcol_h", schema = "CFBam31",
    indexes = {
        @Index(name = "DateColIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, Id", unique = true),
        @Index(name = "DateColTableIdx_h", columnList = "TableId", unique = false)
    }
)
@Inheritance(strategy = InheritanceType.JOINED)
@DiscriminatorValue("43117")
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFBamPU")
public class CFBamJpaDateColH extends CFBamJpaDateDefH
    implements ICFBamDateColH
{
    ...
    public String toString() {
        String ret = "<CFBamJpaDateColH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
