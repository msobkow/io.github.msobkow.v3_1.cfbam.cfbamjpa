...
// Description: Java 25 JPA Default Factory implementation for DateDef.
...
/*
 *	CFBamDateDefFactory JPA implementation for DateDef
 */
public class CFBamJpaDateDefDefaultFactory
    implements ICFBamDateDefFactory
{
    public CFBamJpaDateDefDefaultFactory() {
    }
	...
	public CFBamJpaDateDef ensureRec(ICFBamDateDef rec) {
		if( rec == null ) {
			return( null );
		}
