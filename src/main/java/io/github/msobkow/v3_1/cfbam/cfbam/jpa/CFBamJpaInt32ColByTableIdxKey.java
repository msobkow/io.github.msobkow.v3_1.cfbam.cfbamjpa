// Description: Java 25 JPA implementation of a Int32Col by TableIdx index key object.
...
public class CFBamJpaInt32ColByTableIdxKey
	implements ICFBamInt32ColByTableIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 requiredTableId;
	public CFBamJpaInt32ColByTableIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamInt32ColByTableIdxKey, ICFBamInt32Col, ICFBamInt32ColH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamInt32ColByTableIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
