// Description: Java 25 JPA implementation of a TokenDef entity definition object.
...
@Entity
@Table(
	name = "tkndef", schema = "CFBam31",
	indexes = {
		@Index(name = "TokenDefIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaTokenDef extends CFBamJpaAtom
	implements ICFBamTokenDef
{
	...
	public String toString() {
		String ret = "<CFBamJpaTokenDef" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
