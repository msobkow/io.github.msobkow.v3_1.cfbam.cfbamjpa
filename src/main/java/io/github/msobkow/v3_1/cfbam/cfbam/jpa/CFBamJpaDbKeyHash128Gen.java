// Description: Java 25 JPA implementation of a DbKeyHash128Gen entity definition object.
...
@Entity
@Table(
	name = "idgdbk128", schema = "CFBam31",
	indexes = {
		@Index(name = "DbKeyHash128GenIdIdx", columnList = "Id", unique = true)
	}
)
...
public class CFBamJpaDbKeyHash128Gen extends CFBamJpaDbKeyHash128Type
	implements ICFBamDbKeyHash128Gen
{
	...
	public String toString() {
		String ret = "<CFBamJpaDbKeyHash128Gen" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
