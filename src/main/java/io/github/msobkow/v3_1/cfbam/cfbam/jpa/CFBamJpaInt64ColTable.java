...
public class CFBamJpaInt64ColTable implements ICFBamInt64ColTable
{
		...
		ICFBamInt64Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaInt64Col created = int64colService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamInt64Col rec )
	{
		if (rec == null) {
			...
			CFBamJpaInt64Col jparec = (CFBamJpaInt64Col)rec;
			CFBamJpaInt64Col updated = int64colService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamInt64Col rec )
	{
		...
		if (rec instanceof CFBamJpaInt64Col) {
			CFBamJpaInt64Col jparec = (CFBamJpaInt64Col)rec;
			int64colService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		int64colService.deleteByTableIdx(argTableId);
	}
	...
	{
		int64colService.deleteByTableIdx(argKey.getRequiredTableId());
	}
	...
	{
		int64colService.deleteByIdIdx(argKey);
	}
	...
	public void deleteInt64ColByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		int64colService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		int64colService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteInt64ColByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		int64colService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		int64colService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		int64colService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		int64colService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		int64colService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		int64colService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		int64colService.deleteByNextIdx(argNextId);
	}
	...
	{
		int64colService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteInt64ColByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		int64colService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		int64colService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteInt64ColByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		int64colService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		int64colService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( int64colService.find(PKey) );
	}
	...
	public ICFBamInt64Col lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( int64colService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamInt64Col[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaInt64Col> results = int64colService.findAll();
	...
	{
		return( int64colService.find(argId) );
	}
	...
	public ICFBamInt64Col readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( int64colService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamInt64Col[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaInt64Col> results = int64colService.findByScopeIdx(argScopeId);
		ICFBamInt64Col[] retset = new ICFBamInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt64Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt64Col[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaInt64Col> results = int64colService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamInt64Col[] retset = new ICFBamInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt64Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt64Col[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaInt64Col> results = int64colService.findByPrevIdx(argPrevId);
		ICFBamInt64Col[] retset = new ICFBamInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt64Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt64Col[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaInt64Col> results = int64colService.findByNextIdx(argNextId);
		ICFBamInt64Col[] retset = new ICFBamInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt64Col cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt64Col[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaInt64Col> results = int64colService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamInt64Col[] retset = new ICFBamInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt64Col cur: results) {
	...
	public ICFBamInt64Col[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaInt64Col> results = int64colService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamInt64Col[] retset = new ICFBamInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt64Col cur: results) {
	...
	public ICFBamInt64Col[] readDerivedByTableIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argTableId )
	{
		List<CFBamJpaInt64Col> results = int64colService.findByTableIdx(argTableId);
		ICFBamInt64Col[] retset = new ICFBamInt64Col[results.size()];
		int idx = 0;
		for (CFBamJpaInt64Col cur: results) {
			retset[idx++] = cur;
