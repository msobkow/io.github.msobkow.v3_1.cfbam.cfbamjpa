// Description: Java 25 JPA implementation of a Table by DefSchemaIdx index key object.
...
public class CFBamJpaTableByDefSchemaIdxKey
	implements ICFBamTableByDefSchemaIdxKey, Comparable<Object>, Serializable
{
	protected CFLibDbKeyHash256 optionalDefSchemaId;
	public CFBamJpaTableByDefSchemaIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamTableByDefSchemaIdxKey, ICFBamTable, ICFBamTableH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamTableByDefSchemaIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
