...
public class CFBamJpaInt16DefTable implements ICFBamInt16DefTable
{
		...
		ICFBamInt16Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaInt16Def created = int16defService.create(jparec);
			return( created );
		}
		else {
		...
		ICFBamInt16Def rec )
	{
		if (rec == null) {
			...
			CFBamJpaInt16Def jparec = (CFBamJpaInt16Def)rec;
			CFBamJpaInt16Def updated = int16defService.update(jparec);
			return( updated );
		}
		else {
		...
		ICFBamInt16Def rec )
	{
		...
		if (rec instanceof CFBamJpaInt16Def) {
			CFBamJpaInt16Def jparec = (CFBamJpaInt16Def)rec;
			int16defService.deleteByIdIdx(jparec.getPKey());
		}
		else {
	...
	{
		int16defService.deleteByIdIdx(argKey);
	}
	...
	public void deleteInt16DefByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		int16defService.deleteByUNameIdx(argScopeId,
		argName);
	}
	...
	{
		int16defService.deleteByUNameIdx(argKey.getRequiredScopeId(),
	...
	public void deleteInt16DefByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		int16defService.deleteByScopeIdx(argScopeId);
	}
	...
	{
		int16defService.deleteByScopeIdx(argKey.getRequiredScopeId());
	}
	...
	{
		int16defService.deleteByDefSchemaIdx(argDefSchemaId);
	}
	...
	{
		int16defService.deleteByDefSchemaIdx(argKey.getOptionalDefSchemaId());
	}
	...
	{
		int16defService.deleteByPrevIdx(argPrevId);
	}
	...
	{
		int16defService.deleteByPrevIdx(argKey.getOptionalPrevId());
	}
	...
	{
		int16defService.deleteByNextIdx(argNextId);
	}
	...
	{
		int16defService.deleteByNextIdx(argKey.getOptionalNextId());
	}
	...
	public void deleteInt16DefByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		int16defService.deleteByContPrevIdx(argScopeId,
		argPrevId);
	}
	...
	{
		int16defService.deleteByContPrevIdx(argKey.getRequiredScopeId(),
	...
	public void deleteInt16DefByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		int16defService.deleteByContNextIdx(argScopeId,
		argNextId);
	}
	...
	{
		int16defService.deleteByContNextIdx(argKey.getRequiredScopeId(),
	...
	{
		return( int16defService.find(PKey) );
	}
	...
	public ICFBamInt16Def lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey )
	{
		return( int16defService.lockByIdIdx(PKey) );
	}
	...
	public ICFBamInt16Def[] readAllDerived( ICFSecAuthorization Authorization ) {
		List<CFBamJpaInt16Def> results = int16defService.findAll();
	...
	{
		return( int16defService.find(argId) );
	}
	...
	public ICFBamInt16Def readDerivedByUNameIdx( ICFSecAuthorization Authorization,
		...
		String argName )
	{
		return( int16defService.findByUNameIdx(argScopeId,
		argName) );
	}
	...
	public ICFBamInt16Def[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId )
	{
		List<CFBamJpaInt16Def> results = int16defService.findByScopeIdx(argScopeId);
		ICFBamInt16Def[] retset = new ICFBamInt16Def[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Def[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argDefSchemaId )
	{
		List<CFBamJpaInt16Def> results = int16defService.findByDefSchemaIdx(argDefSchemaId);
		ICFBamInt16Def[] retset = new ICFBamInt16Def[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Def[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaInt16Def> results = int16defService.findByPrevIdx(argPrevId);
		ICFBamInt16Def[] retset = new ICFBamInt16Def[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Def[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaInt16Def> results = int16defService.findByNextIdx(argNextId);
		ICFBamInt16Def[] retset = new ICFBamInt16Def[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Def cur: results) {
			retset[idx++] = cur;
	...
	public ICFBamInt16Def[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argPrevId )
	{
		List<CFBamJpaInt16Def> results = int16defService.findByContPrevIdx(argScopeId,
		argPrevId);
		ICFBamInt16Def[] retset = new ICFBamInt16Def[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Def cur: results) {
	...
	public ICFBamInt16Def[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		...
		CFLibDbKeyHash256 argNextId )
	{
		List<CFBamJpaInt16Def> results = int16defService.findByContNextIdx(argScopeId,
		argNextId);
		ICFBamInt16Def[] retset = new ICFBamInt16Def[results.size()];
		int idx = 0;
		for (CFBamJpaInt16Def cur: results) {
