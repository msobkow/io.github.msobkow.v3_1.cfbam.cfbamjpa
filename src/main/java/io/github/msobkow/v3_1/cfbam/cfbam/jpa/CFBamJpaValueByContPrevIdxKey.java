// Description: Java 25 JPA implementation of a Value by ContPrevIdx index key object.
...
public class CFBamJpaValueByContPrevIdxKey
	implements ICFBamValueByContPrevIdxKey, Comparable<Object>, Serializable
{
	...
	public CFBamJpaValueByContPrevIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFBamValueByContPrevIdxKey, ICFBamValue, ICFBamValueH");
		}
	}
	...
	public String toString() {
		String ret = "<CFBamValueByContPrevIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
